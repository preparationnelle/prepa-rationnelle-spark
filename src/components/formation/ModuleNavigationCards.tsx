  ...
  return (
    <div className="mt-16 mb-12">
      <Link to={link} className="block">
        <Card className="border-2 border-blue-300 hover:border-blue-500 transition-all duration-300 hover:shadow-xl group cursor-pointer bg-white hover:bg-blue-50 p-2">
          <CardContent className="p-8">
            <div className="flex items-center gap-6">
              <div className="p-4 rounded-xl bg-blue-100 border-2 border-blue-200 group-hover:bg-blue-200 transition-all duration-300">
                <Icon className="h-8 w-8 text-blue-600" />
              </div>
              <div className="flex-1">
                <h3 className="text-2xl font-bold text-gray-900 mb-2 group-hover:text-blue-800 transition-colors">
                  {title}
                </h3>
                <p className="text-base text-gray-600 group-hover:text-blue-700 transition-colors">
                  {subtitle}
                </p>
              </div>
            </div>
