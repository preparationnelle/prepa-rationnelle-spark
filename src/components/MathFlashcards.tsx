...
export const MathFlashcards: React.FC<MathFlashcardsProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-4">
      ...
      <div className="relative mb-6">
        <Card
          className={`min-h-[350px] bg-white border-2 shadow-xl transition-all duration-500 hover:shadow-2xl ${
            isFlipped ? 'border-purple-300' : 'border-blue-300'
          }`}
        >
              ...
              {!showAnswer ? (
                ...
                <div className="animate-in fade-in duration-300">
                  ...
                  <Button
                    ...
                    className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg shadow-lg transform transition-all duration-200 hover:scale-105"
                  >
                ...
                <div className="animate-in slide-in-from-bottom duration-500">
                  <div className="mb-6">
                    <div className="text-lg font-medium text-slate-700 mb-4 leading-relaxed">
