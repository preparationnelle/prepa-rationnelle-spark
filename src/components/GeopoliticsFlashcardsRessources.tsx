...
export const GeopoliticsFlashcardsRessources: React.FC = () => {
  ...
  const markForReview = () => {
    ...
    const isMarked = isFlashcardMarkedForReview(cardId, 'geopolitics-ressources');

    if (isMarked) {
      removeFlashcardFromReview(cardId, 'geopolitics-ressources');
    } else {
      addFlashcardForReview({
        id: cardId,
        language: 'geopolitics-ressources',
        ...
        <CardContent className="flex flex-col items-center justify-center space-y-8 p-12">
          <div className="text-center max-w-2xl">
            ...
            <div className="mb-8">
              ...
              {isFlashcardMarkedForReview(geopoliticsRessourcesData.findIndex(card => card.term === currentCard.term) + 700, 'geopolitics-ressources') && (
                <div className="mt-2">
          ...
          {!isAtEnd && (
            <div className="flex gap-3">
              ...
              <Button
                ...
                variant={isFlashcardMarkedForReview(geopoliticsRessourcesData.findIndex(card => card.term === currentCard.term) + 700, 'geopolitics-ressources') ? "default" : "outline"}
              ...
              >
                ...
                {isFlashcardMarkedForReview(geopoliticsRessourcesData.findIndex(card => card.term === currentCard.term) + 700, 'geopolitics-ressources') ? 'Retiré' : 'À revoir'} (R)
              </Button>
            </div>
          )}
        </CardContent>
