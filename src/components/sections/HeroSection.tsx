  ...
  return (
    <section className="min-h-[90vh] w-full flex flex-col justify-center items-center py-12 sm:py-20 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-[1200px] flex flex-col items-center relative z-10">
        ...
        <h1 className="text-[1.5rem] sm:text-[1.8rem] md:text-[2.2rem] lg:text-[2.5rem] xl:text-[3rem] font-bold text-center mb-6 sm:mb-8 leading-[1.1] w-full max-w-[1000px] px-4">
          Ta méthode pour intégrer le <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent uppercase">TOP 3</span> en <span className="bg-gradient-to-r from-orange-500 to-orange-600 bg-clip-text text-transparent uppercase">ECG</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6 sm:gap-8 mb-6 sm:mb-8 w-full max-w-[900px] px-4">
          <Link to="/formations" className="text-center group cursor-pointer relative">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-orange-600 transition-colors relative z-10">Exercices incontournables</h3>
          ...
          <Link to="/apropos" className="text-center group cursor-pointer relative">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-orange-600 transition-colors relative z-10">Suivi Humain</h3>
            <p className="text-gray-600 relative z-10">Coaching personnalisé pour surmonter tes blocages et progresser rapidement.</p>
          </Link>
          <div className="hidden md:block w-px h-16 bg-gradient-to-b from-orange-200 to-transparent"></div>
        ...
        {/* Enhanced Buttons */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full max-w-[1000px] mb-6 sm:mb-8 px-4">
          <Button 
            size="lg" 
          ...
          >
            <span className="relative z-10 flex items-center gap-2">
              ...
              Rejoins gratuitement le Groupe WhatsApp ECG
            </span>
            <div className="absolute inset-0 bg-gradient-to-r from-green-600 to-green-700 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          </Button>
          <p className="text-center sm:text-left text-gray-600 max-w-[560px]">
            140+ membres — tips exclusifs, entraide quotidienne et réponses rapides à tes questions. Accès gratuit et immédiat.
          </p>
        </div>
