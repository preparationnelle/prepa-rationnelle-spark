...
> = {
  ...
  processing: {
    label: 'Traitement...',
    className: 'text-[#F4845F] animate-pulse',
  },
  done: {
    label: 'Termin\u00e9 \u2713',
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        ...
        {status === 'processing' && (
          <Loader2 className="h-4 w-4 animate-spin text-[#F4845F]" />
        )}
        {status === 'error' && (
      ...
      {transcription && status === 'done' && (
        <Button
          ...
          className="w-full bg-[#F4845F] hover:bg-[#F4845F]/90 text-white font-semibold transition-all animate-in fade-in slide-in-from-bottom-2 duration-300"
