        ...
        {Array.from({ length: totalQuestions }, (_, i) => {
          ...
          return (
            <button
              ...
              className={`
                h-3 w-3 rounded-full transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-[#F4845F]/50 focus:ring-offset-1
                ${isCurrent
                  ? 'ring-2 ring-[#F4845F] ring-offset-2 scale-125'
                  : 'hover:scale-110'
                }
                ${isAnswered
                  ? 'bg-[#F4845F]'
