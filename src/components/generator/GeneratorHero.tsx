 ...
 * Charte Prépa Rationnelle : fond clair, DM Serif Display titre, trait orange signature.
 */
    ...
    <div className="max-w-3xl mx-auto text-center">
      {breadcrumb && (
        <nav className="flex items-center justify-center gap-1.5 text-xs text-pr-gray-mid mb-6 font-dm-sans">
          <Link to="/" className="hover:text-pr-orange transition-colors">Accueil</Link>
      ...
      <h1 className="font-dm-serif text-4xl sm:text-5xl lg:text-6xl text-pr-black mb-5 leading-[1.05]">
        ...
        {highlight && (
          <>
            {' '}
            <span className="text-pr-orange">{highlight}</span>
          </>
        )}
      </h1>
