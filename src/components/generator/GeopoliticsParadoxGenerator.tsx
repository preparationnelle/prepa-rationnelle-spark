      ...
      <Card className="bg-carnet-paper-2 rounded-2xl border border-pr-gray-light overflow-hidden shadow-[0_2px_12px_rgba(26,26,24,0.04)]">
        ...
        <CardContent className="p-6">
          <div className="flex items-start gap-4">
            <div className="p-2.5 bg-pr-gray-bg rounded-xl border border-pr-black-soft flex-shrink-0">
              <Sparkles className="h-5 w-5 text-pr-black" />
            </div>
            <div className="flex-1">
              ...
              {!loading && !evaluation && (
                <div className="bg-pr-gray-bg rounded-xl border border-pr-gray-light p-4">
                  <div className="text-[10px] font-bold text-pr-black uppercase tracking-[0.12em] mb-1.5">Exemple d'excellence — Paradoxe</div>
      ...
      <Card className="bg-carnet-paper-2 rounded-2xl border border-pr-gray-light shadow-[0_2px_12px_rgba(26,26,24,0.04)]">
        ...
        <CardContent className="px-6 pb-6 space-y-6">
          ...
          <Button
            ...
            className="w-full bg-pr-black hover:bg-pr-black-dark text-white h-12 rounded-xl font-semibold text-[15px] shadow-[0_4px_14px_rgba(244,132,95,0.35)] hover:shadow-[0_6px_20px_rgba(196,90,53,0.4)] transition-all duration-200 disabled:opacity-50 disabled:shadow-none"
          >
            {loading ? (
              <>
          ...
          <Card className="bg-carnet-paper-2 rounded-2xl border border-pr-gray-light shadow-[0_2px_12px_rgba(26,26,24,0.04)] overflow-hidden">
            ...
            <CardContent className="p-6 sm:p-7 space-y-7">
              ...
              <div className="bg-pr-gray-bg/60 rounded-xl p-5 border border-pr-black-pale">
                <h3 className="text-[11px] font-semibold text-pr-black uppercase tracking-[0.14em] mb-2 flex items-center gap-2">
                ...
                {evaluation.points_forts && evaluation.points_forts.length > 0 && (
                  <div className="space-y-3">
                    <h3 className="text-[11px] font-semibold text-pr-gray-mid uppercase tracking-[0.14em] flex items-center gap-2">
                      <CheckCircle className="h-3.5 w-3.5 text-pr-black" />
                      Points forts
                    </h3>
              ...
              <div className="rounded-2xl bg-pr-black p-7 text-white">
                <h3 className="text-[11px] font-semibold text-pr-black-soft uppercase tracking-[0.14em] mb-5 flex items-center gap-2">
                ...
                <div className="space-y-5">
                  <div className="bg-white/5 rounded-xl p-4 border border-white/10">
                    ...
                    <p className="text-white/90 italic border-l-2 border-pr-black pl-4">{userParadox}</p>
                  </div>
                  <div>
