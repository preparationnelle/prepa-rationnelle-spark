...
import { Loader2, Languages, Save, Trash2 } from 'lucide-react';
        ...
        <Card className="border-primary">
          <CardHeader>
            <CardTitle className="text-primary">
              {language === 'fr' ? 'Flashcard générée' : 'Generated Flashcard'}
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <p className="font-medium">{currentFlashcard.word_fr}</p>
                <p className="text-sm text-muted-foreground italic">"{currentFlashcard.sentence_fr}"</p>
              </div>
              <div className="space-y-2">
                <h4 className="font-semibold text-sm text-muted-foreground">🇬🇧 English</h4>
                <p className="font-medium">{currentFlashcard.word_en}</p>
                <p className="text-sm text-muted-foreground italic">"{currentFlashcard.sentence_en}"</p>
              </div>
            </div>
          </CardContent>
        </Card>
