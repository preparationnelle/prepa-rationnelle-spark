...
export const pythonCommands = {
  ...
  pandas: {
    ...
    commands: [
      ...
      { command: "df.mean()", description: "Renvoie le vecteur des moyennes de chaque colonne" },
      { command: "df.std()", description: "Renvoie le vecteur des écart-types de chaque colonne" },
      { command: "df.median()", description: "Renvoie le vecteur des médianes de chaque colonne" },
