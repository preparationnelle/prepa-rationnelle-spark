...
const ProfesseurPage = () => {
  ...
  return (
    <div className="relative">
      {/* Section Hero */}
      <section className="w-full flex flex-col justify-center items-center pt-16 sm:pt-20 pb-10 sm:pb-16 md:pb-24 px-4 sm:px-6 relative">
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">
              Rejoignez notre <span className="text-pr-black">équipe</span> de professeurs
            </h1>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-center pt-4">
                  <Button 
                    ...
                    className="bg-pr-black-dark hover:bg-pr-black-dark text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
                  >
                    {isSubmitting ? (
                      <>
      ...
      <section className="py-10 sm:py-14 md:py-16 lg:py-24 px-4 sm:px-6 relative overflow-hidden" style={{ backgroundColor: 'var(--section-bg-1)' }}>
        <div className="container mx-auto max-w-6xl relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Card Flexibilité */}
            <Card className="bg-white rounded-xl p-6 shadow-md hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-orange-300 hover:bg-gray-50 group">
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-orange-200 transition-colors duration-300">
                <Clock className="h-8 w-8 text-pr-black group-hover:text-pr-black transition-colors duration-300" />
              </div>
              <h3 className="font-semibold text-xl mb-2 text-pr-black group-hover:text-gray-800 transition-colors duration-300">
                Flexibilité totale
              </h3>
              ...
              <div className="space-y-1 text-xs text-left">
                <div className="flex items-center text-pr-black group-hover:text-pr-black transition-colors duration-300">
            ...
            {/* Card Rémunération */}
            <Card className="bg-white rounded-xl p-6 shadow-md hover:shadow-2xl hover:scale-105 hover:-translate-y-2 transition-all duration-300 border border-transparent hover:border-pr-black hover:bg-pr-gray-bg group">
              <div className="w-16 h-16 bg-carnet-red/10 rounded-full flex items-center justify-center mb-4 group-hover:bg-pr-black-soft transition-colors duration-300">
        ...
        <div className="container mx-auto max-w-4xl text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              className="bg-pr-black-dark hover:bg-pr-black-dark text-white px-8 py-4 text-lg font-semibold rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
            >
              Postuler maintenant
            </Button>
            <Button 
              ...
              className="px-8 py-4 text-lg font-semibold rounded-lg border-2 border-pr-black-dark text-pr-black hover:bg-gray-50 transition-all duration-300"
            >
              En savoir plus
            </Button>
          </div>
