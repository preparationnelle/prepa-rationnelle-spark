...
import { Star, ExternalLink, Quote, ArrowLeft } from 'lucide-react';
...
const AvisPage = () => {
  const reviews = [
    ...
    },
    {
      ...
      subject: "Maths",
      progression: "Progression significative"
    },
    {
      name: "Louise",
      ...
      subject: "Maths",
      progression: "Reprise de confiance"
    },
    {
      name: "Daniel",
    ...
    },
    {
      ...
      subject: "Prépa ECG",
      progression: "Méthode rigoureuse"
    },
    {
      name: "Nathalie",
      ...
      subject: "Maths Prépa",
      progression: "2 années d'accompagnement"
    },
    {
      name: "Martin",
      ...
      progression: "Décollage en philo"
    },
    {
      name: "Hugo",
    ...
    },
    {
      ...
      subject: "Maths",
      progression: "Progression rapide"
    },
    {
      name: "Ismael",
      ...
      subject: "Python",
      progression: "Amélioration en Python"
    },
    {
      name: "Kijanshika",
    ...
    },
    {
      ...
      progression: "Progression étape par étape"
    }
  ];
        ...
        <div className="container mx-auto py-8 px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {reviews.map((review, index) => (
              <Card key={index} className="group hover:shadow-xl transition-all duration-300 border-2 border-blue-200 hover:border-blue-300 bg-white/80 backdrop-blur-sm">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="relative">
                        ...
                        <p className="text-sm text-gray-700 leading-relaxed pl-4 mb-3">
                          {review.content}
                        </p>
          ...
          <div className="text-center">
            <div className="bg-white rounded-2xl shadow-lg p-8 max-w-2xl mx-auto">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Prêt à progresser ?</h3>
              <p className="text-gray-600 mb-6">
                Rejoignez les élèves qui ont déjà transformé leurs résultats grâce à mon accompagnement personnalisé.
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/contact">
                  <Button 
                    variant="outline"
                    size="lg" 
                    className="border-2 border-orange-500 text-orange-600 hover:bg-orange-50 font-semibold py-4 px-8 text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105"
                  >
                    Me contacter
                  </Button>
                </Link>
