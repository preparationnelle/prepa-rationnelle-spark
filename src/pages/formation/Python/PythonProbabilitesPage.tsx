    ...
    <PythonModuleLayout>
      <header className="mb-10">
        ...
        <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black leading-tight tracking-tight">
          <span className="text-pr-orange">Probabilités</span> en Python
        </h1>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-pr-gray-dark">Simulation</p>
            ...
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-pr-gray-dark">Statistiques</p>
                <p className="text-sm text-gray-700">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-pr-gray-dark">Monte-Carlo</p>
                <p className="text-sm text-gray-700">
            ...
            <div className="flex items-start gap-3">
              <CheckCircle className="h-5 w-5 text-green-600 mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-pr-gray-dark">Visualisation</p>
                <p className="text-sm text-gray-700">
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          <div className="bg-pr-black rounded-lg p-4 mb-4">
            <pre className="text-pr-gray-light text-sm">
              {`import numpy as np
...
import matplotlib.pyplot as plt`}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <h4 className="font-semibold text-pr-gray-dark mb-2">Simulation</h4>
            ...
            <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <h4 className="font-semibold text-pr-gray-dark mb-2">Monte-Carlo</h4>
              <p className="text-sm text-pr-gray-dark">
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          <div className="space-y-6">
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">Fonction Bernoulli</h4>
    ...
    return 0`}
            ...
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">Fonction Géométrique</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
                  {`def geometrique(p):
    n = 1
    ...
    return n`}
            ...
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">Fonction Binomiale</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
                  {`def binomiale(n, p):
    S = 0
    ...
    return S`}
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          ...
          <div className="mt-4 p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
            <p className="text-sm text-pr-gray-dark">
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
                <h4 className="font-semibold text-pr-gray-dark mb-2">Estimer une espérance</h4>
                <code className="text-sm bg-pr-gray-bg px-2 py-1 rounded text-pr-black">np.mean(rd.&lt;loi&gt;(..., size=N))</code>
                <p className="text-sm text-pr-gray-dark mt-2">avec un grand N</p>
              </div>
              <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
                <h4 className="font-semibold text-pr-gray-dark mb-2">Estimer une probabilité</h4>
                <code className="text-sm bg-pr-gray-bg px-2 py-1 rounded text-pr-black">freq = np.mean(condition_bool)</code>
              </div>
            </div>
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">Exemple d'intégrale</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
    ...
    return y.mean()`}
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          <div className="space-y-6">
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">1. Deux faces "Pile" consécutives au pile ou face</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
                  {`def simul_X():
    tirs, pile = 0, 0
    ...
    return tirs`}
            ...
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">2. Jeu de dés : le joueur A gagne s'il obtient 6 avant B</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
                  {`def partie():
    while True:
...
proba_A = np.mean([partie() for _ in range(10000)])`}
            ...
            <div>
              <h4 className="font-semibold mb-3 text-pr-gray-dark">3. Géométrique(p=0.2) : comparaison simulation / théorie</h4>
              <div className="bg-pr-black rounded-lg p-4">
                <pre className="text-pr-gray-light text-sm">
...
rd.normal(mean, sigma)   # normale`}
      ...
      <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="p-3 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <p className="text-sm font-medium text-pr-black">1. <code>rd.random((3,4))</code> produit-il bien 12 réels indépendants entre 0 et 1 ?</p>
            </div>
            <div className="p-3 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <p className="text-sm font-medium text-pr-black">2. Quelle commande simule une valeur de loi de Poisson avec paramètre 2 ?</p>
            </div>
            <div className="p-3 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <p className="text-sm font-medium text-pr-black">3. Pour estimer une espérance, quelle syntaxe est la plus simple ?</p>
            </div>
            <div className="p-3 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <p className="text-sm font-medium text-pr-black">4. Pourquoi ajouter <code>density=True</code> dans un histogramme ?</p>
            </div>
            <div className="p-3 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
              <p className="text-sm font-medium text-pr-black">5. Une ligne pour simuler dix mille valeurs de la loi géométrique avec paramètre 0.25 ?</p>
            </div>
          </div>
          <div className="mt-4 p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
            <p className="text-sm text-pr-gray-dark">
