    ...
    <PythonModuleLayout>
      ...
      <header className="mb-10">
        <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-pr-orange-pale border border-pr-orange-soft/60">
          <Code className="h-3.5 w-3.5 text-pr-orange-dark" />
        ...
        <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black leading-tight tracking-tight">
          Les <span className="text-pr-orange">Fondamentaux</span>
        </h1>
        ...
        <CardContent>
          <ul className="space-y-3 text-gray-700">
            <li className="flex items-start gap-2">
              <CheckCircle className="h-4 w-4 text-pr-gray-mid mt-1" />
      ...
      <div className="space-y-6">
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black flex items-center gap-2">
          ...
          <CardContent>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-pr-gray-bg border-l-4 border-pr-gray-light p-4 rounded-lg">
              ...
              <div className="bg-pr-gray-bg/80 p-4 rounded-lg">
          ...
          <CardContent>
            ...
            <div className="space-y-4">
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    <TableCell className="font-mono text-gray-600">numpy.random</TableCell>
                    <TableCell className="font-mono">rd</TableCell>
                    <TableCell>Tirages aléatoires (lois de proba)</TableCell>
                    <TableCell className="font-mono text-sm">rd.random(), rd.binomial(), rd.geometric()</TableCell>
                  </TableRow>
                  <TableRow>
              ...
              <div className="grid md:grid-cols-2 gap-4 mt-6">
                <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                  <h4 className="font-semibold text-gray-700 mb-2">1. numpy.random (rd)</h4>
                  <p className="text-sm text-gray-600 mb-2">Simuler des lois de probabilité</p>
                  <div className="bg-pr-black p-2 rounded font-mono text-sm text-pr-gray-light">
                    <div>import numpy.random as rd</div>
                    <div>x = rd.random()           # uniforme sur [0,1[</div>
                    <div>n = rd.binomial(10, 0.5)  # B(10, 0.5)</div>
                  </div>
                </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">3 + 2</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">5 - 8</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">4 * 3</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">7 / 2</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">17 % 6</TableCell>
                      <TableCell className="font-mono">5</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-mono text-gray-600">**</TableCell>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">2 ** 4</TableCell>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 4 - Instructions d'affichage et de saisie en Python</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                  ...
                  <div className="bg-pr-black p-3 rounded font-mono text-sm text-pr-gray-light space-y-1">
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 5 - Fonctions Python : natives, numpy et personnalisées</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-pr-gray-bg border-l-4 border-pr-gray-light p-4 rounded-lg">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>• Une fonction ECG = nom court, paramètres clairs, un seul return</li>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 6 - Fiche Python – Listes (uniquement maths appli)</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 7 - Structures de contrôle : for, if, while</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 8 - Différence entre une fonction et un script en Python</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 10 - Les trois types d'exercices programmation fréquents en ECG</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 11 - Comment bien se préparer en Python pour réussir les concours ECG</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
          <CardHeader>
            <CardTitle className="text-2xl font-bold text-pr-black">Notion 12 - Récapitulatif des commandes utiles</CardTitle>
          </CardHeader>
          <CardContent>
            ...
            <Table>
              ...
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell className="font-mono bg-gray-50">for k in range(1, 5, 2):</TableCell>
                </TableRow>
                <TableRow>
