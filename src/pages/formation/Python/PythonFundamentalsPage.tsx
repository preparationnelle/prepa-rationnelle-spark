...
print(somme_1_a_n(100))   # Affiche 5050`}</CarnetCodeBlock>
      ...
      <section className="carnet-card p-8 sm:p-10 mb-12">
        ...
        <p className="font-instrument text-[15px] text-carnet-ink-soft mb-4">
          Teste tes connaissances sur les fondamentaux Python avec ce quiz interactif.
        </p>
        <PythonModuleQuiz title="Quiz pratique — Module 0" questions={fundamentalsQuizQuestions} />
      </section>
