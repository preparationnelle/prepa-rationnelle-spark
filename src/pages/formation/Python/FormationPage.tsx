      ...
      <div className="py-8 bg-white relative z-10">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="inline-flex items-center gap-3 mb-4 p-3 rounded-lg bg-blue-100 text-blue-700 border border-blue-300 mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {pythonModules.map((module) => (
                <Link key={module.id} to={module.courseLink} className="block h-full">
                  <Card className="h-full bg-white shadow-xl shadow-blue-200/60 hover:shadow-orange-200/50 transition-all duration-500 border-2 border-blue-300 hover:border-orange-300 bg-blue-100/40 hover:bg-orange-100/50 relative overflow-hidden group cursor-pointer">
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <Link to={module.courseLink} className="flex-1">
                          <Button variant="outline" size="sm" className="w-full border-blue-300 text-blue-700 hover:bg-orange-100 hover:text-orange-800 hover:border-orange-400">
                      ...
                      <Link to={module.exercisesLink} className="block">
                        <Button size="default" className="w-full bg-blue-700 hover:bg-orange-600 text-white font-bold">
