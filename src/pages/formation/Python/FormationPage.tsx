            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-6xl mx-auto">
              {pythonModules.map((module) => (
                <Link key={module.id} to={module.courseLink} className="block h-full">
                  <Card className="h-full bg-white shadow-xl shadow-blue-100/50 hover:shadow-orange-200/50 transition-all duration-500 border-2 border-blue-200 hover:border-orange-300 bg-blue-50/30 hover:bg-orange-50/50 relative overflow-hidden group cursor-pointer">
