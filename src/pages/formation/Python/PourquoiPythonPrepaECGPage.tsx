    ...
    <div className="min-h-screen bg-pr-gray-bg font-dm-sans text-pr-gray-dark">
      ...
      <div className="container mx-auto py-16 px-4 max-w-5xl">
        ...
        <header className="mb-12">
          ...
          <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black mb-4 tracking-tight leading-tight">
            Pourquoi travailler <span className="text-pr-orange">Python</span> en prépa ECG ?
          </h1>
          <div className="my-5 h-[2px] w-16 bg-pr-orange" />
          <p className="text-lg text-pr-gray-dark/80 font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            <section>
              <div className="flex items-start gap-4 mb-4">
                <div className="p-2 bg-pr-gray-bg rounded-lg">
                  <TrendingUp className="h-6 w-6 text-pr-gray-dark" />
                </div>
                <h2 className="text-2xl font-semibold text-pr-black mt-1">Un rapport temps/points imbattable</h2>
              </div>
              <p className="text-pr-gray-dark leading-relaxed pl-14">
            ...
            <section>
              <div className="flex items-start gap-4 mb-4">
                <div className="p-2 bg-pr-gray-bg rounded-lg">
                  <Award className="h-6 w-6 text-pr-gray-dark" />
                </div>
                <h2 className="text-2xl font-semibold text-pr-black mt-1">L'exigence des oraux</h2>
              </div>
              <p className="text-pr-gray-dark leading-relaxed pl-14">
            ...
            <section>
              <div className="flex items-start gap-4 mb-4">
                <div className="p-2 bg-pr-gray-bg rounded-lg">
                  <Terminal className="h-6 w-6 text-pr-gray-dark" />
                </div>
                <h2 className="text-2xl font-semibold text-pr-black mt-1">Une compétence clé pour l'École</h2>
              </div>
              <p className="text-pr-gray-dark leading-relaxed pl-14">
            ...
            <div className="pt-8 border-t border-gray-100">
              <h3 className="text-xl font-medium text-pr-black mb-6">Comment s'y mettre concrètement ?</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <Link to="/formation/python-fondamentaux" className="group block p-6 bg-white/70 hover:bg-pr-gray-bg border border-pr-gray-light/60 rounded-2xl transition-all">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-pr-black">Les Fondamentaux</span>
                    <ArrowRight className="h-4 w-4 text-pr-gray-mid group-hover:text-pr-black transition-colors" />
                  </div>
                  <p className="text-sm text-pr-gray-mid">Syntaxe, boucles et fonctions de base.</p>
                </Link>
                <Link to="/formation/python-matrices" className="group block p-6 bg-white/70 hover:bg-pr-gray-bg border border-pr-gray-light/60 rounded-2xl transition-all">
                  <div className="flex items-center justify-between mb-2">
                    <span className="font-semibold text-pr-black">Matrices & Numpy</span>
                    <ArrowRight className="h-4 w-4 text-pr-gray-mid group-hover:text-pr-black transition-colors" />
                  </div>
                  <p className="text-sm text-pr-gray-mid">Manipulation de tableaux et algèbre linéaire.</p>
                </Link>
              </div>
            </div>
          ...
          <div className="lg:col-span-4 space-y-8">
            <Card className="bg-pr-gray-bg/80 border border-pr-gray-light/60 shadow-sm rounded-2xl">
              <CardContent className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  <Clock className="h-5 w-5 text-pr-gray-mid" />
                  <span className="text-sm font-medium text-pr-gray-dark">Temps de lecture</span>
                </div>
                <p className="text-pr-black font-semibold">3 minutes</p>
              </CardContent>
            </Card>

            <Card className="bg-white/70 border border-pr-gray-light/60 shadow-sm rounded-2xl">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold text-pr-black mb-4">Ressources associées</h3>
                <ul className="space-y-3">
                  <li>
                    <Link to="/formation/python-reference" className="flex items-center gap-2 text-pr-gray-dark hover:text-pr-black transition-colors text-sm">
                      <BookOpen className="h-4 w-4" />
                      <span>Fiche de référence Python</span>
                    </Link>
                  </li>
                  <li>
                    <Link to="/flashcards" className="flex items-center gap-2 text-pr-gray-dark hover:text-pr-black transition-colors text-sm">
