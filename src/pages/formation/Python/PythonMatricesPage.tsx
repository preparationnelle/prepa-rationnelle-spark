    ...
    <PythonModuleLayout>
      ...
      <header className="mb-10">
        <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-pr-orange-pale border border-pr-orange-soft/60">
          <Calculator className="h-3.5 w-3.5 text-pr-orange-dark" />
        ...
        <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black leading-tight tracking-tight">
          Les <span className="text-pr-orange">Matrices</span> NumPy
        </h1>
        <div className="mt-5 h-[2px] w-16 bg-pr-orange" />
      </header>

      {/* Objectifs du module */}
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        <CardHeader>
      ...
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        ...
        <CardContent>
          ...
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Qu'est-ce que NumPy ?</h5>
              ...
              <div className="bg-pr-gray-bg border-l-4 border-pr-gray-light p-4 rounded-r">
                <p className="text-pr-black font-medium">
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Importation standard</h5>
              <div className="bg-pr-black text-pr-gray-light rounded-lg p-4 overflow-x-auto border border-pr-gray-light">
                <pre className="text-pr-gray-light text-sm font-mono">
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Avantages de NumPy</h5>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                  <h6 className="font-semibold text-pr-black mb-2">Performance</h6>
                ...
                <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                  <h6 className="font-semibold text-pr-black mb-2">Syntaxe intuitive</h6>
                  <p className="text-sm text-pr-gray-dark">
      ...
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        ...
        <CardContent>
          ...
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Création directe avec np.array()</h5>
              <p className="text-gray-700 mb-4">
                La fonction <code className="bg-pr-gray-bg px-2 py-1 rounded text-pr-black">np.array()</code> permet de créer une matrice à partir de listes Python.
              </p>
              <div className="bg-pr-black text-pr-gray-light rounded-lg p-4 overflow-x-auto border border-pr-gray-light mb-4">
                <pre className="text-pr-gray-light text-sm font-mono">
...
vecteur_colonne = np.array([[1], [2], [3]])   # Vecteur colonne`}</code>
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Matrices spéciales</h5>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-pr-gray-bg">
                      <TableHead className="text-pr-black">Type</TableHead>
                      <TableHead className="text-pr-black">Syntaxe</TableHead>
                      <TableHead className="text-pr-black">Description</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    <TableRow>
                      <TableCell className="font-semibold">Matrice nulle</TableCell>
                      <TableCell className="font-mono bg-pr-gray-bg">np.zeros([n, m])</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">np.ones([n, m])</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">np.eye(n)</TableCell>
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Création de vecteurs</h5>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-pr-gray-bg">
                      <TableHead className="text-pr-black">Fonction</TableHead>
                      <TableHead className="text-pr-black">Syntaxe</TableHead>
                      <TableHead className="text-pr-black">Description</TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">np.arange(début, fin, pas)</TableCell>
                      <TableCell>Vecteur de valeurs régulièrement espacées</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-semibold">linspace</TableCell>
                      <TableCell className="font-mono bg-pr-gray-bg">np.linspace(début, fin, nb_points)</TableCell>
      ...
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        ...
        <CardContent>
          ...
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Système d'indexation</h5>
              <p className="text-gray-700 mb-4">
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Accès aux éléments et lignes/colonnes</h5>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-pr-gray-bg">
                      <TableHead className="text-pr-black">Opération</TableHead>
                      <TableHead className="text-pr-black">Syntaxe</TableHead>
                      <TableHead className="text-pr-black">Description</TableHead>
                    </TableRow>
                  </TableHeader>
      ...
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        ...
        <CardContent>
          ...
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Opérations arithmétiques élémentaires</h5>
                ...
                <Table>
                  ...
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">A + B</TableCell>
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Multiplication</h5>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-pr-gray-bg">
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">np.dot(A, B)</TableCell>
                      <TableCell>Produit matriciel classique</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell className="font-semibold">Par scalaire</TableCell>
                      <TableCell className="font-mono bg-pr-gray-bg">k * A</TableCell>
                      <TableCell>Multiplication par un scalaire k</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </div>
              <div className="mt-4 p-4 bg-pr-gray-bg/80 border border-pr-gray-light rounded">
                <p className="text-pr-black font-semibold">Attention : Il est crucial de ne pas confondre ces deux types de multiplication.</p>
              </div>
            </div>

            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Division et transposition</h5>
              <div className="overflow-x-auto">
                <Table>
                  <TableHeader>
                    <TableRow className="bg-pr-gray-bg">
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell className="font-mono bg-pr-gray-bg">A.T</TableCell>
      ...
      <Card className="bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl mb-8">
        ...
        <CardContent>
          ...
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Fonctions globales</h5>
...
np.prod(A)     # Produit de tous les éléments`}</code>
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Fonctions par axe</h5>
              <p className="text-gray-700 mb-4">Ces fonctions peuvent être appliquées ligne par ligne ou colonne par colonne :</p>

              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                    <h6 className="font-semibold text-pr-black mb-2">Par ligne (axis=1)</h6>
                    <div className="bg-pr-black text-pr-gray-light rounded p-2 text-sm font-mono">
                      <code>np.sum(A, axis=1)</code>
                    </div>
                  </div>
                  <div className="bg-pr-gray-bg/80 p-4 rounded-lg border border-pr-gray-light">
                    <h6 className="font-semibold text-pr-black mb-2">Par colonne (axis=0)</h6>
                    <div className="bg-pr-black text-pr-gray-light rounded p-2 text-sm font-mono">
            ...
            <div>
              <h5 className="font-semibold text-pr-gray-dark mb-2">Fonctions mathématiques</h5>
...
np.sqrt(A)     # Racine carrée de chaque élément`}</code>
      ...
      <div className="flex justify-center my-8">
        <Button
          ...
          size="lg"
          className={`text-lg px-8 py-6 rounded-xl transition-all ${isComplete ? 'bg-emerald-600 hover:bg-emerald-700' : 'bg-pr-black hover:bg-pr-black'}`}
          disabled={isComplete}
        >
          {isComplete ? (
            <>
