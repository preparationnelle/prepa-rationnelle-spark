...
const PythonFlashcardsPage = () => {
  ...
  return (
    <div className={`min-h-screen bg-pr-gray-bg font-dm-sans text-pr-gray-dark ${isFullscreen ? 'overflow-hidden bg-white' : ''}`}>
      {/* Sticky Breadcrumb (Hidden in Fullscreen) */}
      {!isFullscreen && (
        <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-pr-gray-light/60">
          ...
          <div className="container mx-auto px-4 py-2.5">
            <div className="flex items-center text-[11px] uppercase tracking-wider text-pr-gray-mid">
              ...
              <ChevronRight className="h-3 w-3 text-pr-gray-light mx-1.5" />
              <span className="text-pr-black font-semibold normal-case tracking-normal">Flashcards Python</span>
            </div>
          </div>
        </nav>
      )}
        ...
        {!isFullscreen && (
          <div className="mb-12">
            <div className="flex justify-between items-end mb-6">
              <div>
                <div className="inline-flex items-center gap-2 mb-3 px-3 py-1 rounded-full bg-pr-orange-pale border border-pr-orange-soft/60">
                  <span className="text-[10px] font-semibold uppercase tracking-[0.12em] text-pr-orange-dark">
                    Mémorisation
                  </span>
                </div>
                <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black mb-2 tracking-tight">
                  Flashcards <span className="text-pr-orange">Python</span>
                </h1>
                <div className="my-4 h-[2px] w-14 bg-pr-orange" />
                <p className="text-pr-gray-dark/80">
              ...
              <div className="hidden sm:flex items-center gap-2">
                <Button
                  ...
                  className="gap-2 border-pr-gray-light text-pr-gray-dark hover:bg-pr-orange-pale hover:text-pr-orange-dark hover:border-pr-orange-soft rounded-full"
                >
        ...
        <div className={`w-full ${isFullscreen ? 'max-w-4xl' : 'max-w-2xl mx-auto'}`}>
          ...
          <div className="flex items-center gap-4 mb-4 text-sm font-medium text-gray-500">
            ...
            <div className="h-1 flex-1 bg-gray-100 rounded-full overflow-hidden">
              <div
                className="h-full bg-pr-black transition-all duration-300"
                ...
                <div className="flex-1 flex items-center justify-center w-full">
                  {!isFlipped ? (
                    ...
                    <div className="w-full animate-in fade-in zoom-in-95 duration-300">
                      <div className="bg-pr-black rounded-lg p-6 w-full shadow-inner text-left overflow-x-auto">
          ...
          <div className="flex justify-between items-center mt-8">
            ...
            <Button onClick={handleFlip} className="min-w-[120px] bg-pr-black hover:bg-pr-black text-white shadow-none rounded-full">
