  ...
  return (<PythonModuleLayout>
    ...
    <header className="mb-10">
      <div className="inline-flex items-center gap-2 mb-4 px-3 py-1 rounded-full bg-pr-orange-pale border border-pr-orange-soft/60">
        <TrendingUp className="h-3.5 w-3.5 text-pr-orange-dark" />
      ...
      <h1 className="font-dm-serif text-4xl md:text-5xl text-pr-black leading-tight tracking-tight">
        <span className="text-pr-orange">Analyse</span> numérique
      </h1>
    ...
    <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
      <CardHeader>
        <CardTitle className="text-xl text-pr-black">PRÉSENTATION GÉNÉRALE</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="space-y-4">
          <div>
            <h3 className="font-semibold text-pr-gray-dark mb-2">Objectifs du module</h3>
          ...
          <div>
            <h3 className="font-semibold text-pr-gray-dark mb-2">Prérequis</h3>
            <p className="text-gray-700">
    ...
    <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
      <CardHeader>
        <CardTitle className="text-xl text-pr-black">1. CALCUL DE SOMMES EN PYTHON</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="mb-6">
          <h3 className="font-semibold text-pr-gray-dark mb-2">Objectif</h3>
        ...
        <div className="space-y-6">
          {/* Méthode 1 - Boucle */}
          <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
            <h4 className="font-semibold text-pr-gray-dark mb-3">Méthode 1 – Boucle avec variable initialisée</h4>
            <div className="space-y-3">
              <div className="bg-pr-black p-4 rounded font-mono text-sm text-pr-gray-light">
                <div className="text-pr-gray-light">n = 5</div>
                <div className="text-pr-gray-light">S = 0</div>
                <div className="text-pr-gray-light">for k in range(1, n+1):</div>
                <div className="ml-4 text-pr-gray-light">S += k**2 # pour ∑k^2</div>
                <div className="text-pr-gray-light">print(S)</div>
              </div>
              <div className="p-3 bg-pr-gray-bg border border-pr-gray-light rounded">
          ...
          {/* Méthode 2 - Liste */}
          <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
            <h4 className="font-semibold text-pr-gray-dark mb-3">Méthode 2 – Liste &amp; np.sum()</h4>
            <div className="space-y-3">
              <div className="bg-pr-black p-4 rounded font-mono text-sm text-pr-gray-light">
                <div className="text-pr-gray-light">n = 5</div>
                <div className="text-pr-gray-light">L = [k**2 for k in range(1, n+1)]</div>
                <div className="text-pr-gray-light">S = np.sum(L)</div>
                <div className="text-pr-gray-light">print(S)</div>
              </div>
              <div className="p-3 bg-pr-gray-bg border border-pr-gray-light rounded">
                <p className="text-pr-gray-dark">
          ...
          {/* Méthode 3 - NumPy */}
          <div className="p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
            <h4 className="font-semibold text-pr-gray-dark mb-3">Méthode 3 – Vectorisation avec NumPy</h4>
            <div className="space-y-3">
              <div className="bg-pr-black p-4 rounded font-mono text-sm text-pr-gray-light">
                <div className="text-pr-gray-light">import numpy as np</div>
                <div className="text-pr-gray-light"></div>
                <div className="text-pr-gray-light">n = 5</div>
                <div className="text-pr-gray-light">k = np.arange(1, n+1)</div>
                <div className="text-pr-gray-light">S = np.sum(k**2)</div>
                <div className="text-pr-gray-light">print(S)</div>
              </div>
              <div className="p-3 bg-pr-gray-bg border border-pr-gray-light rounded">
                <p className="text-pr-gray-dark">
        ...
        <div className="mt-6 p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
          <h4 className="font-semibold text-pr-gray-dark mb-3">Comparatif synthétique</h4>
          <Table>
            <TableHeader>
              <TableRow>
        ...
        {/* Exemples guidés */}
        <div className="mt-6 p-4 bg-pr-gray-bg/80 rounded-lg border border-pr-gray-light">
          <h4 className="font-semibold text-pr-gray-dark mb-3">Exemples guidés</h4>
          <div className="space-y-6">
            <div>
              <h5 className="font-semibold mb-3 text-pr-gray-dark">Sommes à calculer</h5>
            ...
            <div>
              <h5 className="font-semibold mb-3 text-pr-gray-dark">Méthode 1 – Boucles imbriquées</h5>
              <div className="bg-pr-black p-4 rounded font-mono text-sm space-y-1 text-pr-gray-light">
                <div className="text-pr-gray-light">n = 5</div>
                <div className="text-pr-gray-light">m = 4</div>
                <div className="text-pr-gray-light"></div>
                <div className="text-pr-gray-light">S1 = 0</div>
                <div className="text-pr-gray-light">for k in range(1, n+1):</div>
                <div className="ml-4 text-pr-gray-light">S1 += k**2</div>
                <div className="text-pr-gray-light"></div>
                <div className="text-pr-gray-light">S2 = 0</div>
                <div className="text-pr-gray-light">for k in range(1, n+1):</div>
                <div className="ml-4 text-pr-gray-light">S2 += k**3 - 2*k</div>
                <div className="text-pr-gray-light"></div>
                <div className="text-pr-gray-light">S3 = 0</div>
                <div className="text-pr-gray-light">for k in range(1, n+1):</div>
                <div className="ml-4 text-pr-gray-light">for j in range(1, m+1):</div>
                <div className="ml-8 text-pr-gray-light">S3 += k**2 + j**3</div>
              </div>
            </div>

            <div>
              <h5 className="font-semibold mb-3 text-pr-gray-dark">Méthode 2 – Listes + compréhension</h5>
              <div className="bg-pr-black p-4 rounded font-mono text-sm space-y-1 text-pr-gray-light">
                <div className="text-pr-gray-light">S1 = sum([k**2 for k in range(1, n+1)])</div>
                <div className="text-pr-gray-light">S2 = sum([k**3 - 2*k for k in range(1, n+1)])</div>
                <div className="text-pr-gray-light">S3 = sum([k**2 + j**3 for k in range(1, n+1) for j in range(1, m+1)])</div>
              </div>
            </div>

            <div>
              <h5 className="font-semibold mb-3 text-pr-gray-dark">Méthode 3 – NumPy</h5>
              <div className="bg-pr-black p-4 rounded font-mono text-sm space-y-1 text-pr-gray-light">
                <div className="text-pr-gray-light">import numpy as np</div>
                <div className="text-pr-gray-light"></div>
                <div className="text-pr-gray-light">k = np.arange(1, n+1)</div>
                <div className="text-pr-gray-light">S1 = np.sum(k**2)</div>
                <div className="text-pr-gray-light">S2 = np.sum(k**3 - 2*k)</div>
                <div className="text-pr-gray-light">S3 = np.sum([k**2 + j**3 for k in range(1, n+1) for j in range(1, m+1)])</div>
              </div>
            </div>
          </div>
        </div>
    ...
    <Card className="mb-8 bg-white/70 backdrop-blur-sm border border-pr-gray-light/60 shadow-sm rounded-2xl">
      <CardHeader>
        <CardTitle className="text-xl text-pr-black">2. CALCUL DE PRODUITS EN PYTHON</CardTitle>
      </CardHeader>
      <CardContent>
        <div className="mb-6">
          <h3 className="font-semibold text-pr-gray-dark mb-2">Objectif</h3>
            ...
            <AccordionContent>
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="bg-pr-black p-3 rounded font-mono text-sm text-pr-gray-light">
                    <div>def carre(k):</div>
                    <div className="ml-4">return k**2</div>
                    <div></div>
                    <div>produit_fini(1, 5, carre)</div>
            ...
            <AccordionContent>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded font-mono text-sm">
                    <div>def f(u):</div>
                    <div className="ml-4">return 5*u + 3</div>
                    <div></div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="bg-gray-50 p-4 rounded font-mono text-sm">
                    ...
                    <div></div>
                    <div>u = 2.4</div>
                    <div>for k in range(5):</div>
                    <div className="ml-4">print(u)</div>
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="syntaxe-fonction">
            ...
            <AccordionContent>
              <div className="space-y-4">
                <div className="bg-gray-50 p-4 rounded font-mono text-sm">
                  <div>def nom_fonction(p1, p2):</div>
