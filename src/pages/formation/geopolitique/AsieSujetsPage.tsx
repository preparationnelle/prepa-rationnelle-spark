      ...
      <nav className="sticky top-0 z-50 bg-carnet-paper/90 backdrop-blur supports-[backdrop-filter]:bg-carnet-paper-2/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-carnet-ink-soft">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/geopolitique/asie" className="hover:text-carnet-ink transition-colors">
              Asie
            </Link>
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-green-50 rounded-lg p-6 max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/formation/geopolitique/asie" className="inline-flex items-center gap-2 bg-pr-black hover:bg-pr-black-dark text-white px-4 py-2 rounded-md transition-colors">
              ...
              <Link to="/formation/geopolitique/asie/flashcards" className="inline-flex items-center gap-2 bg-pr-black hover:bg-pr-black-dark text-white px-4 py-2 rounded-md transition-colors">
