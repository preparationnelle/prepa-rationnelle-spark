    ...
    <div className="relative">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-carnet-ink-soft mb-6">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-carnet-ink font-medium">Chronologie - Amérique du Nord</span>
        </div>
          ...
          <div key={decade} className="mb-10">
            ...
            <div className="space-y-6">
              {decadeEvents.map((item, index) => (
                <Card key={index} className="border-l-4 border-carnet-red shadow-sm hover:shadow-md transition-shadow bg-carnet-paper-2">
