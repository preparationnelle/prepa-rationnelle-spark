  ...
  const etudesDeCasPassePartout = [
    {
      ...
      color: "bg-carnet-red/10 text-carnet-red"
    },
    {
    ...
    <div className="relative">
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div id="article-principal" className="max-w-4xl mx-auto">
          <Card className="border-2 border-carnet-red/30 mb-8">
            <CardHeader className="bg-pr-gray-bg">
              <div className="flex items-center gap-3 mb-2">
                ...
                <Badge className="bg-carnet-red">Méthode de travail</Badge>
          ...
          <Card className="mb-8 bg-carnet-red text-white">
            <CardHeader>
                        ...
                        <Card key={index} className="border-l-4 border-l-carnet-red">
                          <CardContent className="p-4">
                            <div className="flex items-start justify-between gap-4">
                              <div className="flex-1">
                                <Badge className={`bg-carnet-red/10 text-carnet-red mb-2`}>{etude.nom}</Badge>
                  ...
                  <div className="bg-pr-gray-bg p-4 rounded-lg">
                    ...
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <div className="w-2 h-2 bg-carnet-red rounded-full mt-2"></div>
