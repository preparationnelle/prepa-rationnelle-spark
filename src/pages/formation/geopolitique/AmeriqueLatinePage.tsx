  ...
  return (
    <div className="relative">
      <div className="container mx-auto px-4 py-8">
        {/* Breadcrumb */}
        <nav className="sticky top-0 z-50 bg-carnet-paper-2/90 backdrop-blur supports-[backdrop-filter]:bg-carnet-paper-2/60 border-b border-border/40 mb-8">
          <div className="container mx-auto px-4 py-2">
            <div className="flex items-center text-xs font-medium text-carnet-ink-soft">
              ...
              <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
              <span className="text-carnet-ink font-bold">Amérique latine</span>
            </div>
          </div>
        </nav>
        ...
        <Card className="mb-8 bg-carnet-paper-2 border border-carnet-rule shadow-none">
          <CardHeader>
            <CardTitle className="text-base font-semibold text-carnet-ink text-center">
              Plan de la dissertation
            </CardTitle>
          </CardHeader>
          <CardContent className="text-center">
            <div className="inline-block text-left space-y-4 max-w-2xl">
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium text-carnet-ink mb-2">
              ...
              <div>
                ...
                <ul className="list-disc pl-5 text-sm text-carnet-ink-soft space-y-1">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border border-carnet-rule bg-carnet-paper-2 shadow-none mb-8">
            <CardHeader>
              ...
              <AccordionItem value="i1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="bg-carnet-paper p-6 rounded-lg border-l-4 border-carnet-rule">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">1. Contexte historique</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Indépendances précoces (XIXᵉ siècle)</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Rêve bolivarien</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Citation emblématique</h5>
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <blockquote className="bg-carnet-paper-2 p-4 rounded border border-carnet-rule italic text-center">
                            <Quote className="h-5 w-5 text-carnet-ink-soft inline mr-2" />
                            "Pauvre Mexique, si loin de Dieu, si près des États-Unis."
                            <footer className="text-sm text-carnet-ink-soft mt-2 font-normal">— Porfirio Díaz</footer>
                          </blockquote>
                          <div className="mt-3 text-sm text-carnet-ink-soft">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* 2. Doctrine Monroe */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. Doctrine Monroe (1823)</h5>
                        <div className="bg-pr-gray-bg p-4 rounded-lg">
                          <h6 className="font-semibold text-carnet-red mb-2">"L'Amérique aux Américains"</h6>
                          <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      {/* 3. Big Stick Policy */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Big Stick Policy (Corollaire Roosevelt, 1904)</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Renforcement de la domination américaine</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Exemples d'interventions</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    {/* Études de cas */}
                    <div className="space-y-6">
                      <h4 className="text-xl font-semibold text-carnet-ink border-b-2 border-carnet-rule pb-2">
                        Études de cas : interventions américaines et déstabilisation
                      </h4>
                      
                      {/* Guatemala 1954 */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">1. Guatemala (1954) : Sharp power, diplomatie du dollar et Républiques bananières</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Contexte</h6>
                            <p className="text-sm text-carnet-ink-soft">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Réaction des États-Unis</h6>
                            <p className="text-sm text-carnet-ink-soft">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Conséquences</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Importance géopolitique</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    {/* Conclusion */}
                    <div className="bg-carnet-paper p-6 rounded-lg border border-carnet-rule">
                      <h4 className="text-lg font-semibold text-carnet-ink mb-4">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Reprimarisation depuis les années 2000</h6>
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Une spécialisation dépendante des ressources naturelles</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Dominance de l'agriculture et des minerais</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Corrélation avec la demande chinoise</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Exemple du Venezuela</h6>
                            <p className="text-sm text-carnet-ink-soft">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">1. Les États-Unis et le contrôle des canaux interocéaniques</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Canal de Panama (1914)</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Projet de canal au Nicaragua (2013-2017)</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Résultat mitigé</h6>
                            <p className="text-sm text-carnet-ink-soft">
                    ...
                    <div className="space-y-6">
                      <h4 className="text-xl font-semibold text-carnet-ink border-b-2 border-teal-200 pb-2">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Étude de cas : paradis fiscaux et flux financiers opaques</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Centres financiers offshore</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Panama Papers (2016)</h6>
                            <p className="text-sm text-carnet-ink-soft">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Un espace encore largement sous domination extérieure</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Économies dépendantes des grandes puissances</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Spécialisation contrainte</h6>
                            <p className="text-sm text-carnet-ink-soft">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. Une alternance constante entre différents modèles de développement</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Évolution chronologique des stratégies</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">1. Une industrialisation contrariée : de l'ISI aux privatisations libérales</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Échec du protectionnisme</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Privatisations massives (1980-1990)</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Des inégalités sociales et foncières criantes</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Concentration foncière</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Structures héritées</h6>
                            <p className="text-sm text-carnet-ink-soft">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. Un modèle de développement dicté par les cycles économiques mondiaux</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Cycles de crise et adaptation</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
              ...
              <AccordionItem value="ii1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      <h4 className="text-xl font-semibold text-carnet-ink border-b-2 border-brown-200 pb-2">
                        A. Une dépendance historique aux matières premières
                      </h4>
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                            <h6 className="font-semibold text-carnet-ink mb-2">L'Amérique latine devient un "grenier du monde"</h6>
                            <p className="text-sm text-carnet-ink-soft mb-3">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                            <h6 className="font-semibold text-carnet-ink mb-2">Ouvrage clé : Eduardo Galeano</h6>
                            <div className="space-y-3">
                              <p className="text-sm text-carnet-ink-soft">
                                <strong>Les Veines ouvertes de l'Amérique latine (1971)</strong>
                              </p>
                              <blockquote className="bg-carnet-paper-2 p-3 rounded border border-carnet-rule italic text-sm text-carnet-ink-soft">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg border border-carnet-red/30">
                            <h6 className="font-semibold text-carnet-red-deep mb-2">Ouvrage clé : Georges Couffignal</h6>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Un retour aux crises politiques et sociales</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Fragilisation des gouvernements de gauche</h6>
                            <p className="text-sm text-carnet-ink-soft mb-2">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Exemples de crises</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      {/* 3. Virage libéral */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">3. Un virage libéral dans les années 2015-2020</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Retour de gouvernements pro-marché</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Politiques néolibérales</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="bg-cyan-50 p-6 rounded-lg border-l-4 border-cyan-400">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 text-sm text-cyan-700">
                        <div className="bg-carnet-paper-2 p-3 rounded border border-cyan-200">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Influence économique chinoise croissante</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Nouvelles formes d'influence</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Crises économiques et dépendance aux cycles mondiaux</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Impact des crises financières mondiales</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Fluctuation des cours des matières premières</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. Faiblesse des institutions et corruption systémique</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Gouvernements inefficaces et clientélistes</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Corruption massive dans les secteurs publics et privés</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Inégalités sociales et tensions ethniques</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Une des régions les plus inégalitaires du monde</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Opposition villes/ruralités et tensions ethniques</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Violences de genre et patriarcat dominant</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* 2. Crise de 1929 */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Crise de 1929 : une déstabilisation brutale</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Dépendance au marché américain</h6>
                            <p className="text-sm text-carnet-ink-soft mb-2">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Conséquences dramatiques</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      {/* 3. Effet Tequila */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Crise du peso et "Effet Tequila" (Mexique, 1994-1995)</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Contexte et déclenchement</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Conséquences immédiates</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Propagation régionale</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* 3. Cas du Venezuela */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Le cas du Venezuela : une crise sécuritaire en plus de la crise économique</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Effondrement de l'ordre public</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Criminalité endémique</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">1. Une alternance permanente entre populisme de gauche et de droite</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Phénomène historique récurrent</h6>
                            <p className="text-sm text-carnet-ink-soft mb-2">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Populisme de gauche</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Populisme de droite</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">3. Une polarisation croissante dans un contexte de rejet des élites</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Anti-américanisme persistant</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Exploitation politique du rejet</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Contexte mondial de montée du populisme</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Une pauvreté persistante, exacerbée par la pandémie</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Impact du COVID-19</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Augmentation des troubles politiques et sociaux</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      {/* 1. Ville fragmentée */}
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">1. Une ville fragmentée entre quartiers riches et favelas</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Exclusion socio-spatiale</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Forte disparité des services publics</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Violence et narcotrafic</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. La Chine, un rival stratégique en Amérique latine</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Investissements massifs dans les infrastructures</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Augmentation des échanges commerciaux</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Une approche sans condition politique</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. BRICS et l'émergence inégale des pays d'Amérique latine</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Brésil dans les BRICS</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Incapacité des autres pays à suivre</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Bolsa Família (Brésil, 2003)</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Programme social phare sous Lula</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Succès reconnus</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Critiques et limites</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Effet Tequila et crises financières en chaîne</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Crise mexicaine de 1994-1995</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Crises répétées</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                ...
                <AccordionContent>
                  <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">2. Vers une transition écologique et énergétique ?</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Développement des énergies renouvelables</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Exploitation du potentiel solaire et éolien</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Résistances et conflits avec les populations locales</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">1. Une transition démographique inégale</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Vieillissement rapide dans certains pays</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Maintien d'une forte croissance démographique</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Urbanisation accélérée et bidonvilisation</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-red-deep mb-4">1. S'appuyer sur une diversification économique durable</h5>
                        <div className="space-y-4">
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Réduire la dépendance aux matières premières</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-pr-gray-bg p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-red mb-2">Encourager l'économie circulaire et l'innovation</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                      ...
                      <div className="ml-4">
                        <h5 className="text-lg font-semibold text-carnet-ink mb-4">2. Promouvoir des politiques de redistribution sociale</h5>
                        <div className="space-y-4">
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Réduire les inégalités pour une croissance inclusive</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                          ...
                          <div className="bg-carnet-paper p-4 rounded-lg">
                            <h6 className="font-semibold text-carnet-ink-soft mb-2">Soutenir les populations rurales et indigènes</h6>
                            <ul className="list-disc list-inside text-sm text-carnet-ink-soft space-y-1">
                    ...
                    <div className="bg-gradient-to-r from-pr-orange-pale to-green-50 p-6 rounded-lg border-2 border-carnet-red/30">
                      <h4 className="text-lg font-semibold text-carnet-ink mb-4 flex items-center gap-2">
                        <CheckCircle className="h-5 w-5 text-carnet-ink-soft" />
                      ...
                      <div className="space-y-4 text-sm text-carnet-ink-soft">
                        ...
                        <div className="mt-6 p-4 bg-carnet-paper rounded-lg">
                          <p className="text-xs text-carnet-ink-soft italic">
        ...
        {/* Chronologie */}
        <Card className="mt-8 border-2 border-carnet-rule bg-carnet-paper-2 shadow-lg">
          <CardHeader>
            <CardTitle className="text-2xl flex items-center gap-3">
        ...
        <Card className="mt-8 bg-carnet-paper border-carnet-rule">
          <CardContent className="p-6">
            <div className="flex items-center gap-3 text-carnet-ink">
              <AlertTriangle className="h-5 w-5" />
              <p className="font-semibold">Développement en cours</p>
            </div>
            <p className="text-carnet-ink-soft mt-2 text-sm">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-12">
          <Link to="/formation/geopolitique/amerique-latine/chronologie">
            <Card className="h-full hover:shadow-lg transition-all duration-200 cursor-pointer border-2 border-transparent hover:border-carnet-rule">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-carnet-ink-soft">Histoire latino-américaine</p>
              </CardContent>
            </Card>
          </Link>
