        ...
        <div className="text-center mb-12">
          ...
          <div className="bg-green-50 rounded-lg p-6 max-w-4xl mx-auto">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link to="/formation/geopolitique/continent-africain" className="inline-flex items-center gap-2 bg-pr-orange hover:bg-pr-orange-dark text-white px-4 py-2 rounded-md transition-colors">
              ...
              <Link to="/formation/geopolitique/continent-africain/flashcards" className="inline-flex items-center gap-2 bg-pr-orange hover:bg-pr-orange-dark text-white px-4 py-2 rounded-md transition-colors">
