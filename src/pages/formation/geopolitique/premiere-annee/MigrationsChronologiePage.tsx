    ...
    <div className="relative">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center gap-2 text-sm text-carnet-ink-soft mb-6">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-carnet-ink font-medium">Chronologie - Les migrations</span>
        </div>
        ...
        {Object.entries(groupedEvents).map(([decade, decadeEvents]) => (
          <div key={decade} className="mb-10">
            <h2 className="text-3xl font-bold font-dm-serif text-carnet-ink mb-6 border-b border-carnet-rule pb-2">
              {decade}
            </h2>
            <div className="space-y-6">
              {decadeEvents.map((item, index) => (
                <Card key={index} className="border-l-4 border-carnet-ink shadow-none bg-carnet-paper-2">
