    ...
    <div className="relative">
      <div className="sticky top-0 z-40 bg-carnet-paper/95 backdrop-blur-sm border-b border-carnet-rule/60">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-[11px] uppercase tracking-[0.08em] text-carnet-ink-soft font-semibold">
            ...
            <ChevronRight className="h-3 w-3 mx-1" />
            <span className="text-carnet-ink">Géopolitique des énergies</span>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 pt-12 pb-16">
        <div className="max-w-4xl mx-auto bg-carnet-paper-2 border border-carnet-rule rounded-xl p-6">
          <div className="mb-6">
            <h1 className="text-3xl font-bold text-carnet-ink">Géopolitique des énergies</h1>
          ...
          <div className="space-y-8 text-carnet-ink">
            ...
            <div className="border-l-4 border-carnet-red pl-4">
              <h2 className="text-2xl font-semibold text-carnet-red mb-2">Faits et dynamiques récentes</h2>
            ...
            <div className="border-l-4 border-carnet-red pl-4">
              <h2 className="text-2xl font-semibold text-carnet-red mb-2">L’Union européenne face à la crise énergétique</h2>
