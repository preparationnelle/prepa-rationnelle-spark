    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <Card className="mt-8 bg-carnet-paper-2 border border-carnet-rule shadow-none">
            <CardHeader>
            ...
            <CardContent className="text-center">
              <div className="inline-block text-left space-y-4 max-w-2xl">
                <div>
                  ...
                  <ul className="list-disc pl-5 text-sm text-carnet-ink space-y-1">
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="border border-carnet-rule bg-carnet-paper-2 shadow-none mb-8">
            ...
            <CardContent>
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">I.1. L'idée de la construction européenne</h3>
                  <div className="space-y-6">

                    {/* 1/ La nécessité d'établir la paix */}
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Une idée ancienne</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Emmanuel Kant (1795)</strong> - <em>Vers la paix perpétuelle</em></p>
                              <p className="text-carnet-ink-soft italic">Projet de paix perpétuelle</p>
                            </div>

                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Coudenhove Kalergi (1923)</strong> - <em>Paneuropa</em></p>
                              <p className="text-carnet-ink-soft italic">Un projet européen, s'unir pour éviter la guerre</p>
                            </div>

                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Stefan Zweig (1941)</strong> - <em>Le monde d'hier, souvenirs d'un Européen</em></p>
                              <p className="text-carnet-ink-soft italic">Un regard rétrospectif sur l'Europe : Excès de puissance en Europe en 1913 cause de la PGM</p>
                              <blockquote className="bg-carnet-paper p-3 rounded italic text-carnet-ink mt-2">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Héritage d'un passé récent de guerres et destructions</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Robert Kagan (2002)</strong> - <em>La puissance et la faiblesse</em></p>
                              <p className="text-carnet-ink-soft">Pour les Européens : volonté de puissance = porteuse de chaos → « longue guerre civile européenne »</p>
                              <p className="text-xs text-carnet-ink-soft mt-1">
                            ...
                            <div className="bg-carnet-paper p-3 rounded">
                              <p className="italic text-carnet-ink">Abdiquer de la puissance militaire, Europe paradis, grâce aux USA...</p>
                              <p className="font-medium text-carnet-ink mt-2">« Les Européens sont de Vénus, les Américains de Mars »</p>
                            </div>
                          </div>
                        </div>

                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Émergence de l'idée de gouvernance européenne/mondiale</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border border-carnet-rule p-3 rounded bg-carnet-paper-2">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">La réincarnation de la France, rédemption de l'Allemagne</h5>
                          <blockquote className="bg-carnet-paper-2 p-3 rounded italic text-carnet-ink border-l-2 border-carnet-rule">
                            « À travers l'Europe, la France vise la réincarnation, l'Allemagne la rédemption »
                            <footer className="text-sm text-carnet-ink-soft mt-1">— Zbigniew Brzezinski</footer>
                          </blockquote>
                          <p className="text-sm text-carnet-ink mt-2">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Réponse au déclin relatif des puissances européennes</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <blockquote className="bg-carnet-paper-2 p-3 rounded italic border-l-2 border-carnet-rule">
                              « L'Allemagne est trop grande pour l'Europe, trop petite pour le monde »
                              <footer className="text-sm text-carnet-ink-soft mt-1">— Henry Kissinger</footer>
                            </blockquote>
                            ...
                            <div className="border border-carnet-rule p-3 rounded bg-carnet-paper-2">
                              ...
                              <p className="text-xs text-carnet-ink-soft">Voir le livre de Mathieu pour une synthèse sur l'établissement relatif de l'Europe</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Chacun a sa propre vision de l'Europe</h5>
                          <p className="text-sm text-carnet-ink mb-3">Projet de paix et de prospérité de l'Europe</p>

                          <blockquote className="bg-carnet-paper-2 p-3 rounded italic text-carnet-ink border-l-2 border-carnet-rule">
                            « On ne sort de l'ambiguïté qu'à son détriment »
                            <footer className="text-sm text-carnet-ink-soft mt-1">— Cardinal de Retz</footer>
                          </blockquote>

                          <p className="text-sm text-carnet-ink mt-2 font-medium">
                            La construction européenne serait-elle finalement l'histoire d'un malentendu ?
                          </p>
                        </div>

                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Étude de cas : Le couple franco-allemand</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            ...
                            <p className="font-medium text-carnet-ink">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-3">Les trois approches des pères fondateurs</h5>

                          <div className="grid md:grid-cols-3 gap-4">
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">1. Pragmatisme</h6>
                              <p className="text-xs text-carnet-ink-soft">Par des réalisations concrètes et le functional spillover, paix et fédération créées</p>
                            </div>

                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">2. Fédéralisme</h6>
                              <p className="text-xs text-carnet-ink-soft">Pro-européen, vision ambitieuse d'intégration</p>
                            </div>

                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">3. Unionisme</h6>
                              <p className="text-xs text-carnet-ink-soft">Coopération intergouvernementale</p>
                            </div>
                          </div>
                        </div>

                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">9 mai 1950 : Discours de l'horloge</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <p className="text-xs text-carnet-ink-soft">(Lendemain de la commémoration de l'armistice, aujourd'hui journée de l'Europe)</p>
                            ...
                            <blockquote className="bg-carnet-paper-2 p-3 rounded italic border-l-2 border-carnet-rule">
                              ...
                              <footer className="text-sm text-carnet-ink-soft mt-1">— Robert Schuman</footer>
                            </blockquote>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Synthèse</h5>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">I.2. Coopération, rivalités et ingérences</h3>
                  <div className="space-y-6">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">"Ring of Fire" - L'anneau de feu européen</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>The Economist (2014)</strong> - <em>"Ring of Fire"</em></p>
                              <p className="text-carnet-ink-soft italic">Échec des politiques de voisinage, anneau de feu autour de l'Europe</p>
                            </div>

                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold mb-2 text-carnet-ink">Carte du voisinage instable de l'Europe</h6>
                              ...
                              <div className="mt-2 bg-carnet-paper p-2 rounded">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Stratégies de l'UE pour pacifier son voisinage</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                              ...
                              <div className="border border-carnet-rule p-3 rounded bg-carnet-paper-2">
                                ...
                                <p className="text-xs text-carnet-ink-soft">Voisinage crisogène, suite de la conférence de Barcelone</p>
                              </div>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Dépendance sécuritaire aux États-Unis</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="grid grid-cols-2 gap-3">
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink">70%</p>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Focus : Le programme Frontex</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            ...
                            <div className="space-y-2">
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                ...
                                <p className="text-xs text-carnet-ink-soft">Mise en commun des moyens policiers pour contrôler les frontières</p>
                              </div>

                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p><strong>2020</strong> : Garde-côtes et garde-frontières européens renforcés</p>
                                <p className="text-xs text-carnet-ink-soft">Budget multiplié par 5, corps permanent de 10 000 agents d'ici 2027</p>
                              </div>
                            </div>
                          </div>
                        </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">I.3. Modèle et puissance de l'Europe</h3>
                  <div className="space-y-6">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Mythe : l'Europe puissance</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Limites économiques du modèle</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Mouhoub Mouhoud</strong> : Artefacte statistique</p>
                              <p className="text-carnet-ink-soft">1% PIB, PAC, secteurs stratégiques sous-investis</p>
                            </div>
                            ...
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              ...
                              <p className="text-xs text-carnet-ink-soft">Lettre ouverte pour une Europe puissance militaire</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">L'exception française dans un ensemble fragile</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <p>
                            ...
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <p className="italic text-carnet-ink">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Incompatibilité du modèle avec les rivalités actuelles</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <p className="font-medium text-carnet-ink mb-1">Question centrale :</p>
                              <p className="italic">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Obstacles internes et externes</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Désillusion et retour à la géopolitique</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <p>
                            ...
                            <div className="border-l-2 border-carnet-rule pl-4">
                              ...
                              <p className="text-carnet-ink-soft">Renonce à la puissance, mais une quête dans certains points de puissance</p>
                            </div>
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Vers une boussole stratégique</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink">💻 Numérique</p>
                                <p className="text-xs">Cloud européen, souveraineté avec RGPD</p>
                              </div>
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink">⚔️ Militaire</p>
                                <p className="text-xs">Défense européenne autonome</p>
                              </div>
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink">🌱 Environnement</p>
                        ...
                        {/* Études de cas (EDC) */}
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-3">Études de cas (EDC)</h5>

                          <div className="space-y-4">
                            <div className="bg-carnet-paper-2 p-4 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">EDC 1 : Paix ou faiblesse ? Prix Nobel de la paix</h6>
                              <div className="space-y-2 text-sm text-carnet-ink">
                                <p>
                            ...
                            <div className="bg-carnet-paper-2 p-4 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">EDC 2 : L'Europe garde un normative power (écologie) dans la mondialisation</h6>
                              <div className="space-y-2 text-sm text-carnet-ink">
                                <p className="font-medium">Montrer que les intérêts économiques priment sur la puissance normative UE</p>

                                <div className="bg-carnet-paper p-3 rounded border border-carnet-rule">
                            ...
                            <div className="bg-carnet-paper-2 p-4 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-2">EDC 3 : Changement de paradigme - Allemagne</h6>
                              <div className="space-y-2 text-sm text-carnet-ink">
                                <p>
                                  Plus de certitude de vivre dans un monde post-stratégique et post-conflictuel (post-Clausewitzian)
                                </p>

                                <div className="border-l-2 border-carnet-rule pl-3">
                                  <p><strong>"Wandel Durch Handel"</strong> (Changement par le commerce)</p>
                                  <p className="text-xs text-carnet-ink-soft">Doctrine allemande traditionnelle</p>
                                </div>
          ...
          <Card className="border border-carnet-rule bg-carnet-paper-2 shadow-none mb-8">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-3">
                <AlertTriangle className="h-6 w-6 text-carnet-ink-soft" />
                II. Les défis contemporains de l'Union européenne
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">II.1. Les dépendances de l'Europe</h3>
                  <div className="space-y-6">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Dépendance historique au gaz russe</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="grid grid-cols-2 gap-3">
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink">55%</p>
                                <p className="text-xs">du gaz venait de Russie</p>
                              </div>
                              <div className="bg-carnet-paper-2 p-3 rounded border">
                                <p className="font-semibold text-carnet-ink mb-1">🇺🇸 Dépendance militaire</p>
                                <p className="text-xs">Sous-investissement depuis la SGM</p>
                              </div>
                            </div>

                            <div className="bg-carnet-paper p-3 rounded">
                              <p className="font-semibold text-carnet-ink mb-1">Réponses allemandes :</p>
                              <div className="space-y-1 text-xs">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Géopolitique des tubes</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Philippe Rekacewicz</strong> - Géopolitique des tubes</p>
                              <p className="text-carnet-ink-soft italic">Importance des sources d'approvisionnement d'hydrocarbures dans les rapports de force mondiaux</p>
                            </div>
                            ...
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              ...
                              <p className="text-xs text-carnet-ink-soft mt-1">Nécessité de diversification énergétique et développement durable</p>
                            </div>
                          </div>
                        </div>

                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Fin de la culture de la retenue</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Ampelkoalition</strong> (Coalition feu tricolore allemande)</p>
                              <p className="text-carnet-ink-soft">Réarmer alors que Verts au pouvoir, une Realpolitik</p>
                            </div>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">📋 Étude de cas : KUKA AG</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Dépendance structurelle à l'OTAN</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">L'Europe n'est pas Schumpeterienne</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Daniel Cohen</strong> - Article Le Monde (2002)</p>
                              <p className="text-carnet-ink-soft italic">Analyse du retard technologique européen</p>
                            </div>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-3">📋 Études de cas technologiques</h5>

                          <div className="space-y-3">
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-1">KUKA AG</h6>
                            ...
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <h6 className="font-semibold text-carnet-ink mb-1">Photovoltaïque</h6>
                              <p className="text-xs text-carnet-ink-soft">
                    ...
                    {/* Synthèse */}
                    <div className="bg-carnet-paper p-4 rounded-lg border-l-4 border-gray-500">
                      <h5 className="font-semibold text-carnet-ink mb-2">💡 Synthèse des dépendances européennes</h5>
                      <div className="text-sm text-carnet-ink space-y-2">
                        <p>
                        ...
                        <p className="italic text-carnet-ink-soft mt-2">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">II.2. Une polycrise : typologie des défis de l'Europe</h3>
                  <div className="space-y-6">
                    ...
                    <div className="bg-carnet-paper p-4 rounded-lg border-l-4 border-gray-400">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <h5 className="font-semibold text-carnet-ink">Concept de « Polycrise »</h5>
                      </div>
                      <p className="text-sm text-carnet-ink">
                        <strong>Guy Verhofstadt</strong> - Député européen belge, <em>Le mal européen</em> (2016)
                      </p>
                      <p className="text-xs text-carnet-ink-soft mt-1 italic">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">💰 1. Économique</h5>
                        <p className="text-xs text-carnet-ink">Crise de la dette souveraine, Grexit</p>
                      </div>
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">🏛️ 2. Identitaire</h5>
                        <p className="text-xs text-carnet-ink">Désunion Ouest/Est, singularités nationales</p>
                      </div>
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">🚶‍♂️ 3. Migratoire</h5>
                        <p className="text-xs text-carnet-ink">Voisinage instable, 1,5M en 2015</p>
                      </div>
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">⚡ 4. Énergétique</h5>
                        <p className="text-xs text-carnet-ink">Dépendance gaz russe, diversification</p>
                      </div>
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">⚔️ 5. Guerre</h5>
                        <p className="text-xs text-carnet-ink">Ukraine, retour de la géopolitique</p>
                      </div>
                      <div className="bg-carnet-paper p-4 rounded-lg border border-carnet-rule">
                        <h5 className="font-semibold text-carnet-ink mb-2">👥 6. Démographique</h5>
                        <p className="text-xs text-carnet-ink">"Suicide démographique" (Godet)</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Origines et ampleur</h5>
                          <div className="space-y-2 text-sm text-carnet-ink">
                            ...
                            <div className="bg-carnet-paper-2 p-3 rounded border mt-3">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Groupe de Visegrád (V4)</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <p><strong>Pologne (2016) :</strong> 586 000 permis de résidence</p>
                              <p className="text-xs text-carnet-ink-soft">Soit 20% du total de l'Union européenne</p>
                            </div>

                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>V4</strong> - Formé en 1991 (Hongrie, Pologne, République tchèque, Slovaquie)</p>
                              <p className="text-xs text-carnet-ink-soft">Initialement pour faciliter l'intégration OTAN</p>
                              <p className="text-xs mt-1">Maintenant : défense de la souveraineté face à « Bruxelles »</p>
                            </div>

                            <blockquote className="bg-carnet-paper p-3 rounded italic text-carnet-ink">
                              « Ils n'ont pas confiance dans le modèle occidental d'une société multiculturelle »
                              <footer className="text-xs text-carnet-ink-soft mt-1">— Jacques Rupnik</footer>
                            </blockquote>
                          </div>
                        </div>

                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Conséquences : Montée de l'extrême-droite</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">II.3. Désillusions européennes</h3>
                  <div className="space-y-6">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Une harmonie impossible ?</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>Henry Kissinger</strong> (1970), Secrétaire d'État américain :</p>
                              <blockquote className="bg-carnet-paper-2 p-3 rounded italic border-l-2 border-carnet-rule mt-2">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Définition et portée</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <p>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Partis eurosceptiques en Europe</h5>
                          <div className="grid md:grid-cols-2 gap-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                              <div className="bg-carnet-paper-2 p-2 rounded border">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Moments clés de l'euroscepticisme</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <p><strong>2005 :</strong> Non au traité constitutionnel par référendum</p>
                              <p className="text-xs text-carnet-ink-soft">France et Pays-Bas - Distance entre populations et construction européenne</p>
                            </div>

                            <div className="bg-carnet-paper-2 p-3 rounded border">
                              <p><strong>"Opting out" :</strong> Europe à géométrie variable</p>
                              <p className="text-xs text-carnet-ink-soft">Certaines politiques ne s'appliquent pas dans tous les pays</p>
                            </div>
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Héritages et divergences</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Cas Viktor Orbán (Hongrie)</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <blockquote className="bg-carnet-paper-2 p-3 rounded italic border-l-2 border-carnet-rule">
                    ...
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      ...
                      <div className="space-y-4">
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Typologie du déclin</h5>
                          <div className="grid md:grid-cols-2 gap-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                              <div className="bg-carnet-paper-2 p-2 rounded border">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Le "Temps des prédateurs"</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="border-l-2 border-carnet-rule pl-4">
                              <p><strong>François Heisbourg</strong> - "Tiersmondialisation de l'UE"</p>
                              <p className="text-carnet-ink-soft italic">L'Europe risque de devenir un acteur de second plan</p>
                            </div>
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Atouts européens restants</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
                            <div className="space-y-2">
                        ...
                        <div className="bg-carnet-paper p-4 rounded-lg">
                          <h5 className="font-semibold text-carnet-ink mb-2">Déficits structurels</h5>
                          <div className="space-y-3 text-sm text-carnet-ink">
          ...
          <Card className="border border-carnet-rule bg-carnet-paper-2 shadow-none mb-8">
            <CardHeader>
              <CardTitle className="text-2xl flex items-center gap-3">
                <Flag className="h-6 w-6 text-carnet-ink-soft" />
                III. Les voies de l'avenir et la réinvention de l'Europe
              </CardTitle>
            </CardHeader>
            <CardContent>
              <div className="space-y-8">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">III.1. Une Europe plurielle : confrontée aux crises de différentes dans une ampleur différente</h3>
                  <div className="space-y-6">
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      <h4 className="text-lg font-semibold text-carnet-ink mb-4 flex items-center gap-2">
                      ...
                      <div className="space-y-4 text-sm text-carnet-ink">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">III.2. La stratégie de l'UE : le tournant actuel</h3>
                  <div className="space-y-6">
                    <div className="bg-carnet-paper-2 p-6 rounded-lg border border-carnet-rule">
                      <h4 className="text-lg font-semibold text-carnet-ink mb-4 flex items-center gap-2">
                        <Shield className="h-5 w-5" />
                ...
                <div>
                  <h3 className="text-lg font-semibold text-carnet-ink mb-4">III.3. L'Union Européenne est un groupement supranational formé de 27 pays...</h3>
                  <div className="space-y-6">
        ...
        {/* Note */}
        <Card className="mt-8 bg-carnet-paper border border-carnet-rule">
          <CardContent className="p-6">
            <p className="text-carnet-ink text-sm">
          ...
          <Link to="/formation/geopolitique/chronologie-europe">
            <Card className="h-full hover:shadow-lg transition-all duration-200 cursor-pointer border-2 border-transparent hover:border-carnet-red/40">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-sm text-carnet-ink-soft">Histoire européenne</p>
              </CardContent>
            </Card>
          </Link>
