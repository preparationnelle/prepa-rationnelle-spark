    ...
    <div className="relative">
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm mb-6">
          ...
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <span className="text-carnet-ink-soft">Guerre économique</span>
        </nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-carnet-ink">Exemples historiques</h4>
                    <p className="text-carnet-ink">
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-carnet-ink">Début Guerre froide économique</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-pr-black-dark rounded-full mt-2"></div>
                    <div>
                      ...
                      <div className="text-carnet-ink">Tariffs Trump</div>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    <div className="w-2 h-2 bg-pr-black-dark rounded-full mt-2"></div>
                    <div>
                      ...
                      <div className="text-carnet-ink">Sanctions post-invasion Ukraine</div>
                    </div>
                  </div>
                </div>
              </CardContent>
          ...
          <div className="space-y-6">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="text-center p-3 bg-red-50 rounded-lg">
                    ...
                    <div className="text-sm text-carnet-ink-soft">Béton mondial impacté</div>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  <DollarSign className="h-5 w-5 text-carnet-red" />
                  Thématiques pertinentes
                </CardTitle>
              </CardHeader>
              <CardContent>
