    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <nav className="flex items-center space-x-2 text-sm mb-6">
          ...
          <Link to="/formation/geopolitique" className="text-emerald-600 hover:text-emerald-800">
            Géopolitique
          </Link>
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <Link to="/formation/geopolitique/etudes-de-cas" className="text-emerald-600 hover:text-emerald-800">
            Thèmes centraux
          </Link>
          <ChevronRight className="h-4 w-4 text-gray-400" />
          <span className="text-gray-600">Forêt</span>
        </nav>
