        ...
        <Card className="mb-8 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
          <CardHeader>
            <div className="flex items-center gap-3">
              ...
              <div>
                <CardTitle className="text-3xl font-bold">Migrations internationales</CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
              <div className="bg-white/10 rounded-lg p-3">
                <div className="text-2xl font-bold">304M</div>
                <div className="text-sm text-blue-100">Migrants internationaux</div>
              </div>
              <div className="bg-white/10 rounded-lg p-3">
                <div className="text-2xl font-bold">3,7%</div>
                <div className="text-sm text-blue-100">Population mondiale</div>
              </div>
              <div className="bg-white/10 rounded-lg p-3">
                <div className="text-2xl font-bold">122M</div>
                <div className="text-sm text-blue-100">Déplacés forcés</div>
              </div>
              <div className="bg-white/10 rounded-lg p-3">
                <div className="text-2xl font-bold">850Md$</div>
                <div className="text-sm text-blue-100">Remittances</div>
              </div>
            </div>
          </CardContent>
        </Card>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              {keyFigures.map((figure, index) => (
                <div key={index} className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                  <div className="text-2xl font-bold text-blue-800">{figure.value}</div>
                  <div className="text-sm font-medium text-blue-700 mb-1">{figure.label}</div>
              ...
              <div className="space-y-4">
                {topDestinations.map((dest, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                    <div>
                      <div className="font-semibold text-green-800">{dest.country}</div>
                      <div className="text-sm text-green-600">{dest.note}</div>
                    </div>
                    <div className="text-right">
                      <div className="font-bold text-green-700">{dest.migrants}</div>
                      <div className="text-xs text-green-600">{dest.rank} mondial</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="space-y-4">
                {refugeeHosts.map((host, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-orange-50 rounded-lg border border-orange-200">
                    <div>
                      <div className="font-semibold text-orange-800">{host.country}</div>
                      <div className="text-sm text-orange-600">{host.origin}</div>
                    </div>
                    <div className="font-bold text-orange-700">{host.refugees}</div>
                  </div>
                ))}
              </div>
              <div className="mt-4 p-3 bg-gray-100 rounded-lg">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="causes">
                <AccordionTrigger className="text-lg">
                  I. Causes et dynamiques migratoires
                </AccordionTrigger>
                <AccordionContent>
                  <div className="space-y-4">
                    <div className="bg-blue-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-blue-800 mb-2">Facteurs de déplacement</h4>
                    ...
                    <div className="bg-green-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-green-800 mb-2">Évolution des flux</h4>
                ...
                <AccordionContent>
                  <div className="space-y-4">
                    <div className="bg-orange-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-orange-800 mb-2">Conséquences démographiques</h4>
                    ...
                    <div className="bg-purple-50 p-4 rounded-lg">
                      <h4 className="font-semibold text-purple-800 mb-2">Conséquences économiques</h4>
