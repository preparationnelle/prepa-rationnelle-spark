...
plt.legend(); plt.show()`}
                ...
                <div>
                  <h4 className="font-semibold mb-2">4. Marche aléatoire simple sur ℤ</h4>
                  <div className="mb-4">
                    <img src="/lovable-uploads/13c4b897-93dd-4ee7-912e-164d20d70848.png" alt="Énoncé marche aléatoire" className="w-full rounded-lg border" />
                  </div>
                  
                  <div className="space-y-4">
                    <div>
                      <h5 className="font-medium mb-2">Question a) Simulation de base</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
{`import random as rd
...
print(position_finale(10))`}
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Question b) Marche biaisée avec probabilité p</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
...
print(position_biaisee(10, p=0.7))`}
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Question c) Nombre de passages à l'origine</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
...
print(passages_origine(10))`}
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Question d) Temps de sortie d'un intervalle</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
...
print(temps_sortie(5))`}
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Question e) Moyenne empirique sur plusieurs essais</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
...
print(moyenne_position(10, 10000))`}
                    ...
                    <div>
                      <h5 className="font-medium mb-2">Question f) Estimation empirique vs théorique</h5>
                      <div className="bg-slate-900 rounded-lg p-4">
                        <pre className="text-green-400 text-sm">
