  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-[#F8FAFF] relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-10 w-28 h-28 bg-red-200 rounded-full opacity-10 animate-pulse-slow"></div>
        <div className="absolute top-40 right-20 w-48 h-48 bg-orange-100 rounded-full opacity-10 animate-pulse-slow"></div>
        <div className="absolute bottom-40 left-20 w-56 h-56 bg-red-200 rounded-full opacity-5 animate-pulse"></div>
        <div className="absolute top-1/4 left-1/3 w-64 h-64 bg-orange-50 rounded-full opacity-10 animate-pulse-slow"></div>
        <div className="absolute top-3/4 right-1/4 w-40 h-40 bg-red-100 rounded-full opacity-5 animate-pulse"></div>
        ...
        <nav className="sticky top-0 z-50 bg-[#F8FAFF]/95 backdrop-blur supports-[backdrop-filter]:bg-[#F8FAFF]/60 border-b border-border/40 relative z-10">
          <div className="container mx-auto px-4 py-2">
            <div className="flex items-center text-xs text-muted-foreground">
              ...
              <ChevronRight className="h-3 w-3 text-muted-foreground/50 mx-1" />
              <Link to="/formation/chinois" className="hover:text-foreground transition-colors">
                Chinois
              </Link>
              <ChevronRight className="h-3 w-3 text-muted-foreground/50 mx-1" />
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
                ...
                <span className="text-red-500">Chinois</span>
              </h1>
              <p className="text-xl sm:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
                Préparation complète au concours SESAME - Chinois
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link to="/">
                  <Badge variant="outline" className="px-4 py-2 border-red-500 text-red-600 hover:bg-red-50">
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-12">
              {/* Grammar Section */}
              <Card className="hover:shadow-xl transition-all duration-300 border-red-200 hover:border-red-300">
                ...
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    Maîtrisez la grammaire chinoise avec des exercices interactifs et des explications détaillées.
                  </p>
                  <Link to="/formation/chinois/grammaire">
                    <Badge className="bg-red-500 hover:bg-red-600 text-white cursor-pointer">
              ...
              <Card className="hover:shadow-xl transition-all duration-300 border-red-200 hover:border-red-300">
                ...
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    Découvrez la civilisation et la culture chinoises à travers l'histoire et l'actualité.
                  </p>
                  <Link to="/formation/chinois/civilisation">
                    <Badge className="bg-red-500 hover:bg-red-600 text-white cursor-pointer">
              ...
              <Card className="hover:shadow-xl transition-all duration-300 border-red-200 hover:border-red-300">
                ...
                <CardContent className="p-6">
                  <p className="text-gray-600 mb-4">
                    Enrichissez votre vocabulaire chinois avec des flashcards et des exercices thématiques.
                  </p>
                  <Link to="/formation/chinois/vocabulaire">
                    <Badge className="bg-red-500 hover:bg-red-600 text-white cursor-pointer">
              ...
              <CardContent className="p-6">
                <div className="grid md:grid-cols-2 gap-6">
                  {generatorTools.map((tool) => (
                    <div key={tool.id} className="flex items-start space-x-4 p-4 rounded-lg border border-red-100 hover:border-red-300 transition-colors">
