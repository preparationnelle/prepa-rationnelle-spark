      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-carnet-red">
            ...
            <ChevronRight className="h-3 w-3 text-carnet-red/80 mx-1" />
            <span className="text-carnet-red font-medium">Séance 13 - Mini Projet</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="text-center mb-8">
          <div className="flex justify-center mb-4">
            <div className="w-16 h-16 bg-carnet-red/10 rounded-full flex items-center justify-center">
              <Code2 className="h-8 w-8 text-carnet-red" />
            </div>
          </div>
          <h1 className="text-3xl font-bold mb-4 text-carnet-red-deep">Séance 13 : Mini-projet – ateliers & répétitions</h1>
          ...
          <div className="max-w-2xl mx-auto mb-6">
            <div className="bg-pr-orange-pale border border-carnet-red/30 rounded-lg p-4 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                ...
                <div className="flex flex-col items-center">
                  <span className="text-sm text-carnet-red font-medium mb-1">Type</span>
                  <span className="text-lg font-semibold text-carnet-red-deep">Mini Projet</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="text-sm text-carnet-red font-medium mb-1">Durée</span>
                  <span className="text-lg font-semibold text-carnet-red-deep">Séance entière</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex justify-between items-center mb-8 max-w-4xl mx-auto">
          <Link
            ...
            className="flex items-center gap-2 text-carnet-red hover:text-carnet-red transition-colors"
          >
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-pr-orange-pale border border-carnet-red/30 rounded-lg p-6">
            ...
            <p className="text-carnet-red-deep mb-4">
            ...
            <p className="text-carnet-red-deep mt-4">
