                ...
                <div className="text-center">
                  ...
                  <div className="space-y-4 text-left">
                    ...
                    {questions.map((q, idx) => {
                      ...
                      return (
                        <div key={q.id} className={`p-4 rounded-lg border-2 ${isCorrect ? 'border-green-500 bg-green-50' : 'border-red-500 bg-red-50'}`}>
          ...
          <div className="max-w-2xl mx-auto mb-4">
            <div className="bg-orange-50 border border-orange-200 rounded-lg p-4 text-center">
              <p className="text-orange-800 font-medium">
                ⚠️ Répondez à toutes les questions pour voir le corrigé ({Object.keys(selectedAnswers).length}/{questions.length} répondues)
              </p>
            </div>
          </div>
        )}
          ...
          <div className="max-w-2xl mx-auto mb-6">
            <div className="bg-green-50 border-2 border-green-500 rounded-lg p-6 text-center">
              ...
              <Button
                ...
                size="lg"
                className="flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-bold px-8 py-6 text-lg mx-auto"
              >
