      ...
      <div className="container mx-auto py-8 px-4 max-w-6xl">
            ...
            <div className="bg-pr-orange-pale border border-carnet-red/30 rounded-lg p-4 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-xl font-bold text-carnet-red-deep">10</span>
                </div>
                <div className="flex flex-col items-center">
                  <span className="text-sm text-carnet-red font-medium mb-1">Fonctions</span>
                  <span className="text-xl font-bold text-carnet-red-deep">50+</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">import numpy as np</code>
                <p className="text-sm mt-1">NumPy principal pour le calcul mathématique</p>
              </div>
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">import numpy.linalg as al</code>
                <p className="text-sm mt-1">Sous-module algèbre linéaire</p>
              </div>
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">import numpy.random as rd</code>
                <p className="text-sm mt-1">Génération de nombres aléatoires</p>
              </div>
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">import matplotlib.pyplot as plt</code>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-r from-pr-orange-pale to-pr-orange-pale/60 mb-8">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">np.pi</code>
                <p className="text-sm mt-1">π (pi)</p>
              </div>
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold">np.e</code>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-r from-pr-orange-pale to-pr-orange-pale/60 mb-8">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-white border-l-4 border-carnet-red/40 p-4 rounded">
                <code className="text-carnet-red font-semibold text-sm">np.array([[a1,1,...,a1,p],...,[an,1,...,an,p]])</code>
        ...
        <div className="text-center">
          <div className="flex gap-3 justify-center flex-wrap">
            <Link to="/formation/oteria/python-bases-qcm">
              <button className="inline-flex items-center gap-2 bg-carnet-red text-white px-4 py-2 rounded-lg hover:bg-carnet-red-deep transition-colors">
