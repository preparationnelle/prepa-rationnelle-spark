...
import { matricesMarkovFlashcards, getMatricesMarkovFlashcardsByCategory, getMatricesMarkovFlashcardsByDifficulty, shuffleMatricesMarkovFlashcards } from '@/data/matricesMarkovFlashcardsData';
import { LatexRenderer } from '@/components/LatexRenderer';

const OteriaMatricesMarkovFlashcardsPage = () => {
  ...
  const [filteredCards, setFilteredCards] = useState(matricesMarkovFlashcards);

  // Mettre à jour les cartes filtrées
  useEffect(() => {
    let filtered = matricesMarkovFlashcards;

    if (selectedCategory !== 'all') {
      filtered = getMatricesMarkovFlashcardsByCategory(selectedCategory);
    }
    ...
    if (isShuffled) {
      filtered = shuffleMatricesMarkovFlashcards(filtered);
    }
  ...
  const categories = ['all', ...Array.from(new Set(matricesMarkovFlashcards.map(card => card.category)))];
    ...
    <div className="min-h-screen bg-white">
      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-teal-600">
            ...
            <ChevronRight className="h-3 w-3 text-teal-400 mx-1" />
            <span className="text-teal-600 font-medium">Séance 11 - Flashcards</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4 max-w-4xl">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-4 text-teal-900">Chapitre 11 : Matrices & Chaînes de Markov</h1>
          <p className="text-lg text-blue-800 max-w-3xl mx-auto mb-6">
            Flashcards interactives — Testez vos connaissances sur les matrices et processus stochastiques
          </p>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 shadow-sm">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-2xl font-bold text-blue-900">{matricesMarkovFlashcards.length}</span>
                </div>
                <div className="flex flex-col items-center">
                ...
                <div>
                  ...
                  <Select value={selectedCategory} onValueChange={setSelectedCategory}>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="Types de matrices">Types de matrices</SelectItem>
                      <SelectItem value="Déterminant">Déterminant</SelectItem>
                      <SelectItem value="Matrices inversibles">Matrices inversibles</SelectItem>
                      <SelectItem value="Valeurs propres">Valeurs propres</SelectItem>
                      <SelectItem value="Vecteurs propres">Vecteurs propres</SelectItem>
                      <SelectItem value="Systèmes linéaires">Systèmes linéaires</SelectItem>
                      <SelectItem value="Chaînes de Markov">Chaînes de Markov</SelectItem>
                      <SelectItem value="Vecteurs stationnaires">Vecteurs stationnaires</SelectItem>
                      <SelectItem value="Matrices stochastiques">Matrices stochastiques</SelectItem>
        ...
        {/* Carte principale */}
        <div className="mb-6">
          <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-100 min-h-[400px]">
