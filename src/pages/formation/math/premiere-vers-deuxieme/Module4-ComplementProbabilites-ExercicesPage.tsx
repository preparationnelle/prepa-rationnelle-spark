      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-carnet-ink-soft max-w-2xl mx-auto mb-8">Les exercices seront créés spécifiquement pour ce module. Les anciens exercices liés à une autre formation ont été supprimés.</p>
