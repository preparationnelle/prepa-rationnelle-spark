...
const Module5VariableAleatoireExercicesPage: React.FC = () => {
  return (
      ...
      <nav className="sticky top-0 z-50 bg-carnet-paper/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-[#2D5BFF]">
            ...
            <ChevronRight className="h-3 w-3 text-[#2D5BFF]/50 mx-1" />
            <span className="text-[#2D5BFF] font-bold">Module 5 Exercices - Variable aléatoire</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-pr-orange-pale to-indigo-50 mb-8">
          <div className="p-8">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-carnet-red to-indigo-600 bg-clip-text text-transparent mb-2">
              Module 5 - exercice (Variable aléatoire)
            </h1>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold text-carnet-ink mb-4">Contenu en construction</h2>
            <p className="text-carnet-ink-soft max-w-2xl mx-auto mb-8">Les exercices dédiés seront ajoutés prochainement.</p>
...
export default Module5VariableAleatoireExercicesPage;
