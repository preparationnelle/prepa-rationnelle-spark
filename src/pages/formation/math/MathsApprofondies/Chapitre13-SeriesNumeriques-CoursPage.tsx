                                ...
                                <Card className="border border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-300 bg-carnet-paper-2">
                                        ...
                                        <CardContent className="space-y-6 pt-6">
                                                <div>
                                                        ...
                                                        <ComparisonGrid>
                                                                <ComparisonCard label="Critère de comparaison">
                                                                        <p className="mb-2">Si <LatexRenderer latex="0 \le u_n \le v_n" /> :</p>
                                                                ...
                                                                <ComparisonCard label="Critère d'équivalence">
                                                                        <p className="mb-2">Si <LatexRenderer latex="u_n \sim v_n" /> et <LatexRenderer latex="v_n \geq 0" /> :</p>
                                                                        <p className="text-sm">
                                                                                Alors <LatexRenderer latex="\sum u_n" /> et <LatexRenderer latex="\sum v_n" /> sont <strong>de même nature</strong>.
                                                                        </p>
                                                                </ComparisonCard>
                                                        </ComparisonGrid>
                                                </div>
