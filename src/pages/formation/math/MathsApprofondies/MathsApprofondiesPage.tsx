...
const MathsApprofondiesPage = () => {
  return (
    <div className="carnet-paper min-h-screen">
      <SEOHead
        canonical="/formation/maths-premiere-approfondies"
        title="Maths Approfondies · 1ère année ECG · Prépa Rationnelle"
        description="Programme complet de Maths Approfondies 1ère année ECG : démonstrations rigoureuses, concepts théoriques avancés, préparation intensive aux concours."
      />
      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
            ...
            <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
            <span className="carnet-eyebrow text-[11px]">Maths Approfondies · 1A</span>
          </div>
        </div>
      </nav>
        ...
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <p className="font-instrument text-[17px] lg:text-[19px] leading-[1.65] text-carnet-ink-soft max-w-[640px] mb-8">
              Formation <span className="carnet-hl font-lora italic">théorique avancée</span> pour la 1ère année ECG, avec focus sur les concepts fondamentaux et les démonstrations rigoureuses.
            </p>
        ...
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <div className="space-y-4">
              {mathsApprofondies1ereAnneeData.semestre1.chapters.map((chapter, idx) => {
      ...
      <section className="relative pb-24">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <div className="space-y-4">
              {mathsApprofondies1ereAnneeData.semestre2.chapters.map((chapter, idx) => {
                const tilt = idx % 4 === 1 ? 'carnet-tilt-r' : idx % 4 === 3 ? 'carnet-tilt-l' : '';
                return (
                  <motion.div
                    key={chapter.id}
