        ...
        <Card className="border border-slate-200 shadow-sm hover:shadow-md transition-shadow duration-300 bg-carnet-paper-2">
          ...
          <CardContent className="space-y-8 pt-6">
            <div>
              ...
              <ComparisonGrid>
                <ComparisonCard label="Probabilités totales">
                  <p className="text-sm mb-2 italic">Si <LatexRenderer latex="(B_n)" /> est un système complet d'événements :</p>
                  <div className="text-center my-2">
                    <LatexRenderer latex="\mathbb{P}(A) = \sum_n \mathbb{P}(A \cap B_n) = \sum_n \mathbb{P}(B_n)\mathbb{P}_{B_n}(A)" />
                  </div>
                </ComparisonCard>
                <ComparisonCard label="Formule de Bayes">
                  <p className="text-sm mb-2 italic">Pour inverser le conditionnement :</p>
                  <div className="text-center my-2">
