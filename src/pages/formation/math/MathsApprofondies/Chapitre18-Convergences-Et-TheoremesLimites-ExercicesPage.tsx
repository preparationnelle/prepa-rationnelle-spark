      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-[#2D5BFF]">
            ...
            <ChevronRight className="h-3 w-3 text-[#2D5BFF]/50 mx-1" />
            <span className="text-[#2D5BFF] font-bold">Exercices - Chapitre 18</span>
          </div>
        </div>
      </nav>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-indigo-50 mb-8">
          <div className="p-8">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-4">
              Exercices - Chapitre 18 : Convergences & théorèmes limites
            </h1>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Les exercices du chapitre 18 seront disponibles prochainement. 
