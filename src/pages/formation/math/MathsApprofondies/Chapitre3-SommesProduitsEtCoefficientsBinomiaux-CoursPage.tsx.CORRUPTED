...
const Chapitre3SommesProduitsEtCoefficientsBinomiauxCoursPage = () => {
  return (
    ...
    >
                <p className="mb-2">Pour deux entiers <LatexRenderer latex={"m,n"} /> tels que <LatexRenderer latex={"m \\leq n"} /> et toute constante réelle <LatexRenderer latex={"c"} />, on a :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=m}^n c = (n-m+1)\\,c"} />)}
              </div
    >
    ...
    >
                <p className="mb-2">Pour <LatexRenderer latex={"q"} /> réel et <LatexRenderer latex={"n \\geq 0"} /> :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=0}^n q^i = \\begin{cases} n+1 & \\text{si } q = 1,\\\\ \\displaystyle\\frac{1-q^{n+1}}{1-q} & \\text{si } q \\neq 1. \\end{cases}"} />)}
                <p className="mb-2">Plus généralement, pour <LatexRenderer latex={"q \\neq 1"} /> et <LatexRenderer latex={"n \\geq m"} /> :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=m}^n q^i = q^m\\,\\frac{1-q^{n-m+1}}{1-q}"} />)}
              </div
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=m}^n x_{i+r} = \\sum\\limits_{j=m+r}^n x_{j}"} />)}
                <p className="mb-2">Lorsque <LatexRenderer latex={"r \\ge n"} /> et en définissant <LatexRenderer latex={"\\ell = r - i"} /> :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=m}^n x_{r-i} = \\sum\\limits_{\\ell=r-n}^{r-m} x_{\\ell}"} />)}
              </div
    >
    ...
    >
                <p className="mb-2">Pour toute suite <LatexRenderer latex={"(u_i)_{i \\geq 0}"} /> :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=0}^n (u_{i+1}-u_i) = u_{n+1} - u_0"} />)}
              </div
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{i=1}^n\\,\\sum\\limits_{j=1}^n x_{i,j} = \\sum\\limits_{j=1}^n\\,\\sum\\limits_{i=1}^n x_{i,j}"} />)}
              </div
    >
              <div
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\sum\\limits_{1 \\leq i \\leq j \\leq n} x_{i,j} = \\sum\\limits_{j=1}^n \\sum\\limits_{i=1}^j x_{i,j}"} />)}
              </div
    >
    ...
    >
              {orangeBox(<LatexRenderer latex={"\\displaystyle \\left(\\sum\\limits_{i=1}^n x_i\\right)^2 = \\sum\\limits_{i=1}^n x_i^2 + 2\\sum\\limits_{1 \\leq i < j \\leq n} x_i x_j"} />)}
              {/* Section 5 - Produits */}
              <Separator className="my-8" /
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle n! = \\prod\\limits_{i=1}^n i"} />)}
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\prod\\limits_{i=1}^n \\lambda = \\lambda^n"} />)}
              </div
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\prod\\limits_{i=0}^n \\frac{z_{i+1}}{z_i} = \\frac{z_{n+1}}{z_0}"} />)}
              </div
    >
            </CardContent
    >
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\binom{n}{p} = \\begin{cases} \\dfrac{n!}{p!\\,(n-p)!} & \\text{si }0 \\leq p \\leq n,\\\\ 0 & \\text{si }p > n.\\end{cases}"} />)}
    ...
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\binom{n}{p} = \\frac{n(n-1)\\cdots(n-p+1)}{p!}"} />)}
                <p className="mb-2">Par exemple :</p
    >
                {orangeBox(<LatexRenderer latex={"\\displaystyle \\binom{n}{2} = \\frac{n(n-1)}{2},\\quad \\binom{n}{3} = \\frac{n(n-1)(n-2)}{6}"} />)}
              </div
    >
              <div
    >
