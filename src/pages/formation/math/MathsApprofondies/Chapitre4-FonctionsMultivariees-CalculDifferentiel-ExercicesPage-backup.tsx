...
const Chapitre4FonctionsMultivariees_CalculDifferentielExercicesPage = () => {
  ...
  const DifficultyHeader = ({ 
    ...
    <div className="bg-gradient-to-r from-carnet-red/10 to-pr-black-pale border-l-4 border-carnet-red p-6 mb-6 rounded-r-lg shadow-sm">
    ...
    <Card className="mb-6 border-0 shadow-md hover:shadow-lg transition-shadow">
      <div className="p-6">
        <div className="flex items-start gap-3 mb-4">
          ...
          <div className="text-xs text-carnet-red bg-pr-gray-bg px-2 py-1 rounded">
            {difficulty}
          </div>
        </div>
    ...
    <div className="min-h-screen bg-[#EEF3FC]">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-pr-orange-pale to-indigo-50 mb-8">
          <div className="p-8">
            <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-carnet-red to-pr-black bg-clip-text text-transparent mb-4">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <p>Ainsi :</p>
                  <div className="text-center bg-pr-gray-bg p-3 rounded border">
          ...
          correction={
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-pr-gray-bg p-3 rounded border space-y-2">
          ...
          correction={
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-pr-gray-bg p-3 rounded border">
          ...
          correction={
            <div className="space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-pr-gray-bg p-3 rounded border space-y-3">
