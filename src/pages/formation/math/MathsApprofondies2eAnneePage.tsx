...
import { Award, ChevronRight, Sigma, Home, GraduationCap } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center text-xs font-medium text-gray-500">
            ...
            <ChevronRight className="h-3 w-3 mx-2 text-gray-300" />
            <span className="text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">Maths Approfondies 2A</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-12 px-4">
        ...
        <div className="text-center mb-16 max-w-4xl mx-auto">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white rounded-full border border-gray-200 shadow-sm text-sm font-medium text-gray-700">
            ...
            <span>2ème année ECG</span>
            <span className="w-1 h-1 rounded-full bg-gray-300 mx-1"></span>
            <span className="text-blue-600">Voie Théorique</span>
          </div>
        </div>
