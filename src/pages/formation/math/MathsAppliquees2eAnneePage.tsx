...
const MathsAppliquees2eAnneePage = () => {
  return (
    <div className="carnet-paper min-h-screen">
      <SEOHead
        canonical="/formation/maths-deuxieme-appliquees"
        title="Maths Appliquées · 2ème année ECG · Prépa Rationnelle"
        description="Programme complet de Maths Appliquées 2ème année ECG : approfondissement de l'algèbre, des probabilités et de l'analyse pour préparer les concours."
      />
      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
            ...
            <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
            <span className="carnet-eyebrow text-[11px]">Maths Appliquées · 2A</span>
          </div>
        </div>
      </nav>
        ...
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <p className="font-instrument text-[17px] lg:text-[19px] leading-[1.65] text-carnet-ink-soft max-w-[640px] mb-8">
              Formation <span className="carnet-hl font-lora italic">avancée</span> pour la 2ème année ECG, avec approfondissement de l'algèbre, des probabilités et de l'analyse.
            </p>
        ...
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <div className="space-y-4">
              {mathsAppliquees2eAnneeData.semestre1.chapters.map((chapter, idx) => {
      ...
      <section className="relative pb-24">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16">
          ...
          >
            ...
            <div className="space-y-4">
              {mathsAppliquees2eAnneeData.semestre2.chapters.map((chapter, idx) => {
                const tilt = idx % 4 === 1 ? 'carnet-tilt-r' : idx % 4 === 3 ? 'carnet-tilt-l' : '';
                return (
                  <motion.div
                    key={chapter.id}
