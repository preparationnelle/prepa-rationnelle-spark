...
import { Award, ChevronRight, Calculator, Home, GraduationCap } from 'lucide-react';
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center text-xs font-medium text-gray-500">
            ...
            <ChevronRight className="h-3 w-3 mx-2 text-gray-300" />
            <span className="text-blue-600 bg-blue-50 px-2 py-0.5 rounded-full">Maths Appliquées 2A</span>
          </div>
        </div>
      </nav>
