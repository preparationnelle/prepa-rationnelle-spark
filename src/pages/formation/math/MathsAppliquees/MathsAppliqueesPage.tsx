      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="mt-12 max-w-4xl mx-auto">
          <div className="bg-blue-50 rounded-xl p-8 text-center border-2 border-blue-200">
            <h2 className="text-2xl font-bold mb-4 text-blue-900">Ressources complémentaires</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 text-sm">
              <div className="bg-white p-3 rounded border border-blue-200">
                <span className="font-medium text-blue-900">{getTotalChaptersCount()} chapitres complets</span>
              </div>
              <div className="bg-white p-3 rounded border border-blue-200">
                <span className="font-medium text-blue-900">Quiz interactifs</span>
              </div>
              <div className="bg-white p-3 rounded border border-blue-200">
                <span className="font-medium text-blue-900">Exercices corrigés</span>
              </div>
            </div>
          </div>
        </div>
