    ...
    <div className="min-h-screen bg-[#F8FAFF] relative overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-[#F8FAFF]/95 backdrop-blur supports-[backdrop-filter]:bg-[#F8FAFF]/60 border-b border-border/40 relative z-10">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-muted-foreground">
            ...
            <span className="mx-1 text-muted-foreground/50">›</span>
            <span className="text-foreground font-medium">Maths Appliquées - 1ère année</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Maths Appliquées - 1ère année</h1>
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <span className="text-lg font-medium text-blue-600">1ère année ECG - Voie Appliquée</span>
          </div>
        </div>
