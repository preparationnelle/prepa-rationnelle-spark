      ...
      <nav className="sticky top-0 z-50 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-[#2D5BFF]">
            ...
            <ChevronRight className="h-3 w-3 text-[#2D5BFF]/50 mx-1" />
            <span className="text-[#2D5BFF] font-bold">Maths Appliquées</span>
          </div>
        </div>
      </nav>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">
              Formation mathématiques axée sur les applications pratiques pour la prépa ECG
            </p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              La formation Maths Appliquées sera disponible prochainement. 
              Nous travaillons actuellement à la création d'un contenu adapté 
              aux besoins spécifiques de la voie appliquée en prépa ECG.
            </p>
            <Link 
              to="/formation/maths-choix"
              className="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors"
            >
              Retourner au choix des options
            </Link>
          </div>
        </Card>
      </div>
