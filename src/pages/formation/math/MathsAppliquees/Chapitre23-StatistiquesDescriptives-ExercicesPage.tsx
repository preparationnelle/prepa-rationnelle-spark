...
const Chapitre23StatistiquesDescriptivesExercicesPage = () => {
  return (
      ...
      <nav className="sticky top-0 z-50 bg-carnet-paper/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-[#2D5BFF]">
            ...
            <ChevronRight className="h-3 w-3 text-[#2D5BFF]/50 mx-1" />
            <span className="text-green-600 font-bold">Chapitre 23 - Statistiques descriptives</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">Exercices - Chapitre 23 : Théorie approfondie et applications pratiques</p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold text-carnet-ink mb-4">Exercices en cours de construction</h2>
            <p className="text-carnet-ink-soft max-w-2xl mx-auto mb-8">
              Les exercices sur les statistiques descriptives seront disponibles prochainement.
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/formation/maths-statistiques-descriptives" className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors">Cours</Link>
              <Link to="/formation/maths-statistiques-descriptives-quiz" className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors">Quiz</Link>
            </div>
          </div>
        </Card>
      </div>
...
export default Chapitre23StatistiquesDescriptivesExercicesPage;
