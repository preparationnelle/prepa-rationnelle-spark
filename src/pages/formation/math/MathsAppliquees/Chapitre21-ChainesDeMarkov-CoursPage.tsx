        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">
              Cours - Chapitre 21 : Théorie approfondie et applications pratiques
            </p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Le cours sur les chaînes de Markov sera disponible prochainement.
            ...
            <div className="flex gap-4 justify-center">
              <Link
                to="/formation/maths-chaines-de-markov-exercices"
