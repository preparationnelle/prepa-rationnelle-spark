      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">Cours - Chapitre 22 : Théorie approfondie et applications pratiques</p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Cours en cours de construction</h2>
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Le cours sur la théorie des graphes approfondie sera disponible prochainement.
            ...
            <div className="flex gap-4 justify-center">
              <Link to="/formation/maths-theorie-des-graphes-approfondie-exercices" className="inline-flex items-center justify-center px-6 py-3 bg-green-600 text-white font-semibold rounded-lg hover:bg-green-700 transition-colors">Exercices</Link>
              <Link to="/formation/maths-theorie-des-graphes-approfondie-quiz" className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors">Quiz</Link>
            </div>
          </div>
        </Card>
      </div>
