...
const Chapitre23StatistiquesDescriptivesQuizPage = () => {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">Quiz - Chapitre 23 : Théorie approfondie et applications pratiques</p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              Le quiz sur les statistiques descriptives sera disponible prochainement.
            ...
            <div className="flex gap-4 justify-center">
              ...
              <Link to="/formation/maths-statistiques-descriptives-exercices" className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors">Exercices</Link>
            </div>
          </div>
        </Card>
      </div>
...
export default Chapitre23StatistiquesDescriptivesQuizPage;
