...
const Chapitre21ChainesDeMarkovExercicesPage = () => {
  return (
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">
              Exercices - Chapitre 21 : Théorie approfondie et applications pratiques
            </p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <Link
                to="/formation/maths-chaines-de-markov"
              ...
              <Link
                to="/formation/maths-chaines-de-markov-quiz"
                className="inline-flex items-center justify-center px-6 py-3 border-2 border-green-600 text-green-600 font-semibold rounded-lg hover:bg-green-50 transition-colors"
              >
                Quiz
              </Link>
...
export default Chapitre21ChainesDeMarkovExercicesPage;
