...
const Chapitre22TheorieDesGraphesApprofondieExercicesPage = () => {
  return (
      ...
      <div className="container mx-auto px-4 py-8">
        <Card className="border-0 shadow-lg bg-gradient-to-br from-green-50 to-emerald-50 mb-8">
          <div className="p-8">
            ...
            <p className="text-slate-600 text-lg">Exercices - Chapitre 22 : Théorie approfondie et applications pratiques</p>
          </div>
        </Card>
        ...
        <Card className="border-0 shadow-lg">
          <div className="p-12 text-center">
            ...
            <p className="text-carnet-ink-soft max-w-2xl mx-auto mb-8">
              Les exercices sur la théorie des graphes approfondie seront disponibles prochainement.
...
export default Chapitre22TheorieDesGraphesApprofondieExercicesPage;
