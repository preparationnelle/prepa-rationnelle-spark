      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Complexité du génitif allemand</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Formation selon le genre</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Article : des</p>
                  <p>Nom : -(e)s</p>
                  <p>Exemple : der Mann → des Mann<span className="text-pr-black">es</span></p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Article : des</p>
                  <p>Nom : -(e)s</p>
                  <p>Exemple : das Buch → des Buch<span className="text-pr-black">es</span></p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Règles orthographiques</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Quand ajouter "-e" avant "-s" :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <ul className="list-disc list-inside text-gray-700">
                    <li>Noms se terminant par une consonne : der Tag → des Tag<span className="text-pr-black">es</span></li>
                    <li>Noms monosyllabiques : der Mann → des Mann<span className="text-pr-black">es</span></li>
                    <li>Noms étrangers : der Park → des Park<span className="text-pr-black">s</span></li>
                  </ul>
                </div>
              </div>
              <div>
          ...
          {/* Usages principaux */}
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Usages principaux du génitif</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Possession :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Das Auto <span className="text-pr-black">des Mannes</span> ist neu.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Der Bruder <span className="text-pr-black">meiner Mutter</span> wohnt in Berlin.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Die Blätter <span className="text-pr-black">des Baumes</span> sind gelb.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ein Glas <span className="text-pr-black">des Weines</span> bitte.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Génitif avec prépositions</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">während</span> - pendant : während des Sommers</li>
                  <li><span className="text-pr-black">wegen</span> - à cause de : wegen des Regens</li>
                  <li><span className="text-pr-black">statt</span> - au lieu de : statt des Essens</li>
                  <li><span className="text-pr-black">trotz</span> - malgré : trotz des Wetters</li>
                  <li><span className="text-pr-black">innerhalb</span> - à l'intérieur de : innerhalb der Stadt</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold mb-3">Exemples :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Wegen <span className="text-pr-black">des schlechten Wetters</span> bleiben wir zu Hause.</p>
                  <p className="text-sm text-gray-700">(À cause du mauvais temps, nous restons à la maison.)</p>
                </div>
                <div className="bg-gray-50 p-4 rounded-lg mt-2">
                  <p>Trotz <span className="text-pr-black">der Gefahr</span> geht er hinaus.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Alternatives au génitif</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Das Haus <span className="text-pr-black">von meinem Bruder</span> ist groß.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p><span className="text-pr-black">Sein</span> Bruder wohnt in Berlin.</p>
          ...
          {/* Erreurs fréquentes */}
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Erreurs fréquentes</h2>
            <div className="space-y-4">
              <div>
