      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les six verbes modaux allemands</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Présentation des six verbes modaux</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  ...
                  <p>Ich <span className="text-pr-black">kann</span> Deutsch sprechen.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  ...
                  <p>Du <span className="text-pr-black">darfst</span> hier rauchen.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  ...
                  <p>Er <span className="text-pr-black">muss</span> arbeiten.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  ...
                  <p>Sie <span className="text-pr-black">soll</span> mehr lernen.</p>
                  <p className="text-sm text-gray-700">(Elle devrait étudier davantage.)</p>
                </div>
              </div>
              <div>
                <h3 className="font-semibold mb-3 text-pr-black">wollen (vouloir)</h3>
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="font-medium">Présent : will, willst, will, wollen, wollt, wollen</p>
                  <p>Wir <span className="text-pr-black">wollen</span> verreisen.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  ...
                  <p>Ich <span className="text-pr-black">mag</span> Schokolade.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Formation des temps composés</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich <span className="text-pr-black">habe</span> das <span className="text-pr-black">machen können</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich <span className="text-pr-black">hatte</span> das <span className="text-pr-black">machen können</span>.</p>
          ...
          {/* Double infinitif */}
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Le "double infinitif"</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Er ist nicht gekommen, <span className="text-pr-black">weil</span> er hat <span className="text-pr-black">arbeiten müssen</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich weiß, dass du das <span className="text-pr-black">hättest machen sollen</span>.</p>
          ...
          {/* Nuances sémantiques */}
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Nuances sémantiques importantes</h2>
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p><span className="text-pr-black">wollen</span> = vouloir : Du willst das machen. (Tu veux le faire.)</p>
                </div>
              </div>
              <div>
