...
const VocabulaireGeschichteFlashcardsPage = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Seconde Guerre mondiale": "bg-orange-100 text-orange-800",
      ...
      "Symboles de division": "bg-orange-100 text-orange-800",
      ...
      "Périodes nazies": "bg-orange-100 text-orange-800",
      ...
      "Débats historiques": "bg-orange-100 text-orange-800",
      ...
      "Dates mémorielles": "bg-orange-100 text-orange-800",
