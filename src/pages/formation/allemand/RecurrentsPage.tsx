      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les constructions subordonnées</h2>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich glaube, <span className="text-pr-black">dass</span> er kommt.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich bleibe zu Hause, <span className="text-pr-black">weil</span> es regnet.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p><span className="text-pr-black">Wenn</span> es regnet, bleibe ich zu Hause.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les prépositions et leurs cas</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Prépositions + Accusatif</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="mb-2">durch, für, gegen, ohne, um</p>
                  <p>Ich gehe <span className="text-pr-black">durch den</span> Park.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich komme <span className="text-pr-black">aus der</span> Schule.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich stelle die Lampe <span className="text-pr-black">auf den</span> Tisch. (ACC - mouvement)</p>
                  <p>Die Lampe steht <span className="text-pr-black">auf dem</span> Tisch. (DAT - position)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les verbes à particule séparable</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
              ...
              <ul className="space-y-2">
                <li>aufstehen → Ich <span className="text-pr-black">stehe</span> früh <span className="text-pr-black">auf</span>.</li>
                <li>ankommen → Der Zug <span className="text-pr-black">kommt</span> pünktlich <span className="text-pr-black">an</span>.</li>
                <li>mitmachen → Er <span className="text-pr-black">macht</span> gerne <span className="text-pr-black">mit</span>.</li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les verbes de modalité</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich <span className="text-pr-black">kann</span> gut Deutsch <span className="text-pr-black">sprechen</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Er <span className="text-pr-black">muss</span> viel <span className="text-pr-black">arbeiten</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Sie <span className="text-pr-black">will</span> nach Berlin <span className="text-pr-black">fahren</span>.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les erreurs fréquentes à éviter</h2>
            <div className="space-y-4">
              <div>
