      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les types de phrases interrogatives</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Questions fermées (Ja/Nein-Fragen)</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Questions ouvertes (W-Fragen)</h2>
            <div className="space-y-4">
              <div>
                <h3 className="font-semibold mb-2">Structure de base :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Mots interrogatifs courants</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-3 text-carnet-red">Questions sur les personnes/choses :</h3>
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">Wer?</span> - Qui ?</li>
                  <li className="ml-4">Wer kommt morgen? (Qui vient demain ?)</li>
                  <li><span className="text-pr-black">Was?</span> - Quoi ?</li>
                  <li className="ml-4">Was machst du? (Que fais-tu ?)</li>
                  <li><span className="text-pr-black">Wen?</span> - Qui ? (COD)</li>
                  <li className="ml-4">Wen siehst du? (Qui vois-tu ?)</li>
                  <li><span className="text-pr-black">Wem?</span> - À qui ? (COI)</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">Wann?</span> - Quand ?</li>
                  <li className="ml-4">Wann kommst du? (Quand viens-tu ?)</li>
                  <li><span className="text-pr-black">Wo?</span> - Où ?</li>
                  <li className="ml-4">Wo wohnst du? (Où habites-tu ?)</li>
                  <li><span className="text-pr-black">Wohin?</span> - Où ? (direction)</li>
                  <li className="ml-4">Wohin gehst du? (Où vas-tu ?)</li>
                  <li><span className="text-pr-black">Woher?</span> - D'où ?</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">Wie?</span> - Comment ?</li>
                  <li className="ml-4">Wie geht es dir? (Comment vas-tu ?)</li>
                  <li><span className="text-pr-black">Warum?</span> - Pourquoi ?</li>
                  <li className="ml-4">Warum bist du traurig? (Pourquoi es-tu triste ?)</li>
                  <li><span className="text-pr-black">Wieso?</span> - Pourquoi ?</li>
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">Wie viel?</span> - Combien ? (non comptable)</li>
                  <li className="ml-4">Wie viel kostet das? (Combien ça coûte ?)</li>
                  <li><span className="text-pr-black">Wie viele?</span> - Combien ? (comptable)</li>
                  <li className="ml-4">Wie viele Bücher hast du? (Combien de livres as-tu ?)</li>
                  <li><span className="text-pr-black">Welcher/Welche/Welches?</span> - Quel/Quelle ?</li>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Questions indirectes</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich weiß nicht, <span className="text-pr-black">ob</span> du morgen kommst.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich weiß nicht, <span className="text-pr-black">wann</span> du morgen kommst.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Questions avec prépositions</h2>
            <p className="text-gray-700 mb-4">
