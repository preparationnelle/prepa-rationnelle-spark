...
const VocabulaireInnovationFlashcardsPage = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Concurrence technologique": "bg-orange-100 text-orange-800",
      ...
      "Sécurité des infrastructures": "bg-orange-100 text-orange-800",
      ...
      "Types d'attaques": "bg-orange-100 text-orange-800",
      ...
      "Infrastructures stratégiques": "bg-orange-100 text-orange-800",
      ...
      "Risques sociétaux": "bg-orange-100 text-orange-800",
      ...
      "Dépendances stratégiques": "bg-orange-100 text-orange-800",
