        ...
        <Card className="mb-8 border shadow-sm">
          <CardHeader className="bg-gray-50">
            <CardTitle className="text-lg font-semibold text-center text-gray-900 flex items-center justify-center gap-2">
              <Vote className="w-5 h-5 text-pr-black" />
          ...
          <CardContent className="pt-6">
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
              ...
              <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                <div className="text-2xl font-bold text-pr-black">20,8%</div>
        ...
        <Card className="mb-6 border shadow-sm">
          ...
          <CardContent className="pt-6">
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <div className="mt-4 p-4 bg-gray-50 border-l-4 border-pr-black">
        ...
        <Card className="mb-8 border shadow-sm">
          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              {/* Adenauer */}
              <div className="border-l-4 border-pr-black pl-4 py-2">
              ...
              {/* Merz */}
              <div className="border-l-4 border-pr-black pl-4 py-2 bg-gray-50">
