...
const VocabulaireKulturFlashcardsPage = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Fractures numériques": "bg-orange-100 text-orange-800",
      ...
      "Discriminations": "bg-orange-100 text-orange-800",
      ...
      "Migration récente": "bg-orange-100 text-orange-800",
      ...
      "Politique historique": "bg-orange-100 text-orange-800",
      ...
      "Cultures alternatives": "bg-orange-100 text-orange-800",
