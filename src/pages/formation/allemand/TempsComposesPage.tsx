      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Difficultés des temps composés</h2>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Règle 1 : Choix de l'auxiliaire (haben/sein)</h2>
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mt-2">
                  <p>Ich <span className="text-pr-black">bin</span> nach Berlin <span className="text-pr-black">gefahren</span>.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Règle 2 : Formation du participe passé</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-3 text-green-700">Verbes faibles (réguliers) :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Infinitif + <span className="text-pr-black">-(e)t</span></p>
                  <p>machen → ge<span className="text-pr-black">macht</span></p>
                  <p>lernen → ge<span className="text-pr-black">lernt</span></p>
                </div>
              </div>
              <div>
                <h3 className="font-semibold mb-3 text-carnet-red">Verbes forts (irréguliers) :</h3>
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Changement vocalique + <span className="text-pr-black">-en</span></p>
                  <p>gehen → ge<span className="text-pr-black">gangen</span></p>
                  <p>kommen → ge<span className="text-pr-black">kommen</span></p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Règle 3 : Position dans la phrase</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich <span className="text-pr-black">habe</span> gestern das Buch <span className="text-pr-black">gelesen</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>Ich <span className="text-pr-black">hatte</span> das Buch schon <span className="text-pr-black">gelesen</span>.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Les temps composés principaux</h2>
            <div className="space-y-6">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich <span className="text-pr-black">habe</span> gearbeitet. (J'ai travaillé.)</p>
                  <p>Ich <span className="text-pr-black">bin</span> gegangen. (Je suis parti.)</p>
                </div>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich <span className="text-pr-black">hatte</span> gearbeitet. (J'avais travaillé.)</p>
                  <p>Ich <span className="text-pr-black">war</span> gegangen. (J'étais parti.)</p>
                </div>
              </div>
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>Ich <span className="text-pr-black">werde</span> gearbeitet <span className="text-pr-black">haben</span>. (J'aurai travaillé.)</p>
                </div>
              </div>
            </div>
          </div>
