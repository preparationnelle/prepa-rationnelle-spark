...
const VocabulaireFrauenFlashcardsPage = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Gouvernance d'entreprise": "bg-orange-100 text-orange-800",
      ...
      "Inégalités structurelles": "bg-orange-100 text-orange-800",
      ...
      "Sexisme": "bg-orange-100 text-orange-800",
      ...
      "Égalité salariale": "bg-orange-100 text-orange-800",
      ...
      "Violences de genre": "bg-orange-100 text-orange-800",
      ...
      "Pauvreté familiale": "bg-orange-100 text-orange-800",
      "Politiques sociales": "bg-cyan-100 text-cyan-800",
      "Inégalités de retraite": "bg-red-100 text-red-800",
      "Précarité âgée": "bg-orange-100 text-orange-800",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-lime-50 via-white to-green-50">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-lime-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
