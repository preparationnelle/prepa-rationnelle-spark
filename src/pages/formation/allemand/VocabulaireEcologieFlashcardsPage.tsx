...
const VocabulaireEcologieFlashcardsPage = () => {
  ...
  const getCategoryColor = (category: string) => {
    const colors = {
      ...
      "Énergies renouvelables": "bg-lime-100 text-lime-800",
      ...
      "Législation": "bg-violet-100 text-violet-800",
      ...
      "Mouvement écologiste": "bg-green-100 text-green-800",
      "Entreprises": "bg-gray-100 text-gray-800",
      "Crise énergétique": "bg-red-100 text-red-800",
      "Sécurité énergétique": "bg-yellow-100 text-yellow-800",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50">
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <span className="text-gray-900 font-bold">Vocabulaire Écologie</span>
          </div>
        </div>
      </nav>
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -z-10 -top-40 -right-40 w-80 h-80 bg-emerald-200 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-pulse"></div>
        ...
        <div className="absolute -z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-lime-200 rounded-full mix-blend-multiply filter blur-xl opacity-20 animate-pulse" style={{animationDelay: '4s'}}></div>
      </div>
            ...
            <Card className="mb-4 bg-emerald-50 border-emerald-200">
              <CardContent className="p-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-sm text-emerald-700">
                  <div><kbd className="bg-emerald-100 px-2 py-1 rounded">Espace</kbd> ou <kbd className="bg-emerald-100 px-2 py-1 rounded">Entrée</kbd> : Retourner la carte</div>
                  <div><kbd className="bg-emerald-100 px-2 py-1 rounded">←</kbd> <kbd className="bg-emerald-100 px-2 py-1 rounded">→</kbd> : Navigation</div>
                  <div><kbd className="bg-emerald-100 px-2 py-1 rounded">S</kbd> : Mélanger</div>
              ...
              <div className="absolute -z-10 top-4 left-4 flex items-center gap-2">
                {isFlipped ? (
                  ...
                  <>
                    ...
                    <span className="text-sm font-medium text-emerald-600">Français</span>
                  </>
                )}
              </div>
        ...
        <div className="max-w-4xl mx-auto mt-12">
          <Card className="border-2 border-emerald-200 bg-gradient-to-r from-emerald-50 to-green-50 shadow-lg">
            <CardContent className="p-6">
              <h3 className="text-xl font-bold text-emerald-900 mb-4">💡 Conseils pour l'apprentissage</h3>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h4 className="font-semibold text-emerald-800">Technique de révision :</h4>
