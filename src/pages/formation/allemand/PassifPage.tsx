        ...
        <div className="container mx-auto px-4 max-w-4xl">
          ...
          <section className="mb-8">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">1. Quand l'utiliser ?</h2>
          ...
          <section className="mb-8">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">2. Tableaux récapitulatifs</h2>
            ...
            <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-white rounded-lg border border-gray-300">
                  ...
                  <div className="bg-gray-50 p-3 rounded border-l-4 border-pr-black">
                  ...
                  {[
                    ...
                    <div key={item.num} className="bg-white p-4 rounded-lg border border-gray-300">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="font-bold text-pr-black">#{item.num}</span>
