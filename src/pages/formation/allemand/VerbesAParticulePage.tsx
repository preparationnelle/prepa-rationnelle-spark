      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Qu'est-ce qu'un verbe à particule séparable ?</h2>
          ...
          {/* Règle générale */}
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Règle générale de séparation</h2>
            <p className="text-gray-700 mb-4">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>aufstehen → Ich <span className="text-pr-black">stehe</span> früh <span className="text-pr-black">auf</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>aufstehen → Ich <span className="text-pr-black">stand</span> gestern früh <span className="text-pr-black">auf</span>.</p>
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  <p>aufstehen → <span className="text-pr-black">Steh</span> bitte <span className="text-pr-black">auf</span>!</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Exception : propositions subordonnées</h2>
            <p className="text-gray-700 mb-4">
              Dans les propositions subordonnées, le verbe conjugué se place en fin de phrase et la particule reste attachée au verbe :
            </p>
            <div className="bg-gray-50 p-4 rounded-lg">
              <p>Ich weiß, dass du jeden Morgen <span className="text-pr-black">aufstehst</span>.</p>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Particules fréquentes</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                <h3 className="font-semibold mb-3">Particules de direction :</h3>
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">ab</span> - descendre (absteigen)</li>
                  <li><span className="text-pr-black">auf</span> - monter (aufstehen)</li>
                  <li><span className="text-pr-black">ein</span> - entrer (einkaufen)</li>
                  <li><span className="text-pr-black">aus</span> - sortir (aussteigen)</li>
                  <li><span className="text-pr-black">zu</span> - fermer (zumachen)</li>
                </ul>
              </div>
              <div>
                <h3 className="font-semibold mb-3">Particules de mouvement :</h3>
                <ul className="space-y-2 text-gray-700">
                  <li><span className="text-pr-black">an</span> - commencer (anfangen)</li>
                  <li><span className="text-pr-black">mit</span> - participer (mitmachen)</li>
                  <li><span className="text-pr-black">vor</span> - présenter (vorstellen)</li>
                  <li><span className="text-pr-black">weg</span> - partir (weggehen)</li>
                  <li><span className="text-pr-black">zusammen</span> - réunir (zusammenkommen)</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p>be<span className="text-pr-black">stehen</span> (inséparable) ≠ auf<span className="text-pr-black">stehen</span> (séparable)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex justify-center gap-4 pb-8">
            <Link to="/formation/allemand-verbes-particules/exercices">
              <Button className="bg-pr-black-dark hover:bg-pr-black-dark text-white flex items-center gap-2">
