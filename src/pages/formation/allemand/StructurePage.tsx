      ...
      <section className="py-8 px-4 sm:px-6">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
            <h2 className="text-xl font-bold mb-4 text-pr-black border-b border-gray-200 pb-2">Vue d'Ensemble : Les Trois Positions du Verbe</h2>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Position 1 : Verbe en Première Position</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Questions fermées (Ja/Nein-Fragen)</h3>
                <p className="text-gray-700 mb-3"><strong>Structure :</strong> VERBE + SUJET + AUTRES ÉLÉMENTS + ?</p>
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-gray-800 mb-2">Exemples pratiques :</p>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Mode impératif</h3>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg">
                    <p className="text-sm text-gray-800 mb-2 font-semibold">Forme familière :</p>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Conditionnelles sans "wenn" (Style soutenu)</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Position 2 : Verbe en Deuxième Position</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Phrases déclaratives</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Mécanisme de la "klammer" (parenthèse verbale) :</h3>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 p-2 text-center font-mono text-pr-black font-bold">habe</td>
                        <td className="border border-gray-300 p-2 text-center font-mono">gestern meinem Bruder</td>
                        <td className="border border-gray-300 p-2 text-center font-mono text-pr-black font-bold">geholfen</td>
                      </tr>
                      <tr>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Questions ouvertes (W-Fragen)</h3>
                <p className="text-gray-700 mb-3"><strong>Structure :</strong> MOT INTERROGATIF + VERBE + SUJET + AUTRES + ?</p>

                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-gray-800 mb-2">Exemples avec différents interrogatifs :</p>
                  <ul className="space-y-2 font-mono text-orange-900">
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Éléments verbaux non conjugués en fin de phrase</h3>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Position Finale : Verbe en Dernière Position</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Propositions subordonnées</h3>
                <p className="text-gray-700 mb-3">
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Cas particuliers dans les subordonnées</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-gray-50 p-4 rounded-lg border-l-4 border-pr-black">
                    <p className="font-semibold text-gray-800 mb-2">Comparatifs :</p>
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Ordre des Éléments : Principes Fondamentaux</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Principe 1 : Mise en relief par la position initiale</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Principe 2 : Position du sujet après inversion</h3>
                <p className="text-gray-700 mb-3">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Ordre des Compléments : Règles Détaillées</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Hiérarchie générale</h3>
                <p className="text-gray-700 mb-3"><strong>SUJET + PRONOMS + TEMPS + CAUSE + LIEU + MANIÈRE + COI + COD</strong></p>
              </div>

              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Règles spécifiques aux pronoms</h3>
                ...
                <div className="bg-gray-50 p-4 rounded-lg mb-4">
                  <p className="text-sm text-gray-800 mb-2 font-semibold">Exemples :</p>
                  <ul className="space-y-2 font-mono text-orange-900">
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Compléments circonstanciels : T-L-M</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Hiérarchie informationnelle</h3>
                <p className="text-gray-700 mb-3">
                  <strong>Principe :</strong> Plus une information est centrale au sens du verbe, plus elle se rapproche de la fin.
                </p>

                <div className="bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm text-gray-800 mb-2 font-semibold">Exemples analytiques :</p>
                  <div className="bg-white p-3 rounded border-l-4 border-pr-black">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">La Négation avec "nicht" : Règles Précises</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Négation totale</h3>
              ...
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Négation partielle</h3>
                <p className="text-gray-700 mb-3"><strong>Position :</strong> Directement avant l'élément nié</p>
                <div className="bg-gray-50 p-3 rounded-lg">
                  <p className="font-mono text-gray-800">Er arbeitet nicht in Berlin, sondern in München.</p>
                </div>
              </div>

              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Respect des groupes syntaxiques</h3>
                <p className="text-gray-700 mb-3"><strong>Groupes inséparables :</strong></p>

                <div className="space-y-3">
                  <div className="bg-gray-50 p-3 rounded-lg border-l-4 border-pr-black">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg mb-8 border border-orange-100">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Ponctuation : Règles Strictes</h2>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-carnet-red-pale rounded-xl p-8 shadow-lg mb-8 border border-gray-200">
            <h2 className="text-2xl font-bold mb-6 text-pr-black border-b border-gray-200 pb-2">Synthèse : Mécanismes Clés</h2>

            <div className="space-y-6">
              <div>
                <h3 className="text-lg font-bold mb-3 text-pr-black">Les trois règles d'or</h3>
