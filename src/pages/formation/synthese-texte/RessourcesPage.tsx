    ...
    <div className="relative">
      ...
      <div className="container mx-auto px-4 py-12 max-w-5xl">
        ...
        <section className="mb-14">
          ...
          <div className="bg-pr-gray-bg/60 border-l-[3px] border-pr-black rounded-r-md p-4 mb-7">
            <p className="font-dm-sans text-sm text-pr-gray-dark">
              <strong className="text-pr-black">Conseil —</strong> commencez par les années récentes (2023-2025) pour vous familiariser avec le format actuel, puis explorez les années plus anciennes pour voir l'évolution des sujets.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {annalesBCE.map((annale, index) => (
              <article
                key={index}
                className="border border-pr-gray-light rounded-lg overflow-hidden hover:border-pr-black transition-colors group"
              >
                ...
                <div className="p-5">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="w-full font-dm-sans border-pr-gray-light text-pr-gray-dark hover:bg-pr-gray-bg hover:border-pr-black hover:text-pr-black gap-2"
                    asChild
                  >
          ...
          <div className="mt-7 border border-pr-gray-light rounded-lg p-6 bg-pr-gray-bg/40">
            ...
            <ul className="space-y-2 font-dm-sans text-sm text-pr-gray-dark">
              <li className="flex items-start gap-2.5"><span className="text-pr-black mt-0.5">→</span><span><strong className="text-pr-black">Étape 1 —</strong> Lisez les textes sans regarder le temps</span></li>
              <li className="flex items-start gap-2.5"><span className="text-pr-black mt-0.5">→</span><span><strong className="text-pr-black">Étape 2 —</strong> Chronométrez-vous en conditions réelles (4h)</span></li>
              <li className="flex items-start gap-2.5"><span className="text-pr-black mt-0.5">→</span><span><strong className="text-pr-black">Étape 3 —</strong> Comparez avec les corrigés types</span></li>
              <li className="flex items-start gap-2.5"><span className="text-pr-black mt-0.5">→</span><span><strong className="text-pr-black">Étape 4 —</strong> Identifiez vos points d'amélioration</span></li>
            </ul>
          </div>
        </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {annalesCorrigees.map((annale, index) => (
              ...
              >
                ...
                <Button
                  size="sm"
                  className="w-full mt-auto bg-pr-black hover:bg-pr-black-dark text-white font-dm-sans gap-2"
                >
          ...
          <div className="space-y-5">
            {exercicesPratiques.map((exercice, index) => (
              ...
              >
                ...
                <div className="mb-5">
                  <h4 className="font-dm-sans text-[10px] uppercase tracking-wider font-semibold text-pr-black mb-2">
                    Objectifs
                  </h4>
        ...
        <section className="mb-14">
          ...
          <div className="mt-5 bg-pr-gray-bg/60 border-l-[3px] border-pr-black rounded-r-md p-4">
            <p className="font-dm-sans text-sm text-pr-gray-dark">
              <strong className="text-pr-black">Note —</strong> cette grille est basée sur les critères officiels des concours ECG. Utilisez-la pour vous auto-évaluer et identifier vos points d'amélioration.
            </p>
          </div>
        </section>
            ...
            {outilsPratiques.map((outil, index) => (
              ...
              >
                ...
                <Button
                  size="sm"
                  variant="outline"
                  className="w-full mt-auto font-dm-sans border-pr-gray-light text-pr-gray-dark hover:bg-pr-gray-bg hover:border-pr-black hover:text-pr-black gap-2"
                >
                  <ExternalLink className="w-3.5 h-3.5" />
                  Découvrir
                </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div className="border border-pr-gray-light rounded-lg p-6">
              ...
              <Button
                variant="outline"
                size="sm"
                className="font-dm-sans border-pr-gray-light text-pr-gray-dark hover:bg-pr-gray-bg hover:border-pr-black hover:text-pr-black gap-2"
              >
                <Download className="w-3.5 h-3.5" />
