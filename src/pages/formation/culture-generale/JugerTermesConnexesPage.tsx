...
const SectionHeader: React.FC<{ title: string; subtitle?: string }> = ({ title, subtitle }) => (
  <div className="text-center mb-10">
    ...
    <div className="h-[2px] w-12 bg-pr-orange mx-auto mb-4" />
    {subtitle && (
...
const sousThemes: { title: string; icon?: React.ReactNode; body: string; wide?: boolean }[] = [
  {
    ...
    icon: <BookOpen className="h-5 w-5 text-pr-orange" />,
  ...
  },
  {
    ...
    icon: <Users className="h-5 w-5 text-pr-orange" />,
  ...
  },
  {
    ...
    icon: <Leaf className="h-5 w-5 text-pr-orange" />,
  ...
  },
  {
    ...
    icon: <Cpu className="h-5 w-5 text-pr-orange" />,
  ...
  },
  {
    ...
    icon: <Globe className="h-5 w-5 text-pr-orange" />,
  ...
  },
  {
    ...
    icon: <Sparkles className="h-5 w-5 text-pr-orange" />,
...
const FicheCardBlock: React.FC<{ item: FicheCard; wide?: boolean }> = ({ item, wide }) => (
  <Card
    className={`relative bg-white rounded-2xl p-6 border border-pr-gray-light hover:border-pr-orange transition-colors overflow-hidden ${wide ? 'md:col-span-2' : ''}`}
  >
    <div className="absolute top-0 left-0 bottom-0 w-[3px] bg-pr-orange" />
    ...
    <div className="min-h-screen bg-pr-gray-bg font-dm-sans">
      <nav className="sticky top-0 z-50 bg-pr-gray-bg/95 backdrop-blur border-b border-pr-gray-light">
        <div className="container mx-auto px-4 py-2.5">
          <div className="flex items-center text-xs text-pr-gray-mid">
            ...
            <ChevronRight className="h-3 w-3 mx-1 opacity-60" />
            <Link to="/formation/culture-generale" className="hover:text-pr-orange-dark transition-colors">Culture générale</Link>
            <ChevronRight className="h-3 w-3 mx-1 opacity-60" />
        ...
        <div className="container mx-auto max-w-5xl">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center gap-4 mb-5">
              <div className="w-12 h-12 bg-pr-orange-pale rounded-xl flex items-center justify-center">
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-7">
              ...
              <span className="px-3 py-1 bg-pr-orange text-white rounded-full text-xs font-semibold uppercase tracking-wider">
                Fiche notion
              </span>
            </div>
          </div>
      ...
      <section className="py-14 px-4 sm:px-6">
        <div className="container mx-auto max-w-5xl space-y-16">
          {/* Encadré intro */}
          <Card className="relative max-w-4xl mx-auto bg-pr-orange-pale border-0 rounded-2xl p-7 overflow-hidden">
            <div className="absolute top-0 left-0 bottom-0 w-[3px] bg-pr-orange" />
            <h3 className="font-dm-serif text-xl text-pr-orange-dark mb-3">
            ...
            <ul className="text-sm text-pr-gray-dark space-y-1.5">
              <li><span className="text-pr-orange mr-2">→</span>Distinguer humain, humanité, personne, dignité.</li>
              <li><span className="text-pr-orange mr-2">→</span>Cartographier les grandes frontières (humain/animal, humain/machine, humanité/inhumanité).</li>
              <li><span className="text-pr-orange mr-2">→</span>Parcourir les 8 sous-thèmes du programme avec leurs auteurs phares.</li>
              <li><span className="text-pr-orange mr-2">→</span>Mettre en lumière les enjeux contemporains : technique, écologie, déshumanisation.</li>
            </ul>
          </Card>
          ...
          <div>
            ...
            <Accordion type="single" collapsible className="max-w-4xl mx-auto bg-white border border-pr-gray-light rounded-2xl px-6">
              <AccordionItem value="animal" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">L&apos;humain face à l&apos;animal</AccordionTrigger>
              ...
              <AccordionItem value="machine" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">L&apos;humain face à la machine</AccordionTrigger>
              ...
              <AccordionItem value="divin" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">L&apos;humain face au divin (ou à l&apos;absolu)</AccordionTrigger>
              ...
              <AccordionItem value="autre" className="border-b-0">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">L&apos;humain face à autrui</AccordionTrigger>
          ...
          <div>
            ...
            <div className="grid gap-5 md:grid-cols-2">
              {sousThemes.map((t) => (
                <Card
                  key={t.title}
                  className={`relative bg-white rounded-2xl p-6 border border-pr-gray-light hover:border-pr-orange hover:shadow-md transition-all overflow-hidden ${t.wide ? 'md:col-span-2' : ''}`}
                >
                  <div className="absolute top-0 left-0 bottom-0 w-[3px] bg-pr-orange" />
          ...
          <div>
            ...
            <Accordion type="multiple" className="max-w-4xl mx-auto bg-white border border-pr-gray-light rounded-2xl px-6">
              <AccordionItem value="dignite" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Dignité (Kant)</AccordionTrigger>
              ...
              <AccordionItem value="perfectibilite" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Perfectibilité (Rousseau)</AccordionTrigger>
              ...
              <AccordionItem value="banalite" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Banalité du mal (Arendt)</AccordionTrigger>
              ...
              <AccordionItem value="zonegrise" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Zone grise (Levi)</AccordionTrigger>
              ...
              <AccordionItem value="arraisonnement" className="border-pr-gray-light">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Arraisonnement technique (Heidegger)</AccordionTrigger>
              ...
              <AccordionItem value="visage" className="border-b-0">
                <AccordionTrigger className="font-dm-serif text-pr-black hover:text-pr-orange-dark">Visage d&apos;autrui (Levinas)</AccordionTrigger>
          ...
          <div>
            ...
            <Card className="relative max-w-4xl mx-auto bg-white rounded-2xl p-7 border border-pr-gray-light overflow-hidden">
              ...
              <ul className="text-sm text-pr-gray-dark space-y-1.5">
                <li><span className="text-pr-orange mr-2">→</span>Pic de la Mirandole, <em>Discours de la dignité de l&apos;homme</em>, 1486.</li>
                <li><span className="text-pr-orange mr-2">→</span>Pascal, <em>Pensées</em>, 1670 : roseau pensant, grandeur et misère.</li>
                <li><span className="text-pr-orange mr-2">→</span>Rousseau, <em>Discours sur l&apos;origine de l&apos;inégalité</em>, 1755 : perfectibilité.</li>
                <li><span className="text-pr-orange mr-2">→</span>Sartre, <em>L&apos;existentialisme est un humanisme</em>, 1946.</li>
                <li><span className="text-pr-orange mr-2">→</span>Hannah Arendt, <em>Eichmann à Jérusalem</em>, 1963.</li>
                <li><span className="text-pr-orange mr-2">→</span>Primo Levi, <em>Si c&apos;est un homme</em>, 1947.</li>
                <li><span className="text-pr-orange mr-2">→</span>Heidegger, <em>La Question de la technique</em>, 1953.</li>
                <li><span className="text-pr-orange mr-2">→</span>Günther Anders, <em>L&apos;Obsolescence de l&apos;homme</em>, 1956.</li>
                <li><span className="text-pr-orange mr-2">→</span>Levinas, <em>Totalité et infini</em>, 1961.</li>
                <li><span className="text-pr-orange mr-2">→</span>Bruno Latour, <em>Face à Gaïa</em>, 2015.</li>
                <li><span className="text-pr-orange mr-2">→</span>Frantz Fanon, <em>Les Damnés de la terre</em>, 1961.</li>
              </ul>
            </Card>
          </div>
        </div>
