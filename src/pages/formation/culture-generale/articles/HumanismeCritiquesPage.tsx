        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <PRCard number="02" title="Renaissance — l'humain au centre">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-orange mr-2">→</span><strong>Érasme</strong>, <em>Éloge de la folie</em> (1511)&nbsp;: critique des dogmatismes, ironie contre les théologiens, pari pédagogique sur la liberté de l&apos;humain.</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Montaigne</strong>, <em>Essais</em> (1580-1592)&nbsp;: «&nbsp;Que sais-je&nbsp;?&nbsp;», primat de l&apos;expérience, tolérance face à la diversité (les «&nbsp;cannibales&nbsp;» plus humains que les conquérants), refus de la cruauté.</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Le programme</strong>. L&apos;humain n&apos;est plus défini par sa place dans une hiérarchie céleste, mais par sa capacité à se cultiver, à choisir, à faire usage de sa raison. La dignité tient à cette autonomie naissante.</li>
              </ul>
              <p>
          ...
          <PRCard number="03" title="Nietzsche — l'humain à dépasser">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-orange mr-2">→</span><strong>Le surhomme</strong> (<em>Übermensch</em>). Non un tyran biologique, mais une figure éthique&nbsp;: celui qui assume la disparition de Dieu et invente ses propres valeurs, au lieu de pleurer la perte du sens.</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Critique de la pitié</strong>. La compassion humaniste, dit Nietzsche, est l&apos;arme des faibles contre les forts. Elle nivelle, elle écrase ce qui veut s&apos;élever. Sous le masque de la bonté, du ressentiment.</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Mort de Dieu</strong>. Nietzsche en tire une conclusion peu commentée&nbsp;: la disparition du fondement divin entraîne celle du fondement humain. L&apos;humain ne peut plus se penser comme «&nbsp;créature à l&apos;image de Dieu&nbsp;». Il devient lui-même la dernière idole à briser.</li>
              </ul>
              <p>
          ...
          <PRCard number="04" title="Foucault — l'homme, invention récente">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-orange mr-2">→</span><strong>Naissance des sciences humaines</strong>. Économie, biologie, philologie inventent au XIX<sup>e</sup> siècle un objet inédit&nbsp;: «&nbsp;l&apos;homme&nbsp;» comme être qui parle, qui travaille et qui vit. Avant cela, on étudiait les richesses, les langues, les vivants — pas «&nbsp;l&apos;homme&nbsp;».</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Pli épistémologique</strong>. L&apos;humain devient à la fois sujet et objet de la connaissance, ce qui produit des paradoxes (penser, c&apos;est être pensé&nbsp;; vouloir, c&apos;est être déterminé). Cette tension n&apos;est pas éternelle&nbsp;: elle date.</li>
                <li><span className="text-pr-orange mr-2">→</span><strong>Mort annoncée</strong>. Foucault prédit que «&nbsp;l&apos;homme&nbsp;» se dissoudra «&nbsp;comme à la limite de la mer un visage de sable&nbsp;». Ce que les structures (langue, parenté, pouvoir) montrent, c&apos;est que «&nbsp;l&apos;homme&nbsp;» n&apos;est pas premier.</li>
              </ul>
              <p>
          ...
          <PRCard number="06" title="Où mobiliser ces références ?">
            <div className="space-y-4 text-sm md:text-base">
              <ul className="space-y-1.5">
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>L&apos;humanisme est-il dépassé&nbsp;?</strong>&nbsp;» — Nietzsche, Foucault.</li>
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>L&apos;humain au centre</strong>&nbsp;» — Renaissance comme programme.</li>
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>Faut-il dépasser l&apos;humain&nbsp;?</strong>&nbsp;» — articulation transhumanisme/Nietzsche.</li>
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>Les droits de l&apos;homme</strong>&nbsp;» — humanisme juridique post-1948.</li>
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>L&apos;universel</strong>&nbsp;» — humanisme et son provincialisme.</li>
                <li><span className="text-pr-orange mr-2">→</span>«&nbsp;<strong>L&apos;humanité a-t-elle une essence&nbsp;?</strong>&nbsp;» — Foucault et la dissolution.</li>
              </ul>
            </div>
          </PRCard>
