        ...
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="space-y-5 text-sm md:text-base">
              ...
              <div>
                ...
                <ul className="space-y-1.5">
                  <li><span className="text-pr-black mr-2">→</span>« Qu&apos;est-ce que… ? » : essence supposée stable face à une réalité plurielle ou historique.</li>
                  <li><span className="text-pr-black mr-2">→</span>« Peut-on… ? » : capacité matérielle face à légitimité morale.</li>
                  <li><span className="text-pr-black mr-2">→</span>« Faut-il… ? » : nécessité face à danger.</li>
                  <li><span className="text-pr-black mr-2">→</span>Sujet avec « et » : opposition ou fusion (humanité <em>et</em> animalité, humanité <em>et</em> technique).</li>
                  <li><span className="text-pr-black mr-2">→</span>Article défini (« l&apos;humanité ») : essence présupposée face à pluralité réelle.</li>
                </ul>
              ...
              <div>
                ...
                <ul className="grid md:grid-cols-2 gap-x-6 gap-y-1">
                  <li><span className="text-pr-black mr-2">→</span>Métaphysique (essence ou existence)</li>
                  <li><span className="text-pr-black mr-2">→</span>Anthropologique (nature ou culture)</li>
                  <li><span className="text-pr-black mr-2">→</span>Politique (universel ou pluriel)</li>
                  <li><span className="text-pr-black mr-2">→</span>Morale (dignité ou cruauté)</li>
                  <li><span className="text-pr-black mr-2">→</span>Technique (augmentation ou perte)</li>
                  <li><span className="text-pr-black mr-2">→</span>Écologique (humain ou vivant)</li>
                  <li><span className="text-pr-black mr-2">→</span>Historique (progrès ou barbarie)</li>
                  <li><span className="text-pr-black mr-2">→</span>Frontières (humain ou animal, humain ou machine)</li>
                </ul>
              </div>
            </div>
          </PRCard>
          ...
          <PRCard number="03" title="Les couples paradoxaux">
            <div className="space-y-5 text-sm md:text-base">
              <div>
                ...
                <ul className="grid md:grid-cols-2 gap-x-6 gap-y-1">
                  <li><span className="text-pr-black mr-2">→</span>Nature / Culture</li>
                  <li><span className="text-pr-black mr-2">→</span>Inné / Acquis</li>
                  <li><span className="text-pr-black mr-2">→</span>Universel / Particulier</li>
                  <li><span className="text-pr-black mr-2">→</span>Essence / Existence</li>
                  <li><span className="text-pr-black mr-2">→</span>Individuel / Collectif</li>
                  <li><span className="text-pr-black mr-2">→</span>En droit / En fait</li>
                  <li><span className="text-pr-black mr-2">→</span>Idéal / Réel</li>
                  <li><span className="text-pr-black mr-2">→</span>Possible / Impossible</li>
                </ul>
              </div>
              <div>
                <h3 className="font-dm-serif text-pr-black text-lg mb-2">Couples propres au thème « L&apos;humanité »</h3>
                <ul className="grid md:grid-cols-2 gap-x-6 gap-y-1">
                  <li><span className="text-pr-black mr-2">→</span>Humanité / Inhumanité</li>
                  <li><span className="text-pr-black mr-2">→</span>Humain / Animal</li>
                  <li><span className="text-pr-black mr-2">→</span>Humain / Machine</li>
                  <li><span className="text-pr-black mr-2">→</span>Dignité / Déshumanisation</li>
                  <li><span className="text-pr-black mr-2">→</span>Civilisation / Barbarie</li>
                  <li><span className="text-pr-black mr-2">→</span>Universel / Pluriel</li>
                  <li><span className="text-pr-black mr-2">→</span>Perfectibilité / Corruption</li>
                  <li><span className="text-pr-black mr-2">→</span>Promesse / Menace (technique)</li>
                </ul>
              </div>
              <div className="bg-pr-gray-bg rounded-xl p-5">
                <h3 className="font-dm-serif text-base text-pr-black mb-2">Formule type</h3>
          ...
          <PRCard number="04" title="De la contradiction à la problématique">
            <div className="space-y-3 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span>« Comment comprendre alors que l&apos;humanité se proclame fondée sur la dignité, tandis qu&apos;elle a produit Auschwitz, Hiroshima et le Rwanda ? »</li>
                <li><span className="text-pr-black mr-2">→</span>« Comment comprendre que l&apos;humanité se définisse par sa différence avec l&apos;animal, tandis que l&apos;éthologie révèle que les frontières sont poreuses ? »</li>
                <li><span className="text-pr-black mr-2">→</span>« Comment comprendre que la technique soit célébrée comme accomplissement de l&apos;humain, tandis qu&apos;elle menace de le rendre obsolète ? »</li>
              </ul>
              <p className="mt-2">On peut rehausser le style par une image :</p>
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span>« L&apos;humanité ne serait-elle pas ce roseau pensant que décrit Pascal : à la fois la plus fragile et la plus haute des créations ? »</li>
                <li><span className="text-pr-black mr-2">→</span>« L&apos;humanité ressemble peut-être à Janus : un visage tourné vers la dignité, l&apos;autre vers la barbarie. »</li>
              </ul>
            </div>
          </PRCard>
