          ...
          <PRCard number="01" title="Définition">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span><strong>Sens biologique</strong> : l&apos;ensemble des êtres appartenant à l&apos;espèce <em>Homo sapiens</em>.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Sens collectif</strong> : la communauté de tous les humains, présents, passés et à venir.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Sens moral</strong> : la qualité qui distingue l&apos;humain (dignité, bienveillance, respect du semblable).</li>
              </ul>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    <li><span className="text-pr-black mr-2">→</span>Espèce biologique (anthropologie).</li>
                    <li><span className="text-pr-black mr-2">→</span>Communauté politique mondiale (droit international).</li>
                    <li><span className="text-pr-black mr-2">→</span>Vertu morale (« faire preuve d&apos;humanité »).</li>
                    <li><span className="text-pr-black mr-2">→</span>Idéal de progrès (les Lumières, Condorcet).</li>
                    <li><span className="text-pr-black mr-2">→</span>Construction historique (l&apos;humanité s&apos;invente).</li>
                  </ul>
                </div>
              </div>
              <div className="bg-pr-gray-bg rounded-xl p-4">
                <h3 className="font-dm-serif text-base text-pr-black mb-1">Connotations</h3>
            ...
            <div className="space-y-5 text-sm md:text-base">
              ...
              <div className="grid md:grid-cols-2 gap-5">
                <div>
                  ...
                  <ul className="space-y-1.5">
                    <li><span className="text-pr-black mr-2">→</span>Causes : nature ou histoire ? L&apos;humain a-t-il une essence ?</li>
                    <li><span className="text-pr-black mr-2">→</span>Conséquences : droits humains, devoirs envers les générations futures, statut des animaux et des machines.</li>
                    <li><span className="text-pr-black mr-2">→</span>Moyens : éducation, langage, technique, droit, art comme vecteurs d&apos;humanisation.</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-dm-serif text-pr-black text-lg mb-2">Dimensions</h3>
                  <ul className="space-y-1.5">
                    <li><span className="text-pr-black mr-2">→</span>Métaphysique : qu&apos;est-ce que l&apos;humain ?</li>
                    <li><span className="text-pr-black mr-2">→</span>Anthropologique : nature ou culture ?</li>
                    <li><span className="text-pr-black mr-2">→</span>Politique : universalisme ou pluralisme ?</li>
                    <li><span className="text-pr-black mr-2">→</span>Morale : dignité, fraternité, hospitalité.</li>
                    <li><span className="text-pr-black mr-2">→</span>Technique : augmentation, hybridation, machines.</li>
                    <li><span className="text-pr-black mr-2">→</span>Écologique : place de l&apos;humain dans le vivant.</li>
                    <li><span className="text-pr-black mr-2">→</span>Historique : barbarie, génocides, progrès moral.</li>
                    <li><span className="text-pr-black mr-2">→</span>Esthétique : représentations de l&apos;humain dans l&apos;art.</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-5 text-sm md:text-base">
              {[
                ...
                <div key={b.t}>
                  ...
                  <ul className="space-y-1">
                    {b.items.map((it) => (
                      <li key={it}><span className="text-pr-black mr-2">→</span>{it}</li>
                    ))}
                  </ul>
                </div>
              ))}
