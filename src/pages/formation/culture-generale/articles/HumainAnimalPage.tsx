        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <PRCard number="02" title="Descartes — l'animal-machine">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span><strong>L&apos;animal est une machine</strong>. Ses mouvements s&apos;expliquent par les rouages du corps, comme une horloge. Il n&apos;a pas d&apos;âme, pas de pensée intérieure.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Le langage est le critère décisif</strong>. Aucun animal ne combine des signes pour exprimer une pensée nouvelle. La parole témoigne d&apos;un esprit, pas d&apos;un automatisme.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>L&apos;humain seul possède la</strong> <em>res cogitans</em>. Une substance pensante distincte du corps-machine. C&apos;est elle qui le rend libre, responsable, susceptible de salut.</li>
              </ul>
              <p>
          ...
          <PRCard number="03" title="Montaigne — l'orgueil humain destitué">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span><strong>Continuité, pas rupture</strong>. Les animaux raisonnent, communiquent, organisent leurs sociétés, soignent leurs malades. La différence est de degré, pas de nature.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Critique de la</strong> <em>présomption</em>. Se croire supérieur à l&apos;animal, c&apos;est céder à la pire des passions, l&apos;orgueil. Montaigne y voit la racine de la sottise humaine.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Sagesse animale</strong>. Les bêtes ignorent l&apos;ambition, l&apos;avarice, la guerre froide&nbsp;: elles vivent selon leur nature, là où l&apos;humain s&apos;invente des malheurs.</li>
              </ul>
              <p>
          ...
          <PRCard number="04" title="Derrida — la fin de « l'Animal » au singulier">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span><strong>Le mot «&nbsp;l&apos;Animal&nbsp;» est une violence</strong>. Mettre dans un même sac la limace et le chimpanzé, le moustique et le dauphin, c&apos;est nier les différences réelles entre les espèces.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Carno-phallogocentrisme</strong>. Derrida forge ce néologisme pour dire que la pensée occidentale est structurée par le sacrifice de l&apos;animal, par le primat du mâle et par celui du logos.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Ouvrir la question</strong>. Il ne s&apos;agit pas de nier la différence humain/animal mais de cesser de la penser comme un trait unique et de prendre en compte la pluralité des vivants.</li>
              </ul>
              <p>
          ...
          <PRCard number="06" title="Où mobiliser ces références ?">
            <div className="space-y-4 text-sm md:text-base">
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>Qu&apos;est-ce qui distingue l&apos;humain de l&apos;animal&nbsp;?</strong>&nbsp;» — sujet frontal.</li>
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>L&apos;humain est-il un animal comme les autres&nbsp;?</strong>&nbsp;» — Montaigne en pivot, Descartes en repoussoir.</li>
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>Avons-nous des devoirs envers les animaux&nbsp;?</strong>&nbsp;» — Singer, Derrida, droit contemporain.</li>
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>La nature humaine</strong>&nbsp;» — frontière comme test de l&apos;essence.</li>
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>L&apos;humanité et la barbarie</strong>&nbsp;» — la violence faite à l&apos;animal interroge la nôtre.</li>
                <li><span className="text-pr-black mr-2">→</span>«&nbsp;<strong>La technique et le vivant</strong>&nbsp;» — Descartes fonde l&apos;empire sur le vivant que l&apos;anthropocène conteste.</li>
              </ul>
            </div>
          </PRCard>
