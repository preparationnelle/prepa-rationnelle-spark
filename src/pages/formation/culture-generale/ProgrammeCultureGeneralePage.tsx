      ...
      <section className="py-16 px-4 sm:px-6">
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="relative bg-white rounded-2xl p-8 md:p-10 border border-pr-gray-light overflow-hidden">
            ...
            <span className="inline-block px-2.5 py-1 bg-pr-orange-pale text-pr-orange-dark rounded text-[10px] font-semibold uppercase tracking-[0.12em] mb-4">
              Thème 2025-2026
            </span>
            ...
            <ol className="space-y-1.5 text-sm text-pr-gray-dark list-decimal list-inside marker:text-pr-orange marker:font-dm-serif">
