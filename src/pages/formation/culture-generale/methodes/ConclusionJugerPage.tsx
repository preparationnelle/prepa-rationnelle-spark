        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <PRCard number="01" title="Rôle de la conclusion">
            <div className="space-y-2 text-sm md:text-base">
              ...
              <ul className="space-y-1.5">
                <li><span className="text-pr-black mr-2">→</span>montrer la <strong>cohérence du raisonnement</strong> (enchaînement parties et sous-parties) ;</li>
                <li><span className="text-pr-black mr-2">→</span>reformuler la <strong>réponse à la problématique</strong> clairement ;</li>
                <li><span className="text-pr-black mr-2">→</span>réactiver les <strong>concepts clés</strong> (dignité, indétermination, banalité du mal, perfectibilité, hospitalité) ;</li>
                <li><span className="text-pr-black mr-2">→</span>ouvrir intelligemment (retour à l&apos;accroche ou élargissement contemporain).</li>
              </ul>
            </div>
          </PRCard>
          ...
          <PRCard number="03" title="Exemple : « Qu'est-ce qui fait l'humanité ? »">
            <div className="space-y-4 text-sm md:text-base">
              ...
              <div className="bg-pr-gray-bg rounded-lg p-4">
                <h3 className="font-dm-serif text-pr-black text-lg mb-2">Réponse à la problématique</h3>
