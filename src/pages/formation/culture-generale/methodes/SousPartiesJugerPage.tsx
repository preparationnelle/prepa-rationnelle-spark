        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <PRCard number="03" title="Relier les sous-parties : répertoire de connecteurs">
            <div className="space-y-4 text-sm md:text-base">
              <div>
                ...
                <ul className="space-y-1">
                  <li><span className="text-pr-black mr-2">→</span>« On peut commencer par avancer que… »</li>
                  <li><span className="text-pr-black mr-2">→</span>« Tout d&apos;abord, il convient de rappeler que… »</li>
                </ul>
              </div>
              <div>
                <h4 className="font-dm-serif text-pr-black text-base mb-1">Passer à la deuxième</h4>
                <ul className="space-y-1">
                  <li><span className="text-pr-black mr-2">→</span>« Il s&apos;agit alors de comprendre que… »</li>
                  <li><span className="text-pr-black mr-2">→</span>« Mais cette analyse ne se limite pas à… »</li>
                  <li><span className="text-pr-black mr-2">→</span>« Toutefois, il faut reconnaître que… »</li>
                </ul>
              </div>
              <div>
                <h4 className="font-dm-serif text-pr-black text-base mb-1">Introduire la troisième</h4>
                <ul className="space-y-1">
                  <li><span className="text-pr-black mr-2">→</span>« Ainsi, il apparaît que… »</li>
                  <li><span className="text-pr-black mr-2">→</span>« Dès lors, on peut considérer que… »</li>
                  <li><span className="text-pr-black mr-2">→</span>« De ce fait, il est possible de montrer que… »</li>
                </ul>
              </div>
            </div>
          </PRCard>
          ...
          <PRCard number="04" title="Exemple appliqué : Partie I « L'humanité comme donnée naturelle »">
            <div className="space-y-3 text-sm md:text-base">
              <ul className="space-y-2">
                <li><span className="text-pr-black mr-2">→</span><strong>Sous-partie 1</strong> : Tout d&apos;abord, l&apos;humanité se présente comme une espèce biologique unifiée, dotée d&apos;un patrimoine génétique commun et de facultés propres (langage, raison, technique).</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Sous-partie 2</strong> : Mais il s&apos;agit aussi de comprendre que cette unité biologique se redouble d&apos;une dignité morale universelle, fondée par Kant et inscrite dans la déclaration des droits humains de 1948.</li>
                <li><span className="text-pr-black mr-2">→</span><strong>Sous-partie 3</strong> : Ainsi l&apos;humanité possède une essence reconnue depuis Aristote, qui fait de l&apos;humain un animal politique et rationnel, irréductible aux autres êtres vivants.</li>
              </ul>
          ...
          <PRCard number="05" title="Résumé pratique">
            <ul className="space-y-1.5 text-sm md:text-base">
              <li><span className="text-pr-black mr-2">→</span>Chaque grande partie comporte environ <strong>3 sous-parties</strong>.</li>
              <li><span className="text-pr-black mr-2">→</span>Les sous-parties suivent une <strong>logique précise</strong> (syllogisme, distinctions, points de vue, dialectique).</li>
              <li><span className="text-pr-black mr-2">→</span>Elles sont <strong>annoncées et reliées</strong> avec des formules claires.</li>
              <li><span className="text-pr-black mr-2">→</span>Donner au correcteur une impression de <strong>progression continue</strong> et maîtrisée.</li>
            </ul>
          </PRCard>
