...
const MathsFonctionsExercicesPage = () => {
  return (
      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border/40 mb-8">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-muted-foreground">
            ...
            <ChevronRight className="h-3 w-3 text-muted-foreground/50 mx-1" />
            <span className="text-foreground font-medium">Exercices - Fonctions réelles — continuité</span>
          </div>
        </div>
      </nav>
        ...
        <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-purple-50">
          <CardHeader className="pb-3">
            <CardTitle className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">
              Chapitre 5 : Exercices - Fonctions réelles — continuité
            </CardTitle>
            <p className="text-sm text-slate-600 mt-2 font-medium">
              Exercices sur la continuité des fonctions — Semestre 1, Prépa ECG Maths Approfondies
            </p>
          </CardHeader>
        </Card>
...
export default MathsFonctionsExercicesPage;
