...
import { syntaxExercises, getSyntaxExercisesByType, syntaxExerciseCategories } from '@/data/spanishSyntaxExercisesData';
...
const SyntaxeExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getSyntaxExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = syntaxExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
  ...
  const calculateScore = () => {
    ...
    syntaxExercises.forEach(exercise => {
      totalQuestions++;
          ...
          <div className={`rounded-lg p-4 border-2 ${
            ...
            {!validatedAnswers[exerciseId] && (
              <p className="text-red-700 mt-2">
                La bonne réponse est : <strong>{syntaxExercises.find(ex => ex.id === exerciseId)?.correctAnswer}</strong>
              </p>
            )}
          </div>
        )}
      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-10">
          <div className="flex justify-center mb-4">
            <Link to="/formation/espagnol/grammaire/syntaxe-structures-complexes">
              <Button variant="outline" className="flex items-center gap-2">
                ...
                Retour à la Syntaxe et Structures Complexes
              </Button>
            </Link>
          </div>
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
            ...
            Exercices de Syntaxe et Structures Complexes
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Testez vos connaissances avec ces exercices progressifs sur la syntaxe et les structures complexes espagnoles
          </p>
          <div className="flex justify-center gap-2 mt-4">
            <Badge variant="secondary">Niveau Intermédiaire - Avancé</Badge>
            <Badge variant="outline">{syntaxExercises.length} exercices</Badge>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  {syntaxExerciseCategories.map(category => (
          ...
          <Card className="mb-8 border-4 border-blue-500 bg-gradient-to-r from-blue-100 to-indigo-100 shadow-lg">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-4">
                ...
                >
                  QCM ({getSyntaxExercisesByType('qcm').length})
                </Button>
                <Button 
                ...
                >
                  Choix multiples ({getSyntaxExercisesByType('choix').length})
                </Button>
                <Button 
                ...
                >
                  Mots à compléter ({getSyntaxExercisesByType('complet').length})
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <div className={`text-lg ${
                ...
                {score >= 80 ? (
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Félicitations ! Vous avez réussi l'examen avec brio.' : 'Excellent ! Vous maîtrisez bien la syntaxe et les structures complexes espagnoles.'}
                  </div>
                ) : score >= 50 ? (
                  <div className="flex items-center justify-center gap-2">
