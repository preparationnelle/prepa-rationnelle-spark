...
import AffectiveVerbSectionComponent from '@/components/grammar/AffectiveVerbSection';
import ConjugationTable from '@/components/grammar/ConjugationTable';
import { 
  affectiveVerbSections, 
  affectiveVerbExercises, 
  affectiveVerbTables 
} from '@/data/spanishAffectiveVerbsData';

const AffectiveVerbsPage = () => {
      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute">
            ...
            <ChevronRight className="h-3 w-3 opacity-50 mx-2" />
            <span className="text-carnet-ink font-semibold">Verbes Affectifs</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-xl text-carnet-ink-mute max-w-3xl mx-auto">
            Module 9 : Maîtriser les verbes particuliers comme gustar et les tournures affectives
          </p>
          ...
          <CardContent className="text-carnet-red">
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <h3 className="font-semibold text-carnet-red-deep mb-2">1. Comprenez l'inversion</h3>
        ...
        <div className="mb-12">
          ...
          <div className="grid gap-6">
            <ConjugationTable 
              title={affectiveVerbTables.verbesAffectifs.title}
              headers={affectiveVerbTables.verbesAffectifs.headers}
              rows={affectiveVerbTables.verbesAffectifs.rows}
            />
            
            <ConjugationTable 
              title={affectiveVerbTables.conjugaison.title}
              headers={affectiveVerbTables.conjugaison.headers}
              rows={affectiveVerbTables.conjugaison.rows}
            />
            
            <ConjugationTable 
              title={affectiveVerbTables.pronomsIndirects.title}
              headers={affectiveVerbTables.pronomsIndirects.headers}
              rows={affectiveVerbTables.pronomsIndirects.rows}
            />
          </div>
        </div>
        ...
        <div className="mb-12">
          ...
          <div className="space-y-6">
            {affectiveVerbSections.map((section) => (
              <AffectiveVerbSectionComponent key={section.id} section={section} />
            ))}
          </div>
        </div>
...
export default AffectiveVerbsPage; 