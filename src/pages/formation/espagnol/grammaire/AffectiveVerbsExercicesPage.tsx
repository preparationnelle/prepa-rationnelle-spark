      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-10">
          ...
          <div className="flex justify-center gap-2 mt-4">
            ...
            <Badge className="bg-pr-orange-dark">Constructions complexes</Badge>
          </div>
        </div>
        ...
        {showScore && score !== null && (
          <Card className={`mt-10 border-2 ${examMode ? 'border-orange-200 bg-orange-50' : 'border-pink-200 bg-pink-50'}`}>
            <CardHeader className="text-center">
              <CardTitle className={`text-3xl flex items-center justify-center gap-3 ${examMode ? 'text-orange-800' : 'text-pink-800'}`}>
            ...
            <CardContent className="text-center">
              ...
              <div className={`text-lg ${
                examMode ? 'text-pr-orange-dark' : 'text-pink-700'
              }`}>
                {score >= 80 ? (
