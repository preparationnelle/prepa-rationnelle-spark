      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute">
            ...
            <ChevronRight className="h-3 w-3 opacity-50 mx-2" />
            <Link to="/formation/espagnol/grammaire/affective-verbs" className="hover:text-carnet-red transition-colors">
              Verbes Affectifs
            </Link>
            <ChevronRight className="h-3 w-3 opacity-50 mx-2" />
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="text-center mb-10">
          ...
          <div className="flex justify-center gap-2 mt-4">
            ...
            <Badge className="bg-carnet-red">Constructions complexes</Badge>
          </div>
        </div>
        ...
        {showScore && score !== null && (
          <Card className={`mt-10 border-2 ${examMode ? 'border-[rgba(193,68,58,0.25)] bg-[rgba(193,68,58,0.05)]' : 'border-pink-200 bg-pink-50'}`}>
            <CardHeader className="text-center">
              <CardTitle className={`text-3xl flex items-center justify-center gap-3 ${examMode ? 'text-carnet-red-deep' : 'text-pink-800'}`}>
            ...
            <CardContent className="text-center">
              ...
              <div className={`text-lg ${
                examMode ? 'text-carnet-red' : 'text-pink-700'
              }`}>
                {score >= 80 ? (
