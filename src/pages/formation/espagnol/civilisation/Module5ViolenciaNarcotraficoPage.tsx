...
import { violenciaNarcotraficoData } from '@/data/violenciaNarcotraficoData';
    ...
    <div className="min-h-screen bg-[#F7F6F3] relative overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40 relative z-10">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-muted-foreground">
            ...
            <ChevronRight className="h-3 w-3 text-muted-foreground/50 mx-1" />
            <Link to="/formation/espagnol/civilisation/module5" className="hover:text-foreground transition-colors">
              Violencia y Narcotráfico
            </Link>
            <ChevronRight className="h-3 w-3 text-muted-foreground/50 mx-1" />
            <span className="text-foreground font-medium">Vocabulaire Violence</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4 relative z-10">
        ...
        <div className="max-w-6xl mx-auto">
          {/* Unified flashcards component for violence/narcotics vocabulary */}
          <UnifiedFlashcards
            data={violenciaNarcotraficoData}
            title="Vocabulaire Violence et Narcotrafic espagnol-français"
          />
        </div>
      </div>
    </div>
