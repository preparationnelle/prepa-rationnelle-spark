...
const modules = [
  {
    to: '/formation/arabe/grammaire',
    Icon: FileText,
    title: 'Grammaire',
    description: 'Maîtrisez la grammaire arabe avec des exercices interactifs et des explications détaillées.',
    cta: 'Explorer la grammaire',
  },
  {
    to: '/formation/arabe/civilisation',
    Icon: BookOpen,
    title: 'Civilisation',
    description: 'Découvrez la civilisation et la culture arabes à travers l’histoire et l’actualité.',
    cta: 'Explorer la civilisation',
  },
  {
    to: '/formation/arabe/vocabulaire',
    Icon: Languages,
    title: 'Vocabulaire',
    description: 'Enrichissez votre vocabulaire arabe avec des flashcards et des exercices thématiques.',
