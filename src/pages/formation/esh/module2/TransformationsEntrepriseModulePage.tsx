      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
              ...
              <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
              <span className="carnet-eyebrow text-[11px]">Module – Transformations de l'entreprise et de sa gouvernance</span>
            </div>
          </div>
        </nav>
      ...
      <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-12 lg:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="rounded-2xl bg-gradient-to-r from-carnet-red to-pr-orange-dark text-white p-8 shadow-md">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2">
                <a href="#preindus" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">1) Pré‑industriel → 1ère industrialisation</a>
                <a href="#grandes" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">2) Naissance de la grande entreprise</a>
                <a href="#apresguerre" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">3) Après‑guerre → aujourd’hui</a>
                <a href="#theories" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">4) Théories de la firme</a>
                <a href="#gouvernance" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">5) Gouvernance</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {/* 1 */}
            <div id="preindus" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">1) De l’âge pré‑industriel à la première industrialisation</h2>
              <div className="space-y-5 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Tissu pré‑industriel et proto‑industrie</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Première industrialisation (1780–1880)</h3>
            ...
            {/* 2 */}
            <div id="grandes" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">2) Naissance de la grande entreprise moderne (milieu XIXe – années 1930)</h2>
              <div className="space-y-5 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Seconde industrialisation</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Spécificités françaises</h3>
            ...
            {/* 3 */}
            <div id="apresguerre" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">3) De l’après‑guerre à nos jours</h2>
              <div className="space-y-5 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) FMN, moteur de la mondialisation</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Structure européenne : prédominance des PME</h3>
            ...
            {/* 4 */}
            <div id="theories" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">4) Évolutions des formes organisationnelles et théories de la firme</h2>
              <div className="space-y-5 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Genèse</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Paradigmes contractuel et transactionnel</h3>
            ...
            {/* 5 */}
            <div id="gouvernance" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">5) Transformations des modes de gouvernance</h2>
              <div className="space-y-5 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Théories managériales</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Shareholders → Stakeholders</h3>
