      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
              ...
              <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
              <span className="carnet-eyebrow text-[11px]">Module – Croissance économique</span>
            </div>
          </div>
        </nav>
      ...
      <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-12 lg:py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <div className="rounded-2xl bg-gradient-to-r from-carnet-red to-pr-orange-dark text-white p-8 shadow-md">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2">
                <a href="#caracteristiques" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">1) Caractéristiques</a>
                <a href="#modeles" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">2) Modèles</a>
                <a href="#sources" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">3) Sources</a>
                <a href="#limites" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">4) Limites</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            {/* 1) Caractéristiques */}
            <div id="caracteristiques" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">1) Les caractéristiques de la croissance</h2>
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Révolutions industrielles et croissance</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Croissance inégale dans le temps et l’espace</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C) Déséquilibres de la croissance</h3>
            ...
            {/* 2) Modèles */}
            <div id="modeles" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">2) Les modèles d’Harrod‑Domar et de Solow</h2>
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Équilibre de long terme improbable (perspective keynésienne)</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Convergence vers un état régulier (Solow, 1956)</h3>
            ...
            {/* 3) Sources */}
            <div id="sources" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">3) Les sources de la croissance</h2>
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Gains de productivité</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Résidu et PGF</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C) Progrès technique exogène (néoclassiques)</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">D) Croissance endogène</h3>
            ...
            <div id="limites" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              <h2 className="font-lora text-[20px] text-carnet-ink leading-tight mb-3">4) Les limites de la croissance</h2>
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Une croissance durable envisageable</h3>
                  <p>Contre Malthus : une croissance pérenne est possible si la taille du marché suit les gains de productivité.</p>
                </div>
                <div>
                  <h3 className="font-semibold text-carnet-ink">B) Freins : rendements décroissants et ressources</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C) Stagnation séculaire</h3>
