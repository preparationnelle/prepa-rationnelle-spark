      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
              ...
              <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
              <span className="carnet-eyebrow text-[11px]">Les défaillances de marché</span>
            </div>
          </div>
        </nav>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)]">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Qu'est-ce qu'une défaillance de marché ?</h3>
                ...
                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Hypothèses de la concurrence parfaite</h3>
                  <p className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">
                ...
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-4">
                  <h4 className="font-semibold text-carnet-ink mb-2">Conséquences des défaillances</h4>
            ...
            <div className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)]">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    <h3 className="font-semibold text-carnet-ink">L'aléa moral (moral hazard)</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-carnet-red mt-0.5 flex-shrink-0" />
                  ...
                  <div className="space-y-3">
                    <h3 className="font-semibold text-carnet-ink">La sélection adverse (adverse selection)</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="h-4 w-4 text-carnet-red mt-0.5 flex-shrink-0" />
                ...
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-4">
                  <h4 className="font-semibold text-carnet-ink mb-2">Solutions aux asymétries d'information</h4>
                  <ul className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] space-y-1">
