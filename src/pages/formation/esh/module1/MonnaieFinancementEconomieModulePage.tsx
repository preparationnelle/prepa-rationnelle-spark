      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
              ...
              <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
              <span className="carnet-eyebrow text-[11px]">Module – Monnaie et financement</span>
            </div>
          </div>
        </nav>
          ...
          <div className="mb-8">
            <div className="rounded-2xl bg-gradient-to-r from-carnet-red to-pr-black text-white p-8 shadow-md">
              ...
              <div className="mt-6 flex flex-wrap justify-center gap-2">
                <a href="#sec1" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">1) Définir le financement</a>
                <a href="#sec2" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">2) Acteurs & instruments</a>
                <a href="#sec3" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">3) Mutations du système</a>
                <a href="#sec4" className="px-3 py-1 rounded-full bg-carnet-paper-2/10 text-white border border-white/20 hover:bg-carnet-paper-2/20 transition">4) Crises & régulation</a>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div id="sec1" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              ...
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A - L’économie a besoin de financement</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B - Les besoins de financement des uns financent les capacités des autres</h3>
                  <h4 className="font-medium text-carnet-ink">1 - SNF et APU sont génralement en besoin de financement</h4>
                  ...
                  <h4 className="font-medium text-carnet-ink mt-2">2 - Les ménages sont généralement en capacité de financement</h4>
                  ...
                  <h4 className="font-medium text-carnet-ink mt-2">3 - En économie ouverte</h4>
            ...
            <div id="sec2" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              ...
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A) Les systèmes financiers contribuent au financement de l'économie</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B - Les banques offrent des crédits et créent la monnaie</h3>
                  ...
                  <h4 className="font-medium text-carnet-ink mt-2">2 - On distingue 3 sources de création monétaire</h4>
                  <p>1-avec l’extérieur , 2 avec les APU (ex : achat bon du Trésor), 3 avec l’économie  (entreprises et ménages.)</p>
                  <h4 className="font-medium text-carnet-ink mt-2">3 - Les mécanismes de création monétaire par le système bancaire</h4>
                  ...
                  <h4 className="font-medium text-carnet-ink mt-2">4 - Deux théorie de l’offre de monnaie</h4>
                  ...
                  <h4 className="font-medium text-carnet-ink mt-2">5 - Les agrégats monétaires</h4>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C - Les intermédiaires financiers non bancaires</h3>
            ...
            <div id="sec3" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              ...
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A - Réformes financières ambitieuse depuis 1980</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">B - Le système financier connaît des innovations majeurs</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C - La taille des marchés financiers explose</h3>
            ...
            <div id="sec4" className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)] ring-1 ring-blue-100">
              ...
              <div className="space-y-4 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55] leading-relaxed">
                <div>
                  <h3 className="font-semibold text-carnet-ink">A - Les crises se multiplient à l’ère de la mondialisation</h3>
                  <p>Voir tableau p38</p>
                </div>
                <div>
                  <h3 className="font-semibold text-carnet-ink">B - Un petits nombres de mécanisme à l’origine de la crise financière</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">C - Les crises financières sont souvent associées aux innovations</h3>
                ...
                <div>
                  <h3 className="font-semibold text-carnet-ink">D - Les banques centrales et la régulation financière ont un rôle essentiel face aux crises</h3>
