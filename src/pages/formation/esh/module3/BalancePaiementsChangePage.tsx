      ...
      <nav className="sticky top-0 z-40 carnet-paper-plain border-b border-dashed border-[rgba(78,55,30,0.18)]">
        <div className="mx-auto max-w-[1180px] pl-6 pr-6 lg:pl-[200px] lg:pr-16 py-3">
          <div className="flex items-center font-instrument text-[12px] text-carnet-ink-mute flex-wrap">
              ...
              <ChevronRight className="h-3 w-3 mx-2 opacity-50" />
              <span className="carnet-eyebrow text-[11px]">Balance des paiements, cours de change et systèmes de change</span>
            </div>
          </div>
        </nav>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)]">
              ...
              <div className="space-y-4">
                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Balance commerciale</h3>
                  <p className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">Échanges de biens : exportations - importations de marchandises</p>
                </div>

                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Balance des services</h3>
                  <p className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">Tourisme, transports, services financiers, royalties</p>
                </div>

                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Balance des revenus</h3>
                  <p className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">Revenus du travail et du capital (dividendes, intérêts)</p>
                </div>

                <div className="border-l-4 border-carnet-red/40 pl-4">
                  <h3 className="font-semibold text-carnet-ink mb-2">Balance des transferts courants</h3>
                  <p className="font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">Aides, dons, transferts migrants</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)]">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-3">
                  <h3 className="font-semibold text-carnet-ink">Taux de change fixe :</h3>
                ...
                <div className="space-y-3">
                  <h3 className="font-semibold text-carnet-ink">Taux de change flottant :</h3>
                  <ul className="space-y-2 font-instrument text-[13px] text-carnet-ink-soft leading-[1.55]">
                    <li className="flex items-start gap-2">
                      <CheckCircle className="h-4 w-4 text-carnet-red mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-carnet-paper-2 rounded-2xl p-6 border border-dashed border-[rgba(78,55,30,0.18)]">
              ...
              <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-4 mb-4">
                <h3 className="font-semibold text-carnet-ink mb-2">Facteurs fondamentaux</h3>
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-3">
                  <h4 className="font-semibold text-carnet-ink text-sm mb-1">Parité des pouvoirs d'achat (PPA)</h4>
                  <p className="text-xs text-carnet-ink-soft">Taux d'équilibre à long terme basé sur les prix relatifs</p>
                </div>
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-3">
                  <h4 className="font-semibold text-carnet-ink text-sm mb-1">Parité des taux d'intérêt</h4>
                  <p className="text-xs text-carnet-ink-soft">Relation entre taux de change et différentiels de taux</p>
                </div>
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-3">
                  <h4 className="font-semibold text-carnet-ink text-sm mb-1">Spéculation</h4>
                  <p className="text-xs text-carnet-ink-soft">Attentes des opérateurs sur les évolutions futures</p>
                </div>
                <div className="bg-[rgba(193,68,58,0.08)] rounded-lg p-3">
                  <h4 className="font-semibold text-carnet-ink text-sm mb-1">Interventions officielles</h4>
                  <p className="text-xs text-carnet-ink-soft">Actions des banques centrales sur le marché des changes</p>
                </div>
              </div>
            </div>
          </div>
