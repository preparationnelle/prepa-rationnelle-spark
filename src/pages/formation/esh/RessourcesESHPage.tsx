        ...
        <div className="max-w-6xl mx-auto">
          <div className="bg-white rounded-xl p-8 shadow-md border border-carnet-red/20">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-carnet-red">
            ...
            {/* ESSEC */}
            <div className="mb-8">
              <h3 className="text-xl font-semibold text-carnet-red-deep mb-4 border-b border-carnet-red/30 pb-2">
                ESSEC (2000-2025)
              </h3>
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2023 (2) :</span>
                    <span className="text-gray-700 ml-2">Qu'est-ce qu'un bon SMI ?</span>
                  </div>
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2022 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2022 (2) :</span>
                    <span className="text-gray-700 ml-2">Inégalités et croissance</span>
                  </div>
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2021 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2015 (1) :</span>
                    <span className="text-gray-700 ml-2">L'euro : d'où vient-il ? Où mène-t-il ?</span>
                  </div>
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2015 (2) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2014 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2014 (2) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2009 (2) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2008 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2008 (2) :</span>
                    <span className="text-gray-700 ml-2">Concurrence monétaire et compétitivité des nations.</span>
                  </div>
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2007 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2007 (2) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2006 (1) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2002 (2) :</span>
                  ...
                  <div className="text-sm">
                    <span className="font-medium text-carnet-red">2000 (2) :</span>
