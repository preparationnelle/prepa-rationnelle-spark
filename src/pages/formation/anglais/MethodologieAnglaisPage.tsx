      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-green-200">
            <h2 className="text-2xl font-bold text-green-800 mb-4">📚 1. Traduction et Grammaire</h2>
            
            <div className="bg-green-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-green-900 mb-2">Pourquoi est-ce crucial ?</h3>
            ...
            <div className="bg-blue-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-blue-900 mb-2">Comment s'y prendre efficacement ?</h3>
              <p className="text-gray-700">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-green-200">
            <h2 className="text-2xl font-bold text-green-800 mb-4">✅ 2. Gérer vos erreurs</h2>
            
            <div className="bg-blue-50 p-4 rounded-lg mb-4">
              <h3 className="font-semibold text-blue-900 mb-2">Pourquoi ?</h3>
              <p className="text-gray-700">
            ...
            <div className="bg-purple-50 p-4 rounded-lg">
              <h3 className="font-semibold text-purple-900 mb-3">2. Vocabulaire</h3>
              <div className="space-y-3 text-sm">
                <div>
                ...
                <div>
                  <p className="text-purple-800"><strong>Focus sur l'orthographe :</strong> accommodation, environment, indispensable.</p>
                  <p className="text-purple-800"><strong>Flashcards :</strong> Utilisez une appli comme Anki pour mémoriser vos mots clés.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-blue-50 rounded-lg p-6 border border-blue-200 text-center">
            <h3 className="text-xl font-bold text-blue-800 mb-3">📖 Contenu complet de la méthode</h3>
