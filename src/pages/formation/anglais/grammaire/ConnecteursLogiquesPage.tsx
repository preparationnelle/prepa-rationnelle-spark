            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-200 bg-white">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="border px-3 py-2 text-left text-pr-black">Fonction</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Connecteurs</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Exemple</th>
                  </tr>
                </thead>
                <tbody>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Addition</td><td className="border px-3 py-2">moreover, furthermore, in addition, also</td><td className="border px-3 py-2">Moreover, the results are clear.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Opposition</td><td className="border px-3 py-2">however, nevertheless, yet, whereas, while</td><td className="border px-3 py-2">However, the trend is uncertain.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Cause</td><td className="border px-3 py-2">because, since, as, due to, owing to</td><td className="border px-3 py-2">Due to the delay, we canceled.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Conséquence</td><td className="border px-3 py-2">therefore, thus, hence, as a result</td><td className="border px-3 py-2">Therefore, we must adapt.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Concession</td><td className="border px-3 py-2">although, though, even though, despite, in spite of</td><td className="border px-3 py-2">Although it was late, we stayed.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Illustration</td><td className="border px-3 py-2">for instance, for example, namely</td><td className="border px-3 py-2">For instance, consider AI risks.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">But</td><td className="border px-3 py-2">to, in order to, so as to; so that</td><td className="border px-3 py-2">We trained so that we could win.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Comparaison</td><td className="border px-3 py-2">similarly, likewise, whereas</td><td className="border px-3 py-2">Similarly, sales increased.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Conclusion</td><td className="border px-3 py-2">to conclude, in conclusion, ultimately</td><td className="border px-3 py-2">In conclusion, the plan works.</td></tr>
                </tbody>
              </table>
            </div>
          </CardContent>
