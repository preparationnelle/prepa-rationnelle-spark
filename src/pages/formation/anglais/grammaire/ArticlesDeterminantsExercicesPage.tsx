...
import { articlesDeterminantsExercises, getArticlesDeterminantsExercisesByType, articlesDeterminantsCategories } from '@/data/englishArticlesDeterminantsExercisesData';
...
const ArticlesDeterminantsExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getArticlesDeterminantsExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = articlesDeterminantsExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/anglais/grammaire/articles" className="hover:text-gray-900 transition-colors">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
            ...
            Articles & Determiners - Exercises
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Master English articles (a/an/the) and determiners (some/any, much/many, little/few) through interactive exercises.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {articlesDeterminantsCategories.map(category => (
              ...
              <div className={`text-lg ${
                ...
                {score >= 80 ? (
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Congratulations! You passed the exam successfully.' : 'Excellent! You have a good command of articles and determiners.'}
                  </div>
                ) : score >= 50 ? (
                  <div className="flex items-center justify-center gap-2">
                  ...
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Keep practicing! Review the material and try again.' : 'Keep practicing! Review articles and determiners and try again.'}
              </div>
                )}
              </div>
              <div className="mt-6">
                <p className="text-sm text-gray-600">
                  {examMode ? 'Exam completed.' : 'Practice more to improve your understanding of articles and determiners.'}
                </p>
            </div>
          </CardContent>
        </Card>
