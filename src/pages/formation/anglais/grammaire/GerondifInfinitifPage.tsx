    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4 text-gray-800">
            <ul className="list-disc pl-6 space-y-1">
              <li><span className="text-pr-black font-semibold">Gérondif</span> : base + -ing (e.g., <span className="italic">swimming</span>) → l’action comme concept.</li>
              <li><span className="text-pr-black font-semibold">Infinitif</span> : to + base (e.g., <span className="italic">to swim</span>) → potentialité/intention.</li>
            </ul>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>She enjoys <span className="text-pr-black font-semibold">reading</span>.</li>
                <li>They postponed <span className="text-pr-black font-semibold">taking</span> the test.</li>
              </ul>
            </section>
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>He decided <span className="text-pr-black font-semibold">to leave</span>.</li>
                <li>She hopes <span className="text-pr-black font-semibold">to win</span>.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">2.3 Verbes pouvant prendre gérondif ou infinitif</h3>
              <p><span className="text-pr-black font-semibold">Sans changement de sens</span> : begin, continue, hate, like, love, prefer, start.</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>I began <span className="text-pr-black font-semibold">to learn</span> / <span className="text-pr-black font-semibold">learning</span> Spanish.</li>
              </ul>
              <p className="mt-2"><span className="text-pr-black font-semibold">Avec changement de sens</span> : forget, remember, regret, go on, stop.</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>I stopped <span className="text-pr-black font-semibold">smoking</span> vs I stopped <span className="text-pr-black font-semibold">to smoke</span>.</li>
              </ul>
            </section>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>I’m good at <span className="text-pr-black font-semibold">cooking</span>.</li>
                <li>Before <span className="text-pr-black font-semibold">going</span> to bed, brush your teeth.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">3.2 Après adjectifs → Infinitif</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>It’s easy <span className="text-pr-black font-semibold">to understand</span>.</li>
                <li>She’s happy <span className="text-pr-black font-semibold">to help</span>.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">3.3 Pour exprimer le but → Infinitif</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>He works hard <span className="text-pr-black font-semibold">to succeed</span>.</li>
                <li>I opened the window <span className="text-pr-black font-semibold">to let</span> fresh air in.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">3.4 Après certains modaux → Infinitif sans "to"</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>She <span className="text-pr-black font-semibold">can</span> swim.</li>
                <li>We <span className="text-pr-black font-semibold">must</span> leave.</li>
              </ul>
            </section>
          </CardContent>
        </Card>
              ...
              <table className="min-w-full border border-gray-200 bg-white">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="border px-3 py-2 text-left text-pr-black">Gérondif (–ing)</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Infinitif (to + verb)</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6 space-y-1">
              <li>Omettre <span className="text-pr-black font-semibold">to</span> après les verbes exigeant l’infinitif.</li>
              <li>Ajouter <span className="text-pr-black font-semibold">to</span> après les verbes exigeant le gérondif.</li>
              <li>Confondre les sens pour <span className="text-pr-black font-semibold">forget/remember/regret/stop/go on</span>.</li>
