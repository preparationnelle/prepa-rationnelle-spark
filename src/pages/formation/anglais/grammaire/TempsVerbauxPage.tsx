      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + Verbe (+ s/es à la 3ème personne)</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li>Habitudes et routines</li>
                  <li>Vérités générales et faits scientifiques</li>
                  <li>États permanents</li>
                </ul>
                <p className="mt-1"><span className="text-pr-black font-semibold">Exemples</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + am/is/are + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + have/has + Participe passé</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + have/has been + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + Verbe au passé (-ed ou forme irrégulière)</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + was/were + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + had + Participe passé</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + had been + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + will + Verbe à l'infinitif</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + will be + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + will have + Participe passé</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
              ...
              <section>
                ...
                <p><span className="text-pr-black font-semibold">Structure</span> : Sujet + will have been + Verbe-ing</p>
                <p className="mt-1"><span className="text-pr-black font-semibold">Utilisations</span> :</p>
                <ul className="list-disc pl-6 space-y-1">
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : If + Présent simple, Présent simple</p>
              <p><span className="text-pr-black font-semibold">Utilisation</span> : Vérités générales, lois scientifiques</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Exemples</span> :</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : If + Présent simple, will + Infinitif</p>
              <p><span className="text-pr-black font-semibold">Utilisation</span> : Situations probables et leurs conséquences</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Exemples</span> :</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : If + Passé simple, would + Infinitif</p>
              <p><span className="text-pr-black font-semibold">Utilisation</span> : Situations hypothétiques ou improbables</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Exemples</span> :</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : If + Past Perfect, would have + Participe passé</p>
              <p><span className="text-pr-black font-semibold">Utilisation</span> : Situations irréelles du passé et leurs conséquences</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Exemples</span> :</p>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <Card className="mt-8">
          ...
          <CardContent className="space-y-6">
            ...
            <section>
              <h3 className="text-xl font-semibold mb-2"><span className="text-pr-black">Should</span> / <span className="text-pr-black">Would</span></h3>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              <h3 className="text-xl font-semibold mb-2"><span className="text-pr-black">May</span> / <span className="text-pr-black">Might</span> / <span className="text-pr-black">Must</span></h3>
              <ul className="list-disc pl-6 space-y-1">
          ...
          <CardContent>
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-200 bg-white">
                ...
                <tbody>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Present Simple</td><td className="border px-3 py-2">Sujet + V (+ s/es)</td><td className="border px-3 py-2">She works here.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Present Continuous</td><td className="border px-3 py-2">Sujet + am/is/are + V-ing</td><td className="border px-3 py-2">She is working now.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Present Perfect</td><td className="border px-3 py-2">Sujet + have/has + V3</td><td className="border px-3 py-2">She has worked here for 2 years.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Present Perf. Continuous</td><td className="border px-3 py-2">Sujet + have/has been + V-ing</td><td className="border px-3 py-2">She has been working since 9 AM.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Past Simple</td><td className="border px-3 py-2">Sujet + V2</td><td className="border px-3 py-2">She worked yesterday.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Past Continuous</td><td className="border px-3 py-2">Sujet + was/were + V-ing</td><td className="border px-3 py-2">She was working at 5 PM.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Past Perfect</td><td className="border px-3 py-2">Sujet + had + V3</td><td className="border px-3 py-2">She had worked before I arrived.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Past Perf. Continuous</td><td className="border px-3 py-2">Sujet + had been + V-ing</td><td className="border px-3 py-2">She had been working for hours.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Future Simple</td><td className="border px-3 py-2">Sujet + will + V</td><td className="border px-3 py-2">She will work tomorrow.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Future Continuous</td><td className="border px-3 py-2">Sujet + will be + V-ing</td><td className="border px-3 py-2">She will be working at 3 PM.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Future Perfect</td><td className="border px-3 py-2">Sujet + will have + V3</td><td className="border px-3 py-2">She will have worked 8 hours by then.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Future Perf. Continuous</td><td className="border px-3 py-2">Sujet + will have been + V-ing</td><td className="border px-3 py-2">She will have been working for 8 hours.</td></tr>
                </tbody>
              </table>
            </div>
          </CardContent>
        ...
        {/* CTA exercices */}
        <Card className="mt-8 border-2 border-gray-200 bg-gradient-to-r from-orange-50 to-amber-50">
          <CardHeader>
            <CardTitle className="text-2xl flex items-center gap-2 text-gray-800">
