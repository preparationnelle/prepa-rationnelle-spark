...
import { conditionalsExercises, getConditionalsExercisesByType, conditionalsExerciseCategories } from '@/data/englishConditionalsExercisesData';

const ConditionnelsExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getConditionalsExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = conditionalsExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
            ...
            {!examMode && (
              <>
                ...
                >
                  ...
                  {showHints[exercise.id] ? 'Masquer l\'indice' : 'Voir l\'indice'}
                </Button>
                <Button
          ...
          {showHints[exercise.id] && (
            <div className="mt-4 p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
              <p className="text-yellow-800 text-sm">
                <strong>💡 Indice :</strong> {exercise.explanation.split('.')[0]}.
              </p>
            </div>
          )}
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/anglais/grammaire/conditionnels" className="hover:text-gray-900 transition-colors">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Practice conditional structures through interactive exercises. Test your knowledge with QCM, fill-in-the-blank, and multiple-choice questions.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {conditionalsExerciseCategories.map(category => (
            ...
            <CardContent className="text-center">
              ...
              <div className={`text-lg ${
                ...
                {score >= 80 ? (
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Congratulations! You passed the exam successfully.' : 'Excellent! You have a good command of conditional structures.'}
                  </div>
                ) : score >= 50 ? (
                  <div className="flex items-center justify-center gap-2">
              ...
              <div className="mt-6">
                <p className="text-sm text-gray-600">
                  {examMode ? 'Exam completed.' : 'Practice more to improve your understanding of conditional structures.'}
                </p>
              </div>
            </CardContent>
          </Card>
        ...
        <div className="flex justify-center mt-12">
          <Link to="/formation/anglais/grammaire/conditionnels">
            <Button variant="outline" className="flex items-center gap-2">
              <ArrowLeft className="h-4 w-4" />
              Back to Conditional Structures
            </Button>
          </Link>
        </div>
      </div>
...
export default ConditionnelsExercicesPage;
