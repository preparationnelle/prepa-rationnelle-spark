      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="grid md:grid-cols-2 gap-6 text-gray-800">
            <div className="bg-white/70 rounded-lg p-4 border border-gray-200">
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: Subject + reporting verb + "exact words"</p>
            ...
            <div className="bg-white/70 rounded-lg p-4 border border-carnet-red/30">
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: Subject + reporting verb + (that) + transformed clause</p>
              <p className="mt-2">Example: She said (that) she was tired.</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>Removal of quotation marks</li>
                <li>Possible addition of <span className="text-pr-black font-semibold">that</span></li>
        ...
        <Card className="mb-8">
          <CardHeader>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>He said, "I love my car." → He said (that) <span className="text-pr-black font-semibold">he</span> loved <span className="text-pr-black font-semibold">his</span> car.</li>
                <li>She told me, "You are right." → She told me (that) <span className="text-pr-black font-semibold">I</span> was right.</li>
                <li>They said, "We will come tomorrow." → They said (that) <span className="text-pr-black font-semibold">they</span> would come the next day.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">Règle 2 : Le Backshift (Recul des Temps)</h3>
              <p>Avec un verbe introducteur au passé, les temps reculent d'un cran : <span className="text-pr-black font-semibold">Présent → Passé</span>, <span className="text-pr-black font-semibold">Passé → Plus-que-parfait</span>, <span className="text-pr-black font-semibold">Futur → Conditionnel</span>.</p>
            </section>
            <section>
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li>Present Simple → Past Simple : "I work here." → He said he <span className="text-pr-black font-semibold">worked</span> there.</li>
                <li>Present Continuous → Past Continuous : "I am studying." → She said she <span className="text-pr-black font-semibold">was studying</span>.</li>
                <li>Present Perfect → Past Perfect : "I have finished." → He said he <span className="text-pr-black font-semibold">had finished</span>.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">Temps du Passé</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>Past Simple → Past Perfect : "I went yesterday." → She said she <span className="text-pr-black font-semibold">had gone</span> the day before.</li>
                <li>Past Continuous → Past Perfect Continuous : "I was sleeping." → He said he <span className="text-pr-black font-semibold">had been sleeping</span>.</li>
              </ul>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">Futur et Modaux</h3>
              <ul className="list-disc pl-6 space-y-1">
                <li>will → would : "I will help you." → He said he <span className="text-pr-black font-semibold">would</span> help.</li>
                <li>can → could : "I can speak French." → She said she <span className="text-pr-black font-semibold">could</span> speak French.</li>
                <li>may → might : "It may rain." → They said it <span className="text-pr-black font-semibold">might</span> rain.</li>
                <li>must → had to : "You must finish today." → The boss said I <span className="text-pr-black font-semibold">had to</span> finish that day.</li>
              </ul>
            </section>
          </CardContent>
        </Card>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-200 bg-white">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="border px-3 py-2 text-left text-pr-black">Discours Direct</th>
                      <th className="border px-3 py-2 text-left text-pr-black">Discours Indirect</th>
                    </tr>
                  </thead>
                  <tbody>
            ...
            <section>
              ...
              <div className="overflow-x-auto">
                <table className="min-w-full border border-gray-200 bg-white">
                  <thead className="bg-gray-50">
                    <tr>
                      <th className="border px-3 py-2 text-left text-pr-black">Direct</th>
                      <th className="border px-3 py-2 text-left text-pr-black">Indirect</th>
                    </tr>
                  </thead>
                  <tbody>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : verbe introducteur + if/whether + proposition (ordre sujet + verbe, pas d'inversion)</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : verbe introducteur + mot interrogatif + proposition (ordre normal)</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : tell/order + objet + (not) to + infinitif</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span> : ask + objet + (not) to + infinitif</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li><span className="text-pr-black font-semibold">say</span> (sans objet) : She said (that) ...</li>
                <li><span className="text-pr-black font-semibold">tell</span> (avec objet) : She told me (that) ...</li>
                <li><span className="text-pr-black font-semibold">ask</span> : He asked if/whether ...</li>
              </ul>
            </section>
            <section>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <ul className="list-disc pl-6 space-y-1">
              ...
              <li>Mauvais usage de <span className="text-pr-black font-semibold">say</span> et <span className="text-pr-black font-semibold">tell</span></li>
              <li>Garder l'ordre interrogatif dans les questions rapportées (inversion)</li>
              <li>Utiliser <span className="text-pr-black font-semibold">that</span> après <span className="text-pr-black font-semibold">ask</span> pour une question</li>
        ...
        <Card className="mb-2">
          ...
          <CardContent className="space-y-4">
            ...
            <p><span className="text-pr-black font-semibold">Conseil pratique</span> : commencez par les affirmations simples, puis entraînez-vous avec les questions et les ordres/demandes.</p>
          </CardContent>
        </Card>
