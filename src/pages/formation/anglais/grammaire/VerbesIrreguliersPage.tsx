    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8 border-2 border-gray-200 bg-gradient-to-r from-orange-50 to-pr-black-pale">
          ...
          <CardContent className="text-pr-black space-y-2">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-200 bg-white">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="border px-3 py-2 text-left text-pr-black">Base</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Prétérit</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Participe Passé</th>
                    <th className="border px-3 py-2 text-left text-pr-black">Traduction</th>
                  </tr>
                </thead>
                <tbody>
                  {verbs.map(([base, past, pp, fr]) => (
                    <tr key={base}>
                      <td className="border px-3 py-2 text-pr-black font-medium">{base}</td>
        ...
        <Card className="mb-8">
          ...
          <CardContent>
            <ul className="list-disc pl-6 space-y-1">
              <li>Confondre prétérit et participe (❌ I have <span className="line-through">wrote</span> → ✅ I have <span className="text-pr-black font-semibold">written</span>).</li>
        ...
        <Card className="mt-2 border-2 border-gray-200 bg-gradient-to-r from-orange-50 to-amber-50">
          ...
          <CardContent className="text-center">
            <p className="text-lg text-pr-black mb-6">Entraînez-vous avec des quiz de conversion base ↔ prétérit ↔ participe.</p>
