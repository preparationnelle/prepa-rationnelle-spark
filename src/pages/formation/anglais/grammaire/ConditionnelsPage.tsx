      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4 text-gray-800">
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li><span className="text-pr-black font-semibold">Conditional clause (if-clause)</span>: expresses the condition</li>
              <li><span className="text-pr-black font-semibold">Main clause</span>: expresses the result</li>
            </ul>
            <div className="bg-white/70 rounded-lg p-4 border border-gray-200">
              <p className="font-semibold text-gray-800">Example:</p>
              <p className="mt-1">If it rains, I will stay home.</p>
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li><span className="text-pr-black font-semibold">Condition</span>: If it rains</li>
                <li><span className="text-pr-black font-semibold">Result</span>: I will stay home</li>
              </ul>
              <p className="mt-3"><span className="text-pr-black font-semibold">Important</span>: The order can be reversed without changing the meaning → I will stay home if it rains.</p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Present Simple, Present Simple</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: General truths, scientific facts, habits</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
                <li>If you heat water to 100°C, it boils.</li>
                <li>If I eat too much, I feel sick.</li>
                <li>When the sun sets, it gets dark.</li>
              </ul>
              <p className="mt-2">Note: You can use <span className="text-pr-black font-semibold">when</span> instead of <span className="text-pr-black font-semibold">if</span> in this type.</p>
            </section>

            {/* First Conditional */}
            <section>
              <h3 className="text-xl font-semibold mb-2">First Conditional</h3>
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Present Simple, will + infinitive</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: Real and probable future situations</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Past Simple, would + infinitive</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: Hypothetical, unreal or improbable situations in present/future</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
              ...
              <p className="mt-2">Special feature: With the verb <span className="text-pr-black font-semibold">be</span>, we use <span className="text-pr-black font-semibold">were</span> for all persons.</p>
            </section>

            {/* Third Conditional */}
            <section>
              <h3 className="text-xl font-semibold mb-2">Third Conditional</h3>
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Past Perfect, would have + past participle</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: Unreal past situations and their consequences</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Past Perfect, would + infinitive</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: Unfulfilled past condition that affects the present</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: If + Past Simple, would have + past participle</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Usage</span>: Hypothetical present situation that would have changed the past</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Structure</span>: Unless + affirmative clause = If + negative clause</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Usage</span>: Emphasizes the necessary condition</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Usage</span>: More formal than "as long as"</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Usage</span>: Precaution or preparation for a possible event</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Usage</span>: Emphasizes that the result wouldn't change</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Usage</span>: Informal conversation to introduce a hypothesis</p>
              <p className="mt-1"><span className="text-pr-black font-semibold">Examples</span>:</p>
              <ul className="list-disc pl-6 space-y-1">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <p><span className="text-pr-black font-semibold">Standard</span>: If you should need help, call me.</p>
              <p><span className="text-pr-black font-semibold">Inversion</span>: Should you need help, call me.</p>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">Were (Second Conditional)</h3>
              <p><span className="text-pr-black font-semibold">Standard</span>: If I were in charge, I would change things.</p>
              <p><span className="text-pr-black font-semibold">Inversion</span>: Were I in charge, I would change things.</p>
            </section>
            <section>
              <h3 className="text-xl font-semibold mb-2">Had (Third Conditional)</h3>
              <p><span className="text-pr-black font-semibold">Standard</span>: If we had known earlier, we would have come.</p>
              <p><span className="text-pr-black font-semibold">Inversion</span>: Had we known earlier, we would have come.</p>
            </section>
          </CardContent>
        </Card>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li><span className="text-pr-black font-semibold">COMMA REQUIRED</span> when the if-clause comes first.</li>
                <li><span className="text-pr-black font-semibold">No comma</span> when the main clause comes first.</li>
              </ul>
              <div className="bg-white/70 rounded-lg p-4 border border-gray-200 mt-3 space-y-1">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-200 bg-white">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="border px-3 py-2 text-left text-pr-black">Type</th>
                ...
                <tbody>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Zero</td><td className="border px-3 py-2">If + present, present</td><td className="border px-3 py-2">General truths</td><td className="border px-3 py-2">If you heat ice, it melts.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">First</td><td className="border px-3 py-2">If + present, will + V</td><td className="border px-3 py-2">Probable future</td><td className="border px-3 py-2">If it rains, I will stay home.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Second</td><td className="border px-3 py-2">If + past, would + V</td><td className="border px-3 py-2">Present/future hypothesis</td><td className="border px-3 py-2">If I were rich, I would travel.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Third</td><td className="border px-3 py-2">If + past perfect, would have + V3</td><td className="border px-3 py-2">Past regret</td><td className="border px-3 py-2">If I had known, I would have come.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Mixed 1</td><td className="border px-3 py-2">If + past perfect, would + V</td><td className="border px-3 py-2">Past → Present</td><td className="border px-3 py-2">If I had studied, I would be fluent now.</td></tr>
                  <tr><td className="border px-3 py-2 text-pr-black font-medium">Mixed 2</td><td className="border px-3 py-2">If + past, would have + V3</td><td className="border px-3 py-2">Present → Past</td><td className="border px-3 py-2">If I were braver, I would have tried.</td></tr>
                </tbody>
              </table>
            </div>
          </CardContent>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <section>
              ...
              <ul className="list-disc pl-6 space-y-1">
                <li><span className="text-pr-black font-semibold">If necessary</span>: Call me if necessary.</li>
                <li><span className="text-pr-black font-semibold">If possible</span>: I'd like a window seat if possible.</li>
                <li><span className="text-pr-black font-semibold">If I were you</span>: If I were you, I would apologize.</li>
                <li><span className="text-pr-black font-semibold">If only</span>: If only I had more time!</li>
              </ul>
            </section>
            <section>
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-4">
            ...
            <p><span className="text-pr-black font-semibold">Practical tip</span>: Start by mastering the four main types before tackling mixed conditionals and alternatives to "if". Regular practice will help you use these structures naturally.</p>
            <ul className="list-disc pl-6 space-y-1">
