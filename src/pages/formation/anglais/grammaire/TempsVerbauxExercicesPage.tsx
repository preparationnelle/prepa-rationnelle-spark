...
const TempsVerbauxExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getTensesExercisesByType(selectedExerciseType));
  ...
  const calculateScore = () => {
    ...
    tensesExercises.forEach(exercise => {
      totalQuestions++;
          ...
          <div className={`rounded-lg p-4 border-2 ${validatedAnswers[exerciseId]
            ...
            {!validatedAnswers[exerciseId] && (
              <p className="text-red-700 mt-2">
                La bonne réponse est : <strong>{tensesExercises.find(ex => ex.id === exerciseId)?.correctAnswer}</strong>
              </p>
            )}
          </div>
        )}
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/anglais/grammaire/temps-verbaux" className="hover:text-gray-900 transition-colors">
              Temps Verbaux
            </Link>
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
            ...
            Exercices Temps Verbaux Anglais
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Testez vos connaissances avec ces exercices progressifs sur les temps verbaux anglais essentiels pour les concours
          </p>
          <div className="flex justify-center gap-2 mt-4">
            <Badge variant="secondary">Niveau Débutant - Avancé</Badge>
            <Badge variant="outline">{tensesExercises.length} exercices</Badge>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  {tensesExerciseCategories.map(category => (
          ...
          <Card className="mb-8 border-4 border-blue-500 bg-gradient-to-r from-blue-100 to-indigo-100 shadow-lg">
            ...
            <CardContent>
              <div className="flex flex-wrap gap-4">
                ...
                >
                  Mots à compléter ({getTensesExercisesByType('complet').length})
                </Button>
              </div>
            </CardContent>
          </Card>
              ...
              <div className={`text-lg ${examMode ? 'text-blue-700' : 'text-blue-700'
                ...
                {score >= 80 ? (
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Félicitations ! Vous avez réussi l\'examen avec brio.' : 'Excellent ! Vous maîtrisez bien les temps verbaux anglais.'}
                  </div>
                ) : score >= 50 ? (
                  <div className="flex items-center justify-center gap-2">
...
export default TempsVerbauxExercicesPage;
