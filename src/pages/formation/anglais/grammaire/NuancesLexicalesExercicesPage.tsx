...
import { nuancesLexicalesExercises, getNuancesLexicalesExercisesByType, nuancesLexicalesExerciseCategories } from '@/data/englishNuancesLexicalesExercisesData';

const NuancesLexicalesExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getNuancesLexicalesExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = nuancesLexicalesExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/anglais/grammaire/nuances-lexicales" className="hover:text-gray-900 transition-colors">
              Lexical Nuances
            </Link>
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-4 flex items-center justify-center gap-3">
            ...
            Lexical Nuances - Exercises
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Master often confused English words. Practice with pairs like affect/effect, advice/advise, and false friends.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {nuancesLexicalesExerciseCategories.map(category => (
...
export default NuancesLexicalesExercicesPage;
