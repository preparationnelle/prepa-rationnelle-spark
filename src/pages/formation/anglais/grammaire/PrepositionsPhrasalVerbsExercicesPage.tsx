...
import { prepositionsPhrasalVerbsExercises, getPrepositionsPhrasalVerbsExercisesByType, prepositionsPhrasalVerbsExerciseCategories } from '@/data/englishPrepositionsPhrasalVerbsExercisesData';

const PrepositionsPhrasalVerbsExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getPrepositionsPhrasalVerbsExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = prepositionsPhrasalVerbsExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {prepositionsPhrasalVerbsExerciseCategories.map(category => (
...
export default PrepositionsPhrasalVerbsExercicesPage;
