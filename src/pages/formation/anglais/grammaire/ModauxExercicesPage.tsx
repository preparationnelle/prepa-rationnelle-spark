...
import { modalVerbsExercises, getModalVerbsExercisesByType, modalVerbsExerciseCategories } from '@/data/englishModalVerbsExercisesData';

const ModauxExercicesPage = () => {
  ...
  const filteredExercises = filterExercises(getModalVerbsExercisesByType(selectedExerciseType));
  ...
  const validateAnswer = (exerciseId: string) => {
    const exercise = modalVerbsExercises.find(ex => ex.id === exerciseId);
    if (!exercise) return;
      ...
      <nav className="sticky top-0 z-40 bg-white/90 backdrop-blur supports-[backdrop-filter]:bg-white/60 border-b border-border/40">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs font-medium text-gray-600">
            ...
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
            <Link to="/formation/anglais/grammaire/modaux" className="hover:text-gray-900 transition-colors">
              Modal Verbs
            </Link>
            <ChevronRight className="h-3 w-3 text-gray-400 mx-1" />
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Practice modal verbs through interactive exercises. Test your knowledge with QCM, fill-in-the-blank, and multiple-choice questions covering can, could, may, might, must, should, will, would, and more.
          </p>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                  {modalVerbsExerciseCategories.map(category => (
            ...
            <CardContent className="text-center">
              ...
              <div className={`text-lg ${
                ...
                {score >= 80 ? (
                  <div className="flex items-center justify-center gap-2">
                    ...
                    {examMode ? 'Congratulations! You passed the exam successfully.' : 'Excellent! You have a good command of modal verbs.'}
                  </div>
                ) : score >= 50 ? (
                  <div className="flex items-center justify-center gap-2">
              ...
              <div className="mt-6">
                <p className="text-sm text-gray-600">
                  {examMode ? 'Exam completed.' : 'Practice more to improve your understanding of modal verbs.'}
                </p>
              </div>
            </CardContent>
          </Card>
...
export default ModauxExercicesPage;
