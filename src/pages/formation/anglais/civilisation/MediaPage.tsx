      ...
      <div className="max-w-4xl mx-auto">
        ...
        <CivAccordion>
          ...
          <CivItem value="big-tech-regulation-essay" title="Big Tech Regulation Essay">
            <div className="space-y-4">
              <div className="bg-pr-orange-pale p-6 rounded-lg border-l-[3px] border-pr-orange">
                <h4 className="font-dm-serif text-pr-orange-dark mb-4">Essay: Big Tech Regulation Debate</h4>
          ...
          <CivItem value="essay-questions" title="Sample Essay Questions">
            <div className="space-y-4">
              <div className="p-6 bg-pr-orange-pale rounded-lg border-l-[3px] border-pr-orange">
                <h4 className="font-dm-serif text-pr-orange-dark mb-4">1. US Polarization Essay Sample</h4>
                <div className="text-sm leading-relaxed space-y-4 text-pr-gray-dark">
                  <p>
