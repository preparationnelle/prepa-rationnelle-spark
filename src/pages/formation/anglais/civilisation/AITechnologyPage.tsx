    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-orange-200">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-black/70">
            ...
            <ChevronRight className="h-3 w-3 text-black/40 mx-1" />
            <span className="font-medium">AI and Technology</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold">Artificial Intelligence and Technology</h1>
          ...
          <Card className="mb-8 border border-orange-200">
            <CardHeader className="py-3">
              <CardTitle className="text-xl">Key Tech Facts 2025</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">2022</div>
                  <div className="text-sm text-black/70">ChatGPT launched</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">100M+</div>
                  <div className="text-sm text-black/70">ChatGPT users in 2 months</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">300M</div>
                  <div className="text-sm text-black/70">Jobs at risk from AI</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">60%</div>
                  <div className="text-sm text-black/70">UK crime is cybercrime</div>
                </div>
              </div>
            </CardContent>
          </Card>
