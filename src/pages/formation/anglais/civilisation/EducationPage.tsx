    ...
    <div className="min-h-screen bg-white text-black">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-orange-200">
        <div className="container mx-auto px-4 py-2">
          <div className="flex items-center text-xs text-black/70">
            ...
            <ChevronRight className="h-3 w-3 text-black/40 mx-1" />
            <span className="font-medium">Education and Culture Wars</span>
          </div>
        </div>
      </nav>
      ...
      <div className="container mx-auto py-8 px-4">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h1 className="text-3xl font-bold">Education and Culture Wars</h1>
          ...
          <Card className="mb-8 border border-orange-200">
            <CardHeader className="py-3">
              <CardTitle className="text-xl">Key Education Facts 2025</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">$3.2B</div>
                  <div className="text-sm text-black/70">Diverted to security/legal costs</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">2023-24</div>
                  <div className="text-sm text-black/70">School year of major conflicts</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">2024</div>
                  <div className="text-sm text-black/70">Labour government elected UK</div>
                </div>
                <div className="border border-orange-200 rounded-lg p-3">
                  <div className="text-2xl font-bold">Conservative</div>
                  <div className="text-sm text-black/70">Previous UK government</div>
                </div>
              </div>
            </CardContent>
          </Card>
