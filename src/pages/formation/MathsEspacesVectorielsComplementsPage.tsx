...
const MathsEspacesVectorielsComplementsPage = () => {
  return (
    <MathChapterTemplate
      chapterNumber={11}
      chapterTitle="Applications linéaires et structures vectorielles"
      description="Compléments sur les espaces vectoriels : applications linéaires, sous-espaces et changements de base"
    >
