          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              <div className="flex justify-center mb-4">
                <div className="w-16 h-16 bg-carnet-red/10 rounded-full flex items-center justify-center">
                  <Trophy className="h-8 w-8 text-carnet-red" />
                </div>
              </div>
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-carnet-red/30">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-carnet-red mb-2">Programme de l'épreuve d'EPS en Terminale</h3>
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Objectifs de l'enseignement en Terminale</h4>

                <p className="mb-4">
                  Dès la classe de Terminale, les apprentissages de Première sont complétés selon deux niveaux de compétences :
                </p>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Niveau 1 : socle commun minimal exigible</h5>
                <p className="mb-6">
                  Pour l'ensemble du cycle terminal, devant être atteint et évalué au baccalauréat.
                </p>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Niveau 2 : approfondissement libre encouragé</h5>
                <p className="mb-6">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Contenus et APSA programmées</h4>
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Modalités d'évaluation</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Contrôle continu (CCF)</h5>
                <p className="mb-6">
                  Trois évaluations distinctes durant l'année, notées sur 20 ; la moyenne constitue la note finale d'EPS au bac.
                </p>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Référentiel national</h5>
                <p className="mb-6">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Suivi individualisé</h5>
                <p className="mb-6">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Trois évaluations notées sur 20</h4>
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Moyenne simple pour la note finale</h5>
                <p className="mb-6">
                  La moyenne arithmétique des trois notes sur 20 constitue la note finale d'EPS au baccalauréat (sur 20).
                </p>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Répartition des critères d'évaluation</h5>
                <p className="mb-4">
