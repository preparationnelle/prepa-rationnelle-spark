  ...
  return (
    ...
    >
      <MethodIntroCard icon={Lightbulb} title="L'importance du projet professionnel">
        ...
        <p className="font-medium text-pr-black mb-2">Un projet bien construit montre :</p>
      ...
      <MethodSection label="Section 04" title="Exemple de projet professionnel réussi" icon={CheckCircle}>
        <div className="bg-pr-orange-pale border-l-4 border-pr-orange rounded-r-lg p-7">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h4 className="font-dm-serif text-lg text-pr-black">Consultant en transformation digitale</h4>
          </div>
          <div className="space-y-3 text-sm text-pr-gray-dark leading-relaxed">
            <p>
              <span className="font-semibold text-pr-orange-dark uppercase text-[10px] tracking-wider">Vision long terme · </span>
            ...
            <p>
              <span className="font-semibold text-pr-orange-dark uppercase text-[10px] tracking-wider">Motivations · </span>
            ...
            <p>
              <span className="font-semibold text-pr-orange-dark uppercase text-[10px] tracking-wider">Plan d'action · </span>
            ...
            <p>
              <span className="font-semibold text-pr-orange-dark uppercase text-[10px] tracking-wider">Expériences validantes · </span>
