      ...
      <div className="container mx-auto py-4 px-4 relative z-10">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold mb-6">
            ...
            <span className="text-blue-600">Espagnol</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-12">
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-black mb-8 text-center leading-relaxed font-semibold">Conjugaisons et syntaxe<br/>et structures</p>
            <div className="space-y-2 text-sm mb-6 w-full">
              <div className="flex items-center text-gray-600 bg-gray-50 rounded-lg py-2 px-3">
                <span className="mr-2 text-xs">✓</span>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-black mb-8 text-center leading-relaxed font-semibold">Enjeux contemporains d'Espagne<br/>et d'Amérique latine</p>
            <div className="space-y-2 text-sm mb-6 w-full">
              <div className="flex items-center text-gray-600 bg-gray-50 rounded-lg py-2 px-3">
                <span className="mr-2 text-xs">✓</span>
        ...
        >
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm text-black mb-8 text-center leading-relaxed font-semibold">Techniques et stratégies<br/>pour réussir les épreuves</p>
            <div className="space-y-2 text-sm mb-6 w-full">
              <div className="flex items-center text-gray-600 bg-gray-50 rounded-lg py-2 px-3">
                <span className="mr-2 text-xs">✓</span>
