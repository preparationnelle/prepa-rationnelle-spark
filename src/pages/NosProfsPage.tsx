...
const NosProfsPage = () => {
  ...
  const ProfessorCardCompact = ({ professor, index }: { professor: Professor; index: number }) => (
    <div className={`professor-card bg-white rounded-2xl p-6 shadow-lg hover:shadow-2xl hover:scale-105 transition-all duration-500 border ${professor.isFounder ? 'border-pr-black ring-2 ring-pr-black-pale' : 'border-gray-100'} cursor-pointer group relative overflow-hidden transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'} flex flex-col h-full`}
      ...
      {professor.isFounder && (
        <div className="bg-gradient-to-r from-pr-black to-pr-black h-2 rounded-t-2xl absolute top-0 left-0 right-0 animate-pulse"></div>
      )}
      ...
      <div className="flex-1">
        ...
        <div className={`text-center mb-4 ${professor.isFounder ? 'pt-2' : ''}`}>
          <div className={`w-20 h-20 rounded-full flex items-center justify-center text-white font-bold text-2xl shadow-lg mx-auto mb-4 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 ${professor.isFounder ? 'bg-gradient-to-br from-pr-orange to-pr-black' : 'bg-gradient-to-br from-gray-600 to-gray-800'} group-hover:shadow-2xl`}>
          ...
          <div className="flex items-center justify-center gap-2 mb-2">
            ...
            {professor.isFounder && (
              <div className="bg-gradient-to-r from-pr-orange to-pr-black text-white px-2 py-1 rounded-full text-xs font-semibold">
                Fondateur
              </div>
            )}
          </div>
          <p className="text-lg text-pr-black font-semibold mb-3">{professor.role}</p>
        ...
        <div className="mb-4">
          <div className="flex flex-wrap gap-2 justify-center">
            {professor.mainSubjects.slice(0, 2).map((subject, index) => (
              <span key={index} className="bg-pr-gray-bg text-pr-black px-3 py-1 rounded-full text-xs font-medium">
                {subject}
              </span>
            ))}
      ...
      <div className="mt-auto">
        <Button
          ...
          className="w-full bg-gradient-to-r from-pr-black to-pr-black hover:from-pr-black hover:to-pr-black text-white font-medium rounded-xl transition-all duration-300 hover:shadow-lg hover:shadow-pr-orange/25 hover:scale-105 active:scale-95"
        >
        ...
        <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative">
          ...
          <div className="p-8">
            ...
            {selectedProfessor.isFounder && (
              <div className="bg-gradient-to-r from-pr-black to-pr-black h-2 rounded-t-3xl absolute top-0 left-0 right-0"></div>
            )}

            {/* Photo et infos principales */}
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6 mb-6 pt-4">
              <div className={`w-32 h-32 rounded-2xl flex items-center justify-center text-white font-bold text-4xl shadow-lg ${selectedProfessor.isFounder ? 'bg-gradient-to-br from-pr-orange to-pr-black' : 'bg-gradient-to-br from-blue-500 to-blue-600'}`}>
              ...
              <div className="flex-1 text-center md:text-left">
                <div className="flex items-center justify-center md:justify-start gap-2 mb-2">
                  ...
                  {selectedProfessor.isFounder && (
                    <div className="bg-gradient-to-r from-pr-orange to-pr-black text-white px-4 py-2 rounded-full text-sm font-semibold">
                      Fondateur
                    </div>
                  )}
                </div>
                <p className="text-2xl text-pr-black font-semibold mb-3">{selectedProfessor.role}</p>
            ...
            <div className="mb-6">
              <h4 className="text-2xl font-semibold mb-4 flex items-center gap-2">
                <Award className="h-6 w-6 text-pr-black" />
                Réalisations & Succès
              </h4>
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <Button className="w-full bg-gradient-to-r from-pr-black to-pr-black hover:from-pr-black hover:to-pr-black text-white font-bold text-lg py-6 rounded-xl">
        ...
        <div className="sticky top-16 z-40 bg-white/95 backdrop-blur-md border-b border-gray-200 shadow-sm">
          <div className="container mx-auto px-4 py-4">
            <nav className="flex flex-wrap gap-4 justify-center text-sm">
              <a href="#equipe" className="hover:text-pr-black transition-colors font-medium">Notre équipe</a>
            </nav>
          </div>
        </div>
        */}
        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="text-center mb-16">
            <h1 className={`text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-pr-black to-pr-black bg-clip-text text-transparent transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              Nos Professeurs
            </h1>
          ...
          <section className="mb-16">
            <div className={`bg-gradient-to-br from-pr-orange-pale via-white to-pr-black-pale rounded-3xl p-8 md:p-12 shadow-xl border border-pr-black-soft/40 transition-all duration-1000 delay-200 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              <div className="max-w-4xl mx-auto">
                {/* Titre principal */}
                <div className="text-center mb-10">
                  <h2 className="text-4xl md:text-5xl font-bold mb-4 bg-gradient-to-r from-pr-black to-pr-black bg-clip-text text-transparent">
                    Une équipe d'excellence à votre service
                  </h2>
                  <div className="flex items-center justify-center gap-3 mb-6">
                    <div className="h-1 w-16 bg-gradient-to-r from-pr-black to-pr-black rounded-full"></div>
                    <GraduationCap className="h-8 w-8 text-pr-black" />
                    <div className="h-1 w-16 bg-gradient-to-r from-pr-orange to-pr-black rounded-full"></div>
                  </div>
                  <p className="text-2xl md:text-3xl font-semibold text-gray-800 mb-2">
                    40 professeurs d'élite
                  </p>
                  <p className="text-lg text-gray-600">
                    Diplômés d'<span className="font-semibold text-pr-black">HEC, ESCP, ESSEC, Centrale</span> et des meilleures écoles
                  </p>
                </div>
                ...
                <div className="mb-10">
                  <h3 className="text-2xl font-bold mb-6 text-gray-900 flex items-center gap-3">
                    <div className="w-10 h-10 bg-pr-gray-bg rounded-xl flex items-center justify-center">
                      <Heart className="h-6 w-6 text-pr-black" />
                    </div>
                    Notre approche
                  </h3>
                  <div className="space-y-4 text-gray-700 text-lg leading-relaxed">
                    <p>
                      ...
                      <span className="font-semibold text-pr-black"> Ils construisent avec chaque élève un véritable plan de progression personnalisé.</span>
                    </p>
                    <div className="grid md:grid-cols-2 gap-4 my-6">
                      <div className="bg-white p-5 rounded-xl shadow-md border border-pr-black-soft/40">
                ...
                <div className="mb-10">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gradient-to-br from-pr-black to-pr-black p-6 rounded-2xl shadow-lg text-white">
                    ...
                    <div className="bg-gradient-to-br from-pr-orange to-pr-black p-6 rounded-2xl shadow-lg text-white">
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-pr-black-soft/40">
                  <h3 className="text-2xl font-bold mb-6 text-gray-900 flex items-center gap-3">
                    <div className="w-10 h-10 bg-pr-gray-bg rounded-xl flex items-center justify-center">
                      <Star className="h-6 w-6 text-pr-black" />
                    </div>
                    Ce qui distingue nos professeurs
                  </h3>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-br from-pr-black to-pr-black rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                    ...
                    <div className="text-center">
                      <div className="w-16 h-16 bg-gradient-to-br from-pr-orange to-pr-black rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg">
                ...
                <div className="mt-8 bg-gradient-to-r from-pr-black to-pr-black p-8 rounded-2xl shadow-xl text-white text-center">
                  ...
                  <Button
                    size="lg"
                    className="bg-white text-pr-black hover:bg-gray-100 font-bold text-lg px-8 py-6 rounded-xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105"
                  >
                    <Mail className="mr-2 h-5 w-5" />
          ...
          <section id="equipe" className="mb-16 scroll-mt-24">
            <div className={`text-center mb-12 transition-all duration-1000 delay-500 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
              <h2 className="text-4xl font-bold mb-4 bg-gradient-to-r from-pr-black to-pr-black bg-clip-text text-transparent">
          ...
          */}
          ...
          <section className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 mb-16">
            <div className="text-center mb-8">
              <h2 className="text-3xl font-bold mb-4 bg-gradient-to-r from-pr-black to-pr-black bg-clip-text text-transparent">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-pr-gray-bg rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Heart className="h-8 w-8 text-pr-black" />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-pr-gray-bg rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Users className="h-8 w-8 text-pr-black" />
                </div>
          ...
          {/* Call to Action */}
          <div className="text-center bg-gradient-to-r from-pr-orange-pale to-pr-black-pale rounded-3xl p-12 border border-pr-black-soft">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-gradient-to-r from-pr-black to-pr-black hover:from-pr-black hover:to-pr-black text-white font-bold py-4 px-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-105">
                Réserver un cours d'essai gratuit
              </button>
              <button className="border-2 border-pr-black-dark text-pr-black hover:bg-pr-black-dark hover:text-white font-bold py-4 px-8 rounded-2xl transition-all duration-300">
                Nous contacter
              </button>
            </div>
          </div>
