          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-carnet-red/30">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-carnet-red mb-2">Méthodologie pour travailler l'espagnol en classe de terminale</h3>
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Organisation générale du travail</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Planification hebdomadaire structurée</h5>
                <p className="mb-4">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Gestion du temps quotidien</h5>
                <p className="mb-6">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Les 5 compétences langagières à développer</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">1. Compréhension écrite</h5>
                <p className="mb-4">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">2. Compréhension orale</h5>
                <p className="mb-4">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">3. Expression écrite</h5>
                <p className="mb-6">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">4. Expression orale en continu</h5>
                <p className="mb-6">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">5. Expression orale en interaction</h5>
                <p className="mb-6">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Méthodes d'apprentissage efficaces</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Vocabulaire et fiches thématiques</h5>
                <p className="mb-6">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Grammaire et conjugaison</h5>
                <p className="mb-6">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Immersion culturelle quotidienne</h5>
                <p className="mb-4">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Préparation aux épreuves du baccalauréat</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Maîtrise des notions du programme</h5>
                <p className="mb-4">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Entraînement aux épreuves</h5>
                <p className="mb-6">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">Outils et ressources recommandés</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Supports numériques</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Méthodes de travail collaboratif</h5>
                <p className="mb-8">
