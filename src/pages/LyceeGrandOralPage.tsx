          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 border-2 border-carnet-red/30">
              <div className="text-center mb-8">
                ...
                <h3 className="text-3xl font-bold text-carnet-red mb-2">Préparer le Grand Oral en Terminale</h3>
              ...
              <div className="prose prose-lg max-w-none text-gray-700">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">1. Comprendre l'épreuve</h4>
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">2. Sélection et formulation du sujet</h4>
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">3. Construire l'exposé</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Introduction (1 minute)</h5>
                <ul className="list-disc pl-6 mb-6 space-y-1">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Développement (3 à 4 parties)</h5>
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Conclusion</h5>
                <ul className="list-disc pl-6 mb-6 space-y-1">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">4. S'entraîner efficacement</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Techniques d'entraînement</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Mises en situation</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                ...
                <h5 className="text-xl font-semibold text-carnet-red mb-3">Feedback systématique</h5>
                <ul className="list-disc pl-6 mb-6 space-y-1">
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">5. Gérer le stress et l'imprévu</h4>
                ...
                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">6. Planning de révision (sur 4 semaines)</h4>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Semaine 1</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                  <li>Choix des sujets + formulation des problématiques</li>
                  <li>Recherche documentaire et collecte d'exemples</li>
                </ul>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Semaine 2</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                  <li>Rédaction des plans détaillés</li>
                  <li>Première rédaction complète des exposés</li>
                </ul>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Semaine 3</h5>
                <ul className="list-disc pl-6 mb-4 space-y-1">
                  <li>Entraînements oraux chronométrés (3 fois/jour)</li>
                  <li>Travail sur la diction, l'élocution et la voix</li>
                </ul>

                <h5 className="text-xl font-semibold text-carnet-red mb-3">Semaine 4</h5>
                <ul className="list-disc pl-6 mb-6 space-y-1">
                  <li>Simulations devant jury (pairs, professeurs)</li>
                  <li>Ajustements finaux et renforcement de la confiance</li>
                </ul>

                <h4 className="text-2xl font-semibold text-carnet-red mb-4 border-b-2 border-carnet-red/30 pb-2">7. Conseils clés</h4>
            ...
            <div className="mt-16 text-center">
              <div className="bg-gradient-to-br from-red-50 to-pr-orange-pale border-2 border-carnet-red/30 hover:shadow-2xl hover:scale-105 hover:border-carnet-red/40 hover:bg-gradient-to-br hover:from-carnet-paper-2 hover:to-red-50 transition-all duration-300 group p-8 rounded-lg">
                ...
                <h3 className="text-2xl font-bold mb-4 text-carnet-red group-hover:text-carnet-red-deep transition-colors duration-300">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link to="/contact">
                    <Button size="lg" className="bg-carnet-red hover:bg-carnet-red text-white transition-all duration-300">
                      Nous contacter
                    </Button>
                  </Link>
                </div>
