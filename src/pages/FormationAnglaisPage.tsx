        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto mb-16">
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-2xl mb-4 text-center text-blue-700 group-hover:text-orange-800 transition-colors">Vocabulaire</h3>
              <p className="text-sm text-blue-700 mb-8 text-center leading-relaxed font-medium">Maîtrisez le lexique essentiel<br/>pour vos épreuves de concours</p>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-2xl mb-4 text-center text-blue-700 group-hover:text-orange-800 transition-colors">Grammaire</h3>
              <p className="text-sm text-blue-700 mb-8 text-center leading-relaxed font-medium">Maîtrisez les règles essentielles<br/>de grammaire anglaise</p>
              <div className="space-y-2 text-sm mb-6 w-full">
                <div className="flex items-center text-blue-600 bg-blue-50 rounded-lg py-2 px-3">
                  <span className="mr-2 text-xs">✓</span>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <h3 className="font-bold text-2xl mb-4 text-center text-blue-700 group-hover:text-orange-800 transition-colors">Civilisation</h3>
              <p className="text-sm text-blue-700 mb-8 text-center leading-relaxed font-medium">Enjeux contemporains<br/>du monde anglophone</p>
              <div className="space-y-2 text-sm mb-6 w-full">
                <div className="flex items-center text-blue-600 bg-blue-50 rounded-lg py-2 px-3">
                  <span className="mr-2 text-xs">✓</span>
          ...
          >
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-blue-700 mb-8 text-center leading-relaxed font-medium">Méthode complète en 7 étapes<br/>pour réussir les épreuves</p>
              <div className="space-y-2 text-sm mb-6 w-full">
                <div className="flex items-center text-blue-600 bg-blue-50 rounded-lg py-2 px-3">
                  <span className="mr-2 text-xs">✓</span>
